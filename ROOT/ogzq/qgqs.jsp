...
<html>
  ...
  <%
      ...
      for(String id : ids) {
          ...
          //13*
          //4047|3|Super/10041.png|里杰卡尔德|6|602404|13|1*
          //3367|4|Super/10043.png|范·巴斯滕|6|612178|13|1*
          //3672|2|Super/10045.png|古力特    |6|619156|13|1
          ...
          <td valign="top">
              <table border="0" cellpadding="1" cellspacing="1" bgcolor="black" id="full">
                  <tr class="head">
                      ...
                      <th style="cursor:pointer;text-decoration:underline;" onclick="resort(this, 5, false)">里杰卡尔德</th>
                      <th style="cursor:pointer;text-decoration:underline;" onclick="resort(this, 6, false)">巴斯滕</th>
                      <th style="cursor:pointer;text-decoration:underline;" onclick="resort(this, 7, false)">古力特</th>
                  </tr>
...
<script type="text/javascript">
    function beforeUp(obj, email, playerId) {
        ...
        OgzqDwr.sjkUpCost(email, playerId, showUp);
    }
    ...
    function doUp(email, player, costPlayer) {
        OgzqDwr.sjkUp(email, player, costPlayer, after);
    }
