(function() {
    ...
    a.prototype = {init:function(f) {
        ...
        var f = "",a = "-";
        if(g.virtualURL)f = g.virtualURL; else if(f = l = escape(b.pathname),b.search != "" && (a = escape(b.search.substr(1))),g.senseParam) {
            var e = this.getParameter(g.senseParam, d.URL);
            e && (f += "_" + e)
        }
        return f + "&arg=" + a
    },getRefInfo:function(f) {
        var a = "-",e = "-",r = "-",c = d.referrer,h,g = f.virtualDomain ? f.virtualDomain : "-",x = f.virtualURL ? f.virtualURL : "-";
        o = f.virtualRefDomain ? f.virtualRefDomain : "";
        s = f.virtualRefURL ? f.virtualRefURL : "";
        f.statIframe || f.useCookie == "true" ? (c = m.get("pgvReferrer"),h = d.URL,g = h.indexOf("?"),g > -1 && (h = h.substr(0, g)),m.set("pgvReferrer", h)) : f.useCookie == "set" && o != "" && s != "" ? (h = "https:" == b.protocol ? "https://" : "http://",h += o + refUrl,m.set("pgvReferrer", h)) : f.useCookie == "set" && (g != "-" || x != "-") ? (h = "https:" == b.protocol ? "https://" : "http://",h += g == "-" ? j : g,h += x == "-" ? l : x,m.set("pgvReferrer", h)) : (f.useCookie == "get" && (h = m.get("pgvReferrer"),h != "" && (c = h)),m.set("pgvReferrer", ""));
        if(h = this.getParameter(f.tagParamName || "ADTAG", d.URL))a = "ADTAG",e = h;
        h = c.indexOf("://");
        if(h > -1 && a == "-" && (h = c.match(/(\w+):\/\/([^\:|\/]+)(\:\d*)?(.*\/)([^#|\?|\n]+)?(#.*)?(\?.*)?/i)))a = h[2],e = h[4] + h[5];
        ...
        var f = "";
        try {
            var a = "-",b = "-",d = "-",c = "-",e = "-",m = "-",r = 0,z = navigator;
            self.screen && (a = screen.width + "x" + screen.height,b = screen.colorDepth + "-bit");
            z.language ? d = z.language.toLowerCase() : z.browserLanguage && (d = z.browserLanguage.toLowerCase());
            r = z.javaEnabled() ? 1 : 0;
            c = z.cpuClass;
            e = z.platform;
        ...
        try {
            ...
            switch(e.tagName) {case "A":d = "<A href=" + e.href + ">" + e.innerHTML + "</a>";break;case "IMG":d = "<IMG src=" + e.src + ">";break;case "INPUT":d = "<INPUT type=" + e.type + " value=" + e.value + ">";break;case "BUTTON":d = "<BUTTON>" + e.innerText + "</BUTTON>";break;case "SELECT":d = "SELECT";break;default:b = !1}
            if(b) {
                var c = new a(g),h = c.getElementPos(e);
                if(g.coordinateId) {
        ...
        if(f.parentNode === null || f.style.display == "none")return!1;
        var a = navigator.userAgent.toLowerCase(),b = null,d = [];
        if(f.getBoundingClientRect)return a = f.getBoundingClientRect(),{x:a.left + Math.max(document.documentElement.scrollLeft, document.body.scrollLeft) - document.body.clientLeft,y:a.top + Math.max(document.documentElement.scrollTop, document.body.scrollTop) - document.body.clientTop}; else if(document.getBoxObjectFor)a = document.getBoxObjectFor(f),d = [a.x - (f.style.borderLeftWidth ? Math.floor(f.style.borderLeftWidth) : 0),a.y - (f.style.borderTopWidth ? Math.floor(f.style.borderTopWidth) : 0)]; else {
            d = [f.offsetLeft,f.offsetTop];
            b = f.offsetParent;
            if(b != f)for(; b;)d[0] += b.offsetLeft,d[1] += b.offsetTop,b = b.offsetParent;
    ...
    var r = {vscope:{page:3,session:2,user:1},setv:function(f) {
        var a = "",a = "";
        if(!f || !f.name || f.name == "" || !f.value || f.value == "" || !f.scope || f.scope < 1 || f.scope > 3)a = m.get("custvar=") == "-" ? m.get("custvar=", !0) : m.get("custvar="); else switch(a = f.name + ":" + f.value,f.scope) {case this.vscope.session:m.setCookie("custvar", !1, a);break;case this.vscope.user:m.setCookie("custvar", !0, a)}
        return"&custvar=" + a
    }},m = {sck:[],sco:{},init:function() {
        var f = this.get("pgv_info=", !0);
        if(f != "-")for(var f = f.split("&"),a = 0; a < f.length; a++) {
            var b = f[a].split("=");
            this.set(b[0], unescape(b[1]))
        }
    },get:function(f, a) {
        var b = a ? d.cookie : this.get("pgv_info=", !0),e = "-",c;
        c = b.indexOf(f);
        if(c > -1) {
            c += f.length;
            e = b.indexOf(";", c);
        ...
        this.sco[f] = a;
        for(var b = !1,d = this.sck.length,c = 0; c < d; c++)if(f == this.sck[c]) {
            b = !0;
            break
        }
        b || this.sck.push(f)
...
Jx().$package("alloy.flashUploadManager", function(a) {
    ...
    function j(a, c) {
        if(c) {
            ...
            d && (d.uploadFile(a._info.flashId, c, {mode:"flashupload"}),n(A.START_UPLOAD, a))
        } else b(a, function(b) {
    ...
    function p() {
        ...
        if((a = F[a]) && !H[a.fileId]) {
            f = g(a.via);
            switch(a.via) {case "FLASH":if(f >= u.flashConcurrency) {
                B.unshift(a.fileId);
                return
            }j(a);break;case "PLUGIN":if(f >= u.pluginConcurrency) {
                B.unshift(a.fileId);
                return
            }_uploadViaPlugin(a)}
            p()
    ...
    function s(a) {
        ...
        if(a.fileName.replace(/[^\x00-\xff]/g, "xx").length > D)return a.status = x.FAIL_VERIFY,n(A.FILE_NAME_LENGTH_EXCEED_LIMIT, a, D),1; else if(a.fileSize > f)return a.status = x.FAIL_VERIFY,n(A.FILE_SIZE_EXCEED_SINGLE_LIMIT, a, f),1; else if(a.fileSize === 0)return a.status = x.FAIL_VERIFY,n(A.FILE_SIZE_ZERO, a),1;
        return 0
    }
    function v(a, f, b) {
        var c,
        ...
        for(d = f.length; c < d; c++) {
            ...
            var m = fileSize;
            e = {_uin:u.uin,
                _verifiedBytes:0,_uploadedBytes:0,index:y++,type:e ? e : 0,via:"FLASH",status:x.INIT,fileId:+(Math.round(Math.random() * 1E4).toString() + (new Date).getMilliseconds()),localPath:k,fileName:k.split("\\").pop(),fileSize:m,startTime:0,_info:{}};
    ...
    function t(a, f, b) {
        switch(a) {case A.UPDATE_UPLOAD:(a = J[f.fileId]) && a.uploadProcess(b);break;case A.FILE_SIZE_EXCEED_SINGLE_LIMIT:alloy.layout.alert("\u76ee\u524d\u4ec5\u652f\u6301\u4e0a\u4f20\u5c0f\u4e8e100M\u7684\u6587\u4ef6\uff01");break;case A.FILE_SIZE_ZERO:alloy.layout.alert("\u6587\u4ef6\u5927\u5c0f\u4e0d\u80fd\u4e3a0\uff01");break;case A.FILE_SIZE_EXCEED_TOTAL_LIMIT:alloy.layout.alert("\u6587\u4ef6\u540d\u957f\u5ea6\u8d85\u8fc7\u4e86\u6700\u5927\u9650\u5236\uff01");
            break;case A.FAIL_UPLOAD:(a = J[f.fileId]) && a.uploadFailed()}
    }
    function r() {
        if(document.body.fireEvent)document.body.fireEvent("onclick", a); else if(document.createEvent) {
            var a = document.createEvent("MouseEvents");
            a.initEvent("click", !0, !0);
            document.body.dispatchEvent(a)
        }
    }
    var m = a.dom,f = a.event,k = this,q = 0;
    k.FlashUploader = new a.Class({isReady:!1,init:function(b) {
        b = b || {};
        ...
        var d = ++q;
        if(!b.holder) {
            var e = m.node("div", {id:"Alloy_Flash_Upload_" + d,"class":"Alloy_Flash_Upload"});
            document.body.appendChild(e);
            b.holder = m.id("Alloy_Flash_Upload_" + d)
        }
        var e = typeof ActiveXObject != "undefined",k = alloy.CONST.MAIN_URL + "swf/FileUploader.swf?preventSwfCache=" + (new Date).getTime(),h = "";
        b.extInfo && (h = "&extInfo=" + b.extInfo);
        this.flashId = "swfFileUploader_" + d;
        this.wrapperNode = m.node("div", {id:"swfFileUploaderWrapper_" + d,style:"position:absolute;top:0;left:0;overflow:hidden;width:" + b.width + ";height:" + b.height + ";"});
        this.wrapperNode.innerHTML = ['<object id="' + this.flashId + '"' + (e ? "" : ' data="' + k + '"') + ' width="' + b.width + '" height="' + b.height + '" ' + (e ? 'classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' : 'type="application/x-shockwave-flash"') + ">",e ? '<param name="movie" value="' + k + '"/>' : "",'<param name="allowScriptAccess" value="always" /><param name="allownetworking" value="all" /><param name="wmode" value="transparent" />',
                '<param name="flashVars" value=\'callback=' + b.callback + "&flashInstanceId=" + this.flashId + "&selectionMode=" + (b.mode === 1 ? 1 : 0) + h + "' />",'<param name="menu" value="false" /></object>'].join("");
        b.holder.innerHTML = "";
        b.holder.appendChild(this.wrapperNode);
        this.divNode = m.node("div", {id:"swfFileUploaderDiv_" + d,style:"_background:url(" + alloy.CONST.CDN_URL_0 + "style/images/transparent.gif);width:" + b.width + ";height:" + b.height + ";"});
        ...
        a.platform.iPad ? (m.setStyle(this.wrapperNode, "width", "1px"),m.setStyle(this.wrapperNode, "height", "1px"),m.setStyle(this.divNode, "color", "#999")) : (m.setStyle(this.wrapperNode, "width", this.option.width),m.setStyle(this.wrapperNode, "height", this.option.height));
    ...
    var D = 260,c = 157286399,h = 1073741823,A = {EXCEED_MAX_SELECTION:1,EXCEED_MAX_UPLOAD:2,FILE_POSTFIX_NOT_ALLOWED:3,FILE_NAME_LENGTH_EXCEED_LIMIT:4,FILE_SIZE_EXCEED_SINGLE_LIMIT:5,FILE_SIZE_ZERO:6,FILE_SIZE_EXCEED_TOTAL_LIMIT:7,ADDED_TO_QUEUE:8,START_LOCAL_VERIFY:9,UPDATE_LOCAL_VERIFY:10,FINISH_LOCAL_VERIFY:11,
        FAIL_LOCAL_VERIFY:12,FAIL_CREATE:13,START_UPLOAD:14,UPDATE_UPLOAD:15,FINISH_UPLOAD:16,FAIL_UPLOAD:17,NOT_LOGIN:18,NO_PRIVILEDGE:19,SPACE_FULL:20,BAD_WORDS:21,CANCEL_UPLOAD:22,REMOVE_FILE:23,STORAGE_FULL:24,NONE:0};
    (function() {
        var a = {},f;
        for(f in A)a[A[f]] = f;
        return a
    })();
    var x = {INIT:0,UPLOADING:1,FINISHED:2,FAIL_VERIFY:3,FAIL_CREATE:4,FAIL_UPLOAD:5,CANCELLED:6},z,y = 0,u = {postfixWhiteList:{"7z":1,avi:1,bmp:1,doc:1,docx:1,flv:1,swf:1,jpg:1,jpeg:1,mov:1,mp3:1,pdf:1,png:1,ppt:1,pptx:1,rar:1,rm:1,rmvb:1,
        rtf:1,tif:1,tiff:1,txt:1,wav:1,wave:1,wma:1,wmv:1,wps:1,xls:1,xlsx:1,zip:1}},n = function() {
    },B = [],F = {},H = {},Q = {},J = {},I = {};
    k.flashEventListener = function(b, c, d) {
        var h = F[Q[c && c.id]],m,b = parseInt(b);
        d && (d = a.json.parse(d));
        switch(b) {case 1:v(1, c, d);r();qqweb.util.report2qqweb("add|desktop|adddocument");break;case 11:r();break;case 3:if(h._uploadedBytes == c.processed)return;h._uploadedBytes = c.processed;n(A.UPDATE_UPLOAD, h, {processed:c.processed,fileSize:h.fileSize});break;case 4:d = !1;b = I[h.fileId];if((m = c.res.match(/ftn_post_end\((\-?\d+)\)/)) && parseInt(m[1]) === 0)d = !0; else if(m = c.res.indexOf('"code":"ok"'),m >= 0)d = !0,c = a.json.parse(c.res),b.ks_fileid = c.fileId,f.notifyObservers(k, "FileUploadComplete", b);if(d) {
            var z = J[h.fileId];
        ...
        } else e(A.FAIL_UPLOAD, h, x.FAIL_UPLOAD),alloy.layout.alert("\u4f20\u8f93\u6587\u4ef6\u6570\u636e\u5230\u5b58\u50a8\u786c\u76d8\u5931\u8d25\uff01");break;case 5:e(A.FAIL_UPLOAD, h, x.FAIL_UPLOAD);break;case 6:console.log("cancle")}
        w()
    };
    k.showUploadMask = function() {
        z || (z = new a.ui.MaskLayer({zIndex:alloy.layout.getTopZIndex(4),appendTo:document.body}),f.on(z.getElement(), "click", function(a) {
            a.preventDefault();
            a.stopPropagation()
        }));
        z.setOpacity(0.01);
    ...
    k.hideUploadMask = function() {
        z && z.hide()
    };
    k.checkBeforeUpload = function() {
        if(a.platform.iPad)alloy.layout.alert("\u60a8\u5f53\u524d\u4f7f\u7528\u7684\u5e73\u53f0\u6682\u4e0d\u652f\u6301\u8be5\u529f\u80fd\uff01"); else if(d())alloy.system.getLoginLevel() < 2 ? alloy.layout.showLoginWindow("") : alloy.storage.getDefaultDisk() || (b = alloy.layout.confirm('<div class="bindDiskAlert">\u60a8\u8fd8\u672a\u7ed1\u5b9a\u4efb\u4f55\u786c\u76d8\uff0c\u7ed1\u5b9a\u540e\u6700\u591a\u53ef\u83b7\u5f9715GB\u7684Q+ Web\u5b58\u50a8\u7a7a\u95f4\u3002</div>', function() {
            alloy.portal.runApp("diskExplorer")
        }, {height:"70"}),b.getButton("ok").setText("\u7ed1\u5b9a")); else {
    ...
    k.upload = j;
    this.init = function() {
        var a = {uin:alloy.portal.getCookieUin(),
            listener:t},b;
        for(b in a)u[b] = a[b];
        u.uin = +u.uin;
        u.port = u.port || 80;
...
Jet().$package(function(a) {
    var d = a.dom,b = a.event,e = 0,g = 0,j = {},l = {},p = function(a) {
        a.preventDefault();
        a.stopPropagation()
    },o = a.ui.ContextMenu = new a.Class({init:function(r) {
        var m = this,f = this.id = "context_menu_" + (r.id || e++),k = r.name || f,q = this._parent = r.container || (r.parentMenu ? r.parentMenu._parent : null) || document.body,g = r.className || "";
        this.parentMenu = r.parentMenu;
        var m = this,c = this._el = d.id(f) || d.node("div", {id:f,"class":"context_menu",style:"display: none;"}),g = '<div class="context_menu_container "' + g + '"><ul id="' + f + '_body" class="context_menu_item_list"></ul></div>';
        ...
        this._popupBox = new a.ui.PopupBox({id:f,name:k,noCatchMouseUp:!0,parentPopupBox:this.parentMenu ? this.parentMenu._popupBox : null,container:c});
        ...
        r.beforeShow && b.addObserver(this, "BeforeShow", r.beforeShow);
        j[f] = this;
        ...
        var b = a.type || "item";
        a.parentMenu = this;
        switch(b) {case "item":a = new s(a);break;case "flash":a = new v(a);break;case "separator":a = new w(a);break;case "submenu":a.parentMenu = this;a = new t(a);break;default:a = null}
        ...
        var e = e || 0,m = m || 0,f = typeof f === "undefined" ? 5 : f,q = this._popupBox,g = e + f,c = m + f,h = 0,A = 0,x = a.browser.ie;
        if(k && (h = d.getOffsetWidth(k),A = d.getOffsetHeight(k),g += h + 5,c -= 1,x == 9 || x == 8))g += 2;
        q.setX("-10000");
        q.show();
        var k = d.getClientWidth(this._el),z = d.getClientHeight(this._el),y = d.getClientWidth(),u = d.getClientHeight();
        if(g + k > y && e - k - f > 0)if(h) {
    ...
    var s = a.ui.ContextMenuItem = new a.Class({init:function(a) {
        var e = {title:a.title || a.text || "",text:a.text || "",link:a.link || "javascript:void(0);",icon:a.icon || null,enable:typeof a.enable === "undefined" ? !0 : a.enable,onClick:a.onClick || null,argument:a.argument};
        this.option = e;
        this.parentMenu = a.parentMenu;
        a = this._el = d.node("li", {"class":"context_menu_item_container"});
        this.render();
        ...
        render:function() {
            var a = this.option,b = '<a class="context_menu_item" href="' + a.link + '" title="' + a.title + '">';
            if(a.icon) {
                var f = a.icon;
        ...
        this._el.parentNode.removeChild(this._el);
        for(var a in this)this.hasOwnProperty(a) && delete this[a]
    }}),v = a.ui.FlashContextMenuItem = new a.Class({init:function(a) {
        var e = {title:a.title || a.text || "",text:a.text || "",link:a.link || "javascript:void(0);",icon:a.icon || null,enable:typeof a.enable === "undefined" ? !0 : a.enable,onClick:a.onClick || null,folderId:a.folderId || -1,argument:a.argument};
        this.option = e;
        this.parentMenu = a.parentMenu;
        var a = this._el = d.node("li", {"class":"context_menu_item_container"}),f = this._flashLi = d.node("li", {"class":"context_menu_item_container"}),k = this._itemId = "context_menu_flashItem_" + ++g,k = this._flashUl = d.node("ul", {id:k,"class":"context_menu_item_list context_menu_flashitem_item"});
        l[g] = k;
        k.appendChild(f);
        this.render();
        ...
        a = q.observer = {onShow:function() {
            ...
            alloy.portal.getLoginLevel() > 1 && alloy.storage.getDefaultDisk() ? q._flashUploader.showFileSelector() : q._flashUploader.hideFileSelector()
        },onHide:function() {
        ...
        a = {callback:"alloy.flashUploadManager.flashEventListener",mode:0,autoshow:!1,holder:d.mini(".explorer_upload_holder2", this._flashLi)[0],text:'<span class="context_menu_item_text">' + a.text + "</span>",width:"100%",
            height:"100%",extInfo:'{"folderId":' + this.option.folderId + "}"};
    ...
    var w = a.ui.ContextMenuSeparator = new a.Class({init:function() {
        (this._el = d.node("li", {"class":"context_menu_separator_container"})).innerHTML = '<span class="context_menu_separator"></span>'
    },getElement:function() {
        return this._el
    },show:function() {
        d.show(this._el)
        ...
        this._el.parentNode.removeChild(this._el);
        for(var a in this)this.hasOwnProperty(a) && delete this[a]
    }}),t = a.ui.ContextSubmenuItem = new a.Class({extend:s}, {init:function(e) {
        if(!e.items)throw Error("J.ui.ContextSubmenuItem: option.items is null!");
        e.title = e.title || e.text || "";
        var m = {title:null,text:"",autoHide:!0,
            link:"javascript:void(0);",icon:null,enable:!0,subWidth:null,parentMenu:e.parentMenu};
        delete e.parentMenu;
        e = this.option = a.extend(m, e);
        this.parentMenu = e.parentMenu;
        var f = this._el = d.node("li", {"class":"context_menu_item_container"});
        this.render();
        e.enable ? this.enable() : this.disable();
        this._submenu = new o({parentMenu:e.parentMenu,width:e.subWidth,beforeShow:e.beforeShow,items:e.items});
        var k = this,q = k.sunmenuTimer = 0,g = function() {
            k._submenu.isShow() && k._submenu.hide()
        },c = {onItemMouseenter:function(a) {
            a.stopPropagation();
...
Jx().$package("alloy", function(a) {
    var d = this,b = window.location.host;
    d.CONST = {CDN_URL:"http://0.web.qstatic.com/webqqpic/",CDN_ROOT:"web.qstatic.com/webqqpic/",CDN_URL_0:"http://0.web.qstatic.com/webqqpic/",UPDATE_TIME_STAMP:"20130816001",MAIN_DOMAIN:"qq.com",DEFAULT_DOMAIN:"web2.qq.com",DOMAIN:b,MAIN_URL:"http://" + b + "/",API_SERVER_URL:"http://s.web2.qq.com/api/",CONN_SERVER_DOMAIN:"http://s.web2.qq.com/",CONN_SERVER_DOMAIN2:"http://d.web2.qq.com/",CGI_BIN_SERVER_URL:"http://web2-b.qq.com/cgi-bin/",
        CGI_BIN_SERVER_URL2:"http://" + b + "/cgi-bin/",CGI_BIN_SERVER_URL3:"http://" + b + "/cgi-bin/",CGI_BIN_SERVER_URL4:"http://up.web2.qq.com/cgi-bin/",JAVA_CGI_URL:"http://cgi.web2.qq.com/",PS_CGI_URL:"http://ps.qq.com:8080/",JAVA_UP_CGI_URL:"http://up.web2.qq.com/",API_PROXY_URL:"http://s.web2.qq.com/proxy.html?v=20110412001",JAVA_CGI_PROXY_URL:"http://cgi.web2.qq.com/proxy.html?v=20110412001",PS_PROXY_URL:"http://ps.qq.com:8080/proxy.html?v=20110412001",JAVA_UP_CGI_PROXY_URL:"http://up.web2.qq.com/proxy.html?v=20110412001",
        PUB_APP_STATIC_URL:"pubapps/",PRI_APP_STATIC_URL:"http://wqbg.qpic.cn/appmarket/",PRI_APP_STATIC_URL2:"/",SYSTEM_FACE_URL:"http://0.web.qstatic.com/webqqpic/style/face/",DEFAULT_AVATAR_URL:"http://0.web.qstatic.com/webqqpic/style/heads/",AVATAR_SERVER_DOMAIN:"http://web.qq.com/",AVATAR_SERVER_DOMAINS:["http://face1.web.qq.com/","http://face2.web.qq.com/","http://face3.web.qq.com/","http://face4.web.qq.com/","http://face5.web.qq.com/","http://face6.web.qq.com/","http://face7.web.qq.com/","http://face8.web.qq.com/",
            "http://face9.web.qq.com/"],QZONE_SERVER_DOMAIN:"http://qzone.qq.com/",QZONE_USER_SERVER_DOMAIN:"http://user.qzone.qq.com/",QMAIL_SERVER_DOMAIN:"http://mail.qq.com/",QQ_GROUP_URL:"http://qun.qq.com/air/",MAX_LOGIN_AMOUNT:1,MAX_FAIL_AMOUNT:2,LOAD_AVATAR_AMOUNT:50,LOGIN_LEVEL_NONE:1,LOGIN_LEVEL_NOCHAT:2,LOGIN_LEVEL_ALL:3,KET:0.1,WINDOW_FLAG_MIN:1,WINDOW_FLAG_NORMAL:2,WINDOW_FLAG_MAX:4,WINDOW_FLAG_CURRENT:8,WINDOW_FLAG_NOT_CURRENT:16,WINDOW_FLAG_FULLSCREEN:32,DAID:164,APPID:1003903};
    ...
    d.init = function() {
        ...
        if(window.webTop) {
            ...
            alloy.rpcService.sendCheckHack({key:g,
                onSuccess:function(a) {
                    if(!a.retcode && a.result && !a.result.result) {
                        var a = a.result.i,g = webTop.ui.channel.postCmd(24, d.portal.getUin() || 0, a);
                        alloy.portal.setSecretIp(a);
                        alloy.portal.setSecretKey(g);
                        d.portal.init(b)
                    } else top.location = "http://im.qq.com/webqq/"
                }})
        } else d.portal.init(b),alloy.rpcService.sendCheckHack({key:0});
        pgvSendClick({hottag:"web2qq.version." + d.CONST.UPDATE_TIME_STAMP})
    };
    d.ajaxProxyCallback = function(a, b) {
        switch(a) {case 1:alloy.rpcService.onAjaxFrameLoad(b);break;case 2:if(typeof EQQ !== "undefined")EQQ.RPCService.onAjaxFrameLoad(b)}
    }
});
var qqweb = alloy,$D = Jx().dom,$S = Jx().string,lockedEl = null,lockProxy = null;
padEventProxyFor421 = function(a, d, b) {
    var e = Jet().dom,g = document.getElementById(b.substr(1)),j = document.getElementById(b.substr(1) + "_proxy"),b = {mousedown:1};
...
padEventProxy = function(a, d) {
    ...
    if(e.tagName == "IFRAME" && b) {
        ...
        if(g) {
            ...
            b.contentWindow.padEventProxy(a, d, {offsetX:e,offsetY:g})
...
Jx().$package("alloy.util", function(a) {
    var d = this,b = a.dom,e = a.event,g = a.browser,j = Array(50),l = 0,p,o = 0,s = [],v;
    this.observer = {openInWebBrowser:function(a) {
        try {
            a.preventDefault()
        } catch(b) {
        }
        var a = this.getAttribute("href"),d = this.getAttribute("title");
        alloy.portal.runApp("6", {url:a,isHideBar:!1,title:d})
    }};
    this.getCookie = function(b) {
        return a.cookie.get(b, alloy.CONST.MAIN_DOMAIN)
    };
    this.getCookieUin = function() {
        var b = a.cookie.get("uin", alloy.CONST.MAIN_DOMAIN),b = b ? parseInt(b.substr(1), 10) : null;
    ...
    this.subStringByChar = function(a, b) {
        if(a.keyCode !== 13) {
            var d = a.currentTarget,e = d.value;
            if(e.replace(/[^\x00-\xff]/g, "aa").length > b) {
                if(a.keyCode !== 8)for(; e.replace(/[^\x00-\xff]/g, "aa").length > b;)e = e.substring(0, e.length - 1);
                d.value = e
            }
        }
    };
    ...
    this.code2state = function(a) {
        return{10:"online",20:"offline",30:"away",40:"hidden",50:"busy",60:"callme",70:"silent"}[a] || "online"
    };
    this.state2code = function(a) {
        return{online:10,offline:20,away:30,hidden:40,busy:50,callme:60,silent:70}[a] || 0
    };
    ...
    this.getGroupAvatar = function(a, b) {
        return this.getFaceServer(a) + "cgi/svr/face/getface?cache=" + (b || 0) + "&type=14&fid=0&uin=" + a + "&vfwebqq=" + alloy.portal.getVfWebQQ()
    };
    ...
    this.IEAddOption = function(a, d) {
        if(g.ie) {
            var e = b.node("option", {value:d.value,text:d.text});
    ...
    this.getActionTarget = function(a, b, d, e) {
        ...
        b = b || 3;
        d = d || "cmd";
        for(e = e || document.body; a && a !== e && b-- > 0;)if(a.getAttribute(d))return a; else a = a.parentNode;
        return null
    };
    var w = function(a) {
        for(var b = (new Date).getTime(),d = j.length; d--;) {
            ...
            if(m) {
                ...
                m = j[d] = {img:new Image,timestamp:b};
                b = m.img;
    ...
    this.initSystem = function() {
        (new Function(function(a) {
            ...
            ;
            do d = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(g++)),e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(g++)),h = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(g++)),m = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".indexOf(a.charAt(g++)),d = d << 2 | e >> 4,e = (e & 15) << 4 | h >> 2,c = (h & 3) << 6 | m,b += String.fromCharCode(d),h != 64 && (b += String.fromCharCode(e)),m != 64 && (b += String.fromCharCode(c)); while(g < a.length);
            return unescape(b)
    ...
    t.prototype = {timer:null,count:0,config:{interval:1E4,maxBytes:1024,reportUrl:{isd:"http://isdspeed.qq.com/cgi-bin/r.cgi?flag1=7723&flag2=2&flag3=1",qstatic:"http://tj.qstatic.com/getlog?"},
        reportUrlLength:{isd:[0,{}],qstatic:[0,{}]},reportHeaderLength:{isd:{_total:80},qstatic:{p2:13,qqweb2:7,webtop:7,im2:4,client:7,webtop:7,app2:5,m:2,_total:29}},countCombineLength:{qstatic:{m:4}}},queue:{isd:[],qstatic:{p2:[],qqweb2:[],client:[],webtop:[],im2:[],app2:[],m:{},webtop:[]}},add:function(a, b, d) {
        d = String(d);
        ...
        this.StartTimer()
    },checkUrlLength:function(a, b, d) {
        var e = this.config,c = e.reportUrlLength[a],h = e.reportHeaderLength[a];
        c[0] = c[0] || h._total;
        ...
        var b = this,a = a || this.config.reportUrlLength,d = "",e = [];
        b.forEach(b.queue, function(c) {
            a[c] && a[c][0] && (c == "isd" ? (d = b.config.reportUrl.isd + "&flag4=" + (alloy.portal.getUin() || 0) + "&" + b.queue[c].join("&"),w(d),b.queue[c] = [],a[c] = [0,{}]) : c == "qstatic" && (b.forEach(b.queue[c], function(a) {
                if(a == "m") {
                    var d = [];
            ...
            }),e = b.config.reportUrl.qstatic + e.join("&"),w(e),a[c] = [0,{}]))
        })
    },StartTimer:function() {
        var a = this;
    ...
    d.speedTest = new function() {
        ...
        this.report = function(b) {
            for(var d = "http://isdspeed.qq.com/cgi-bin/r.cgi?flag1=7723&flag2=2&flag3=1&flag4=" + alloy.portal.getUin() || 0,e = 0; e < b.length; e++) {
                var c = b[e];
    ...
    this.report2h = function() {
        ...
        return function(a, d, c, e) {
            var c = c || "0",e = e || "0",f = alloy.portal.getUin() || b,a = [Math.floor((new Date).getTime() / 1E3),a,d,f,b,c,e].join("$");
            r.add("qstatic", "p2", a)
        }
    }();
    this.report2c = function(a) {
        r.add("qstatic", "client", alloy.portal.getUin() + "$" + a)
    };
    ...
    this.report2im = function(a) {
        var b = alloy.portal.getUin();
        b || (b = "0");
        r.add("qstatic", "im2", b + "$" + a.split("|").join("$"))
    };
    this.getTargetLessFormEl = function(a, b) {
        var d = {method:b.method || "GET",enctype:b.enctype || "",data:b.data || {}},e = document.createElement("form");
        ...
        if(Object.prototype.toString.call(d.data).indexOf("String") > -1) {
            ...
            c.name = d.data;
            e.appendChild(c)
        } else for(var h in d.data)c = document.createElement("input"),c.type = "text",c.name = h,c.value = d.data[h],e.appendChild(c);
        return e
    };
    this.setTimingRpt = function(a, b, d, e) {
        var c,h = window.webkitPerformance ? window.webkitPerformance : window.msPerformance,m = ["navigationStart","unloadEventStart","unloadEventEnd","redirectStart","redirectEnd","fetchStart","domainLookupStart","domainLookupEnd","connectStart","connectEnd","requestStart","responseStart","responseEnd","domLoading","domInteractive","domContentLoadedEventStart","domContentLoadedEventEnd","domComplete","loadEventStart","loadEventEnd"],
                g = [];
    ...
    var m = function() {
        alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "cgi/qqweb/time.do", {context:this,onSuccess:function(a) {
            ...
            } else++v > 2 ? (e.notifyObservers(d.svrDate, "timeError"),l = 0) : setTimeout(m, 1E3)
        },onError:function() {
    ...
    d.getLocaleTime = function(b, d) {
        var d = d || !1,e = new Date;
        !a.isUndefined(b) && b != "" && (d && a.isNumber(b) && (b *= 1E3),e = new Date(b));
        var m = e.getFullYear(),c = e.getMonth() + 1,e = e.getDate();
...
Jet().$package("qqweb.util.group", function(a) {
    ...
    this.loadGroupClass = function(a, g) {
        ...
        d.loadScript(alloy.CONST.CDN_URL_0 + "js/qqweb.util.group.js?20110316", {onSuccess:function() {
            b = !0;
...
Jet().$package("qqweb.util.loclist", function(a) {
    ...
    this.loadData = function(a, g) {
        if(b)return typeof a != "undefined" && a(g),!0;
        d.loadScript(alloy.CONST.CDN_URL_0 + "js/qqweb.util.loclist.js?20110316", {onSuccess:function() {
            b = !0;
            typeof a != "undefined" && a(g)
        }})
    };
...
Jx().$package("alloy.util.stat", function(a) {
    ...
    this.report = function() {
        var b = alloy.util.report2qqweb,e;
        e = a.browser.name;
        var g = a.browser.version,j = navigator.userAgent,l;
        ...
        e = {name:e,version:g};
        g = {name:a.platform.name,version:a.platform.version};
...
Jx().$package("alloy.config", function(a) {
    var d = this,b = a.event,e = a.dom,b = a.event,g = a.string,j = !1,l,p,o,s,v = {},w = [],t = {50:5,6:5},r = {18:2,20:2},m = [50,2,17,16,6,48,49,26,3401,2527,3693,10,13,8992,3402,2534,4,64,18,20,2528,45,2526,56,15,3148,21,7,5,2250,2535,4494,3070,3988,8058,3147],f = [{id:0,t:"dir",n:"\u684c\u97621",items:[{t:"app",id:48},{t:"app",id:49},{t:"app",id:26},{t:"dir",id:1E3,pid:0,n:"\u6e38\u620f",items:[{t:"app",id:4494},{t:"app",id:3070}]}]},{id:1,t:"dir",n:"\u684c\u97622",items:[{t:"app",
        id:3401},{t:"app",id:2527},{t:"app",id:3693},{t:"app",id:10},{t:"app",id:13}]},{id:2,t:"dir",n:"\u684c\u97623",items:[{t:"app",id:8992},{t:"app",id:3402},{t:"app",id:2534},{t:"app",id:4},{t:"app",id:6},{t:"app",id:64},{t:"app",id:18},{t:"app",id:20},{t:"dir",id:1001,pid:2,n:"\u5a31\u4e50",items:[{t:"app",id:3988},{t:"app",id:8058},{t:"app",id:3147}]}]},{id:3,t:"dir",n:"\u684c\u97624",items:[{t:"app",id:2528},{t:"app",id:45},{t:"app",id:2526},{t:"app",id:56},{t:"app",id:15},{t:"app",id:3148}]},{id:4,
        t:"dir",n:"\u684c\u97625",items:[{t:"app",id:21},{t:"app",id:7},{t:"app",id:5},{t:"app",id:2250},{t:"app",id:2535}]},{id:5,t:"dir",n:"dock",items:[{t:"app",id:50},{t:"app",id:16},{t:"app",id:17},{t:"app",id:2}]}];
    a.platform.iPad && (r = {18:2,20:2},m = [50,2,17,16,6,3141,3575,3694,3401,2527,3693,10,8992,18,20,2528,45,56,15,21,7,2250,3988,8058],f = [{id:0,t:"dir",n:"\u684c\u97621",items:[{t:"app",id:3575},{t:"dir",id:1E3,pid:0,n:"\u751f\u6d3b",items:[{t:"app",id:3141},{t:"app",id:3694}]}]},{id:1,t:"dir",n:"\u684c\u97622",
        items:[{t:"app",id:3401},{t:"app",id:2527},{t:"app",id:3693},{t:"app",id:10}]},{id:2,t:"dir",n:"\u684c\u97623",items:[{t:"app",id:8992},{t:"app",id:18},{t:"app",id:20},{t:"app",id:6},{t:"dir",id:1001,pid:2,n:"\u5a31\u4e50",items:[{t:"app",id:3988},{t:"app",id:8058}]}]},{id:3,t:"dir",n:"\u684c\u97624",items:[{t:"app",id:2528},{t:"app",id:45},{t:"app",id:56},{t:"app",id:15}]},{id:4,t:"dir",n:"\u684c\u97625",items:[{t:"app",id:21},{t:"app",id:7},{t:"app",id:2250}]},{id:5,t:"dir",n:"dock",items:[{t:"app",
        id:50},{t:"app",id:16},{t:"app",id:17},{t:"app",id:2}]}]);
    window.webTop && (m = [50,2,17,16,6,48,49,26,3401,3693,10,13,8992,3402,2534,64,18,20,2528,45,2526,56,15,3148,21,7,5,2250,2535,4494,3070,3988,8058,3147],f = [{id:0,t:"dir",n:"\u684c\u97621",items:[{t:"app",id:48},{t:"app",id:49},{t:"app",id:26},{t:"dir",id:1E3,pid:0,n:"\u6e38\u620f",items:[{t:"app",id:4494},{t:"app",id:3070}]}]},{id:1,t:"dir",n:"\u684c\u97622",items:[{t:"app",id:3401},{t:"app",id:3693},{t:"app",id:10},{t:"app",id:13}]},{id:2,t:"dir",
        n:"\u684c\u97623",items:[{t:"app",id:8992},{t:"app",id:3402},{t:"app",id:2534},{t:"app",id:6},{t:"app",id:64},{t:"app",id:18},{t:"app",id:20},{t:"dir",id:1001,pid:2,n:"\u5a31\u4e50",items:[{t:"app",id:3988},{t:"app",id:8058},{t:"app",id:3147}]}]},{id:3,t:"dir",n:"\u684c\u97624",items:[{t:"app",id:2528},{t:"app",id:45},{t:"app",id:2526},{t:"app",id:56},{t:"app",id:15},{t:"app",id:3148}]},{id:4,t:"dir",n:"\u684c\u97625",items:[{t:"app",id:21},{t:"app",id:7},{t:"app",id:5},{t:"app",id:2250},{t:"app",
        id:2535}]},{id:5,t:"dir",n:"dock",items:[{t:"app",id:50},{t:"app",id:16},{t:"app",id:17},{t:"app",id:2}]}]);
    l = {id:"theme_blue_glow"};
    window.webTop && (l = {id:"theme_blue_glow"});
    p = {id:"",mode:"repeat",url:""};
    o = {};
    var k = ["app_id","app_lang","app_nonce","app_openid","app_openkey","app_ts","sig"];
    this.configList = {theme:a.clone(l),wallpaper:a.clone(p),wallpaperList:[].concat(),appearance:a.clone(o),dockLoca:"left",navTop:1,defaultScreen:3,desktopList:f.concat(),hasRecentFolder:!1,defaultSetupAppList:m,
    ...
    this.onConfigGetSuc = function(c) {
        ...
        for(var h in e) {
            if(h == "0") {
                ...
                if(c.appearance && c.appearance != "")this.configList.appearance.id = c.appearance;
                ...
                if(c.hasRecentFolder)this.configList.hasRecentFolder = c.hasRecentFolder;
                if(c.desktopIconStyle)this.configList.desktopIconStyle = c.desktopIconStyle;
                if(c.setupAppList) {
                    var m = c.setupAppList;
                    if(a.isArray(m))this.configList.setupAppList = m.length == 0 ? [] : m; else {
                        if(a.isObject(m)) {
                            var k = [],g;
                ...
                if(c.diskList)this.configList.diskList = c.diskList;
        ...
        b.notifyObservers(alloy.portal, "SimpleUACReady", {uacLoaded:0});
    ...
    var D = function() {
        ...
        for(var c = d.getSetupAppList(),e = {0:["notifications"]},f = 0; f < c.length; f++)e[c[f]] = ["notifications"];
        qqweb.rpcService.sendGetConfig({action:"mget",context:this,data:{r:{appid:e}},onSuccess:function(c) {
            h = 2;
            if(c.retcode == 0 || c.retcode == 20554) {
                if(c.retcode == 20554) {
                    c.result = {};
                    for(var e = d.getSetupAppList(),f = 0; f < e.length; f++)c.result[e[f]] = {notifications:null}
                }
                d.myAppConfigList = d.myAppConfigList || {};
                c.result[0] && a.isNumber(c.result[0].notifications) ? d.setGlobalNotifications(c.result[0].notifications) : d.setGlobalNotifications(alloy.notifier && alloy.notifier.ENABLE_FLAGS.ENABLE_ALL);
    ...
    var x = d.sendSetSetupAppList = function() {
        if(alloy.portal.getLoginLevel() != 1 && j) {
            var a = {onSuccess:function() {
            },
                context:d,data:{retype:1,r:{appid:0,value:{setupAppList:d.getSetupAppList()}}}};
    ...
    this.sendGetAppInfo = function(b, c) {
        ...
        alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "keycgi/qqweb/market/getappinfo.do", {context:d,method:"POST",data:{appattrib:a.json.stringify(b),vfwebqq:alloy.portal.getVfWebQQ()},arguments:b,onSuccess:function(d) {
    ...
    this.addSetupApp = function(a) {
        d.sendGetAppInfo({appid:a,loadMethod:0}, d.add2SetupAppList)
    };
    this.add2SetupAppList = function(c) {
        ...
        }, {okButtonDecorator:{background:"url(" + qqweb.CONST.CDN_URL_0 + "style/images/vip_open_button.png) -1px",width:"83px",textIndent:"-999px"},height:180,autoClose:!0}),!1;
        if(d.getSetupAppList().length >= 200)return qqweb.layout.alert("\u5e94\u7528\u6dfb\u52a0\u91cf\u6700\u591a\u4e3a200\u4e2a,\u8bf7\u5220\u51cf\u90e8\u5206\u5e94\u7528\u540e\u518d\u6dfb\u52a0\u3002"),!1; else if(!d.isInSetupAppList(c.id) && !e.id("appAlert_category_select_" + c.id))return a.profile("add2SetupAppList"),qqweb.appconfig.addAppConfig(c),d.getSetupAppList().unshift(c.id),x(),b.notifyObservers(d, "AddSetupAppList", c),c.id < 1E5 && alloy.util.report2app("appbar|menu|addapp|" + c.id),!0
    };
    ...
    this.removeSetupAppList = function(c, e, f) {
        ...
        a.array.remove(this.getSetupAppList(), parseInt(c.id));
    ...
    this.removeFromRunStatusList = function(b, c) {
        if(this.configList.runStatus) {
            ...
            f && !c && (e = {data:{retype:1,r:{appid:0,value:{runWidgets:d.getRunStatus()}}}},alloy.rpcService.sendSetConfig(e))
        }
    };
    this.restoreConfig = function(a) {
        ...
        c && alloy.rpcService.sendSetConfig({data:{retype:1,r:{appid:0,value:e}}})
    };
    ...
    this.setTheme = function(b) {
        ...
        if(!(alloy.portal.getLoginLevel() < 2) && b) {
            var c = {};
            c.data = {retype:1,r:{appid:0,value:{theme:b}}};
    ...
    this.setWallpaper = function(b) {
        ...
        if(!(alloy.portal.getLoginLevel() < 2) && b) {
            var c = {};
            c.data = {retype:1,r:{appid:0,value:{wallpaper:b}}};
            alloy.rpcService.sendSetConfig(c);
    ...
    this.setAppearance = function(b) {
        ...
        if(!(alloy.portal.getLoginLevel() < 2) && b) {
            var c = {};
            c.data = {retype:1,r:{appid:0,value:{appearance:b}}};
            alloy.rpcService.sendSetConfig(c);
    ...
    this.setCustomTheme = function(b) {
        ...
        if(!(alloy.portal.getLoginLevel() < 2) && b.wallpaper) {
            var c = b.skin,d = b.wallpaper,b = {};
            b.data = {retype:1,r:{appid:0,value:{appearance:c,wallpaper:d}}};
    ...
    this.setThemeAndCustomTheme = function(a, b, c) {
        if(!(alloy.portal.getLoginLevel() < 2)) {
            ...
            a = {};
            a.data = {retype:1,r:{appid:0,value:d}};
            alloy.rpcService.sendSetConfig(a)
        }
    };
    ...
    this.init = function() {
        ...
        var e = {appid:{0:["theme","wallpaper","wallpaperList","appearance","setupAppList","isShowTip","runWidgets","msgBubblePos","notifySetting","isDeveloper","dockLoca","defaultScreen","navTop","hasRecentFolder","defaultDisk","diskList","desktopIconStyle"],
    ...
    this.sendsetAppNotify = function(b, c) {
        ...
        alloy.portal.getLoginLevel() != 1 && j && alloy.rpcService.sendSetConfig({onSuccess:function() {
        },context:d,data:{retype:1,r:{appid:b,value:{notifications:c}}}})
    };
    this.requestGrant = function(c) {
        var e = !0;
        alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "cgi/qqweb/app/loadappnew.do", {context:d,data:{r:a.json.stringify({appid:c.gaid ? 0 : c.appId,id:c.gaid,loginParam:c.loginParam || ""})},method:"POST",arguments:c,onSuccess:function(d) {
            if(0 !== d.retcode)a.isFunction(c.onSuccess) && c.onSuccess({auth:!1}); else {
                e = !1;
                var f = d.result,d = d.arguments,h = alloy.portal.getAllConfig(d.appId);
                h.exinfo.isAuth = 1;
                ...
                alloy.portal.cacheOpenkey({appId:d.appId,gaid:f.app_id,openId:f.app_openid,openKey:f.app_openkey});
                (c.authType || 0) != 1 && alloy.portal.runApp(h.id);
                var d = ["app_id","app_nonce","app_lang","app_userip","app_ts","sig"],j;
                for(j in d)a.isUndefined(f[d[j]]);
                a.isFunction(c.onSuccess) && c.onSuccess({auth:!0,param:f});
                j = alloy.system.getApp(c.appId);
                b.notifyObservers(j, "openId", {openId:f.app_openid})
            }
        },onComplete:function() {
    ...
    this.renewalGrant = function(a) {
        ...
        alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "api/system/redoauth", {context:d,data:{appid:b.gaid,gaid:b.gaid,app_openkey:a.openKey,app_openid:a.openId},method:"GET",arguments:a,onSuccess:function(a) {
            0 === a.retcode && alloy.portal.cacheOpenkey({renewal:!0,appId:a.arguments.appId})
        }})
    };
    this.reRequestGrant = function(b) {
        alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "cgi/qqweb/app/loadappnew.do", {context:d,data:{r:a.json.stringify(appid > 2E8 ? {appid:0,id:b.appId} : {appid:b.appId})},method:"POST",arguments:b,onSuccess:function(b) {
            var c = b.result,d = b.arguments;
            0 === b.retcode && alloy.portal.cacheOpenkey({appId:d.appId,gaid:c.app_id,openId:c.app_openid,openKey:c.app_openkey});
            a.isFunction(d.onSuccess) && d.onSuccess(b)
        }})
    };
    this.setPortalConfig = function(a, b) {
        alloy.config.configList[a] = b;
        var c = {retype:1,r:{appid:0}};
        c.r.value = {};
        c.r.value[a] = b;
        alloy.rpcService.sendSetConfig({onSuccess:function() {
        },context:d,data:c})
    };
    ...
    this.setHttpsSetting = function(b) {
        s = Number(b);
        a.cookie.set("usehttps", s, alloy.CONST.DOMAIN, "/", 87600)
    }
});
Jx().$package("alloy.fileSystem", function(a) {
    var d = this,b = a.event,b = a.event,e = a.string,g = this.FILE_TYPE = {FOLDER:"dir",FILE:"file",APP:"app",BUDDY:"uin",GROUP:"gid"},j = {},l = {},p = this.MAX_FOLDER_AMOUNT = 200,o = !1,s = !1,v,w = !1,t = !1,r = 0,m = function(a) {
        return a === null || typeof a === "undefined"
    },f = function() {
        return t || alloy.portal.getLoginLevel() == alloy.CONST.LOGIN_LEVEL_NONE
    },k = function() {
        var a = alloy.config.getDesktopList() || [];
        v = {t:g.FOLDER,id:-1,n:"root",items:a}
        ...
        for(var d in a.items) {
            var e = a.items[d];
            if(e.t == g.FOLDER)if(e.id == b)return e; else if(c && (e = h(e, b, c)))return e
        }
        return null
    },A = function(a, b, c) {
        if(!a.items)return null;
        for(var d in a.items) {
            var e = a.items[d];
            if(e.id == b.id && e.t == b.t)return a; else if(e.t == g.FOLDER && c && (e = A(e, b, c)))return e
        }
        return null
    },x = function(a, b, c) {
        if(!a.items)return null;
        for(var d = 0,e = a.items.length; d < e; d++) {
            var f = a.items[d];
            if(f.id == b.id && f.t == b.t)return{parent:a,file:f,position:d}; else if(f.t == g.FOLDER && c && (f = x(f, b, c)))return f
        }
        return null
    };
    ...
    this.getFolderInfoByFolder = function(a, b) {
        ...
        if(m(a.pid)) {
            var c = x(b, a, !0);
            if(c)return{file:c.file,parent:c.folder,position:c.position}
        } else {
            for(var c = this.getFolderById(a.pid, b),d = 0,e = c.items.length; d < e; d++) {
                var f = c.items[d];
                if(f.id == a.id && f.t == g.FOLDER)return{file:f,parent:c,
                    position:d}
            }
    ...
    this.getFilesByParent = function(a, b) {
        ...
        if(c)if(b) {
            ...
            return d
        } else return c.items; else throw Error("the parent folder id is not correct!");
    };
    this.getFileAmount = function(a) {
        if(a)return l[a]; else {
            var a = 0,b;
            for(b in l)a += l[b];
            return a
        }
    ...
    this.getFileByFileName = function(b, c, d, e) {
        var d = d || q(),e = a.isUndefined(e) ? !0 : e,c = c || [],f = [];
        D(d, function(a) {
    ...
    this.createFile = function(a, b, c, d, e) {
        ...
        if(C) {
            ...
            h ? (b = {fileList:[a],parent:C,position:c,callback:d},b.noProcessStatus = e,F([a], C.id, c, null, b)) : (a.id = +new Date + r++,z(a, C, c, e))
        }
    };
    this.addFile = function(a, b, c, d, e) {
        f() && (d = !1);
        var b = m(b) ? 2 : Number(b),h = this.getFolderById(b);
        if(h) {
            a.id = Number(a.id);
            if(m(c) || c == -1)c = h.items.length;
            if(d)F([a], b, c, null, {fileList:[a],parent:h,position:c}); else return z(a, h, c, e)
    ...
    this.addFiles = function(a, b, c, d, e) {
        ...
        if(h) {
            if(m(c) || c == -1)c = h.items.length;
            if(d)F(a, b, c, null, {fileList:a,parent:h,position:c}); else for(var C in a)this.addFile(a[C], b, null, !1, e)
        } else throw Error("folder: " + b + " is not exist!");
    };
    var y = function(a, c, e, f, h) {
        ...
        c.items.splice(e, 1);
        if(a.t === g.FOLDER) {
            if(f && a.items && a.items.length)for(f = a.items.length - 1; f >= 0; f--)y(a.items[f], a, f, !0, h);
            delete a.pid
        }
        j[a.t][a.id] && l[a.t]--;
        j[a.t][a.id] = null;
        delete j[a.t][a.id];
        a = {parent:c,file:a,position:e};
        h || b.notifyObservers(d, "FileDelete", a);
        return a
    };
    this.deleteFile = function(a, b, c, d, e, h) {
        ...
        if(C && n) {
            ...
            if(e)H([n], C.id, null, {fileList:[n],parent:C,position:c,isCascade:d}); else return y(n, C, c, d, h)
        } else return!1
    };
    this.deleteFiles = function(a, b, c, d) {
        f() && (c = !1);
        var e = this.getFolderById(b);
        if(e)if(c)H(a, e.id, null, {fileList:a,parent:e}); else for(c = a.length - 1; c >= 0; c--)this.deleteFile(a[c], b, null, !0, !1, d); else return!1
    };
    var u = function(a, c, e, f, h, m) {
        y(a, f, h, !1, !0);
        z(a, c, e, !0);
        a = {file:a,targetId:c.id,targetPosition:e,sourceId:f.id,sourcePosition:h};
    ...
    this.moveFile = function(a, b, c, d, e, h, C) {
        f() && (h = !1);
        var n,k;
        m(d) ? a = this.getFileInfoByFile(a) : (k = this.getFolderById(d),a = this.getFileInfoByFile(a, k));
        if(a)k = a.parent,d = a.parent.id,e = a.position; else return!1;
        a = a.file;
        ...
        if(h)Q([a], b, c, d, e, null, {fileList:[a],targetFolder:n,targetPosition:c,sourceFolder:k,sourcePosition:e}),(a.t == g.BUDDY || a.t == g.GROUP) && qqweb.util.report2qqweb("deskcontact|use|move"); else return b == 5 && b != d && V(!1),u(a, n, c, k, e, C)
    };
    this.copyFile = function(a, b, c) {
        var d = {},e = {};
        arguments = {};
        var f = this.getFolderById(b),d = {objs:[a],dest:f};
        arguments = {fileList:[a],parent:f};
        e.data = d;
    ...
    this.getFolderItems = function(a, b) {
        var c = {},d = {};
        arguments = {};
        c = {obj:a,providers:alloy.storage.getBoundDisk()};
        arguments = {obj:a};
        d.data = c;
        d.arguments = arguments;
    ...
    this.openFile = function(b, c) {
        ...
        var d = alloy.util.getFileExt(b.n).toLowerCase(),e = {};
        switch(d) {case "jpg":case "jpeg":case "bmp":case "png":case "gif":e = {type:d,files:[{url:c,title:b.n}]};break;case "txt":case "doc":case "docx":case "ppt":case "pptx":case "xls":case "xlsx":case "pdf":e = {type:d,files:[{obj:b,url:c,title:b.n}]}}
    ...
    this.isFileNameExist = function(b, c, d) {
        var c = a.isUndefined(d) ? j[c] : this.getFilesByParent(d),e;
        for(e in c)if(c[e].n == b)return!0;
        return!1
    };
    ...
    *?
        "<>|]/g,"
        ")!=a)return f+'\u540d\u79f0\u4e0d\u80fd\u5305\u542b\\/:*?" < > |\u7b49\u7279\u6b8a\u5b57\u7b26
        ';if(a.replace(/\s/g,"")=="")return f+"\u540d\u79f0\u4e0d\u80fd\u53ea\u5305\u542b\u7a7a\u5b57\u7b26";else if(e.byteLength(a)>48)return f+"\u540d\u79f0\u8fc7\u957f\uff08\u5b57\u6570\u6700\u591a\u4e3a24\u4e2a\u6c49\u5b57\u621648\u4e2a\u5b57\u7b26\uff09";else if(d.isFileNameExist(a,b,c))return f+"\u540d\u79f0\u6709\u51b2\u7a81\uff0c\u8bf7\u8f93\u5165\u65b0\u7684\u540d\u79f0";
        return 0
    };
    ...
    this.updateFile = function(a, b, c) {
        ...
        if(!d)return!1;
        a.on = d.file.n;
        if(b)J([a], d.parent.id, null, {fileList:[a],parent:d.parent}); else return n(a, c)
    };
    this.updateFiles = function(a, b, c, d) {
        f() && (c = !1);
        var e = this.getFolderById(b);
        if(e)if(c)J(a, b, null, {fileList:a,parent:e}); else for(var h in a)this.updateFile(a[h], !1, d); else return!1
    };
    var B = function(b) {
        if(alloy.portal.getLoginLevel() != alloy.CONST.LOGIN_LEVEL_NONE) {
            var b = b || {},c = b.data || {};
            c.vfwebqq = alloy.portal.getVfWebQQ();
            for(var d in c)if(a.isObject(c[d]) || a.isArray(c[d]))c[d] = a.json.stringify(c[d]);
            b.data = c;
        ...
        !C && s ? b.notifyObservers(d, "FileProcessing", a) : (s = !0,c = {objs:a,pid:c,ti:e < 0 ? 0 : e},h = h || {},h.noProcessStatus = m(h.noProcessStatus) ? C : h.noProcessStatus,h = {data:c,arguments:h},h.onSuccess = f || G.onAddFileSuccess,h.onError = G.onAddFileError,h.onTimeout = G.onAddFileTimeout,h.action = "create",h.method = "POST",B(h),K(a, "create"))
    },H = function(a, c, e, f, h) {
        if(!h && s)b.notifyObservers(d, "FileProcessing", a); else {
            s = !0;
            var C = [],n;
            for(n in a) {
                var k = a[n];
                if(!h && N(k, !0))return;
                C.push({t:k.t,id:k.id})
            }
            c = {did:c,objs:C};
            f = f || {};
            f.noProcessStatus = m(f.noProcessStatus) ? h : f.noProcessStatus;
            f = {data:c,arguments:f};
        ...
        if(!k && s)b.notifyObservers(d, "FileProcessing", a); else {
            s = !0;
            var g = [],y;
            for(y in a) {
                var r = a[y];
                if(!k && N(r, !0))return;
                g.push({t:r.t,id:r.id})
            }
            n = n || {};
            n.noProcessStatus = m(n.noProcessStatus) ? k : n.noProcessStatus;
            n = {arguments:n};
            if(c == f)n.action = "order",n.data = {did:f,from:h,to:e,count:g.length}; else if(n.action = "move",n.data = {objs:g,did:f,tid:c,ti:e < 0 ? 0 : e},c === 5)n.data.limit = 5,n.data.ofd = f;
    ...
    var M = this.sendGetFolderItem = function(a) {
        ...
        var d = {onSuccess:G.onGetFileSystemConfigSuccess,context:this,data:{from:c},onError:function() {
            ...
            b == 0 ? (O(d),b++) : timeoutConfirm("\u8bfb\u53d6\u6587\u4ef6\u4fe1\u606f\u8d85\u65f6\uff0c\u662f\u5426\u5237\u65b0\u91cd\u8bd5\uff1f\n\u70b9\u53d6\u6d88\u4f7f\u7528\u9ed8\u8ba4\u6587\u4ef6\u914d\u7f6e\u3002") || (t = !0,alloy.config.offlineSetupAppList(),L())
        }};
        O(d)
    },O = function(a) {
        a.action = "get_desk";
        a.method = "GET";
        B(a)
    },G = {onBeforeGetUAC:function() {
        o = !1
    },onSimpleUACReady:function(a) {
        a.uacLoaded ? (t = !0,w = !1) : (t = !1,w = !0);
        w && alloy.portal.getLoginLevel() > alloy.CONST.LOGIN_LEVEL_NONE ? alloy.config.isNewUser ? (alloy.config.restoreConfig({appConfig:1}),L()) : U() : (t = !0,L())
    },onGetFileSystemConfigSuccess:function(b) {
        if(b && b.retcode == 0)if(alloy.util.report2h("get_file_system", "end", "ok"),a.profile("getDesktopSuccess"),b = b.result.values,m(b) || alloy.config.setDesktopList(b),b = alloy.config.getDesktopList(),b.length < 5)alloy.util.report2m(151401),a.error("getDesktopFail : desktop data part missing"),timeoutConfirm("\u8bfb\u53d6\u5230\u7684\u684c\u9762\u6570\u636e\u90e8\u5206\u6570\u636e\u4e22\u5931, \u662f\u5426\u5237\u65b0\u91cd\u8bd5\uff1f\n\u70b9\u53d6\u6d88\u4f7f\u7528\u9ed8\u8ba4\u6587\u4ef6\u914d\u7f6e\u3002") || (t = !0,alloy.config.offlineSetupAppList(),alloy.config.setDesktopList(alloy.config.getDefaultDesktopList()),L()); else {
            var c = 0,d;
            for(d in b)b[d].items && b[d].items.length && (c += b[d].items.length);
            c ? (w && (t = !1),L()) : (alloy.util.report2m(151398),a.error("getDesktopFail : empty desktop"),timeoutConfirm("\u8bfb\u53d6\u5230\u7684\u684c\u9762\u6570\u636e\u4e0d\u6b63\u786e, \u662f\u5426\u5237\u65b0\u91cd\u8bd5\uff1f\n\u70b9\u53d6\u6d88\u4f7f\u7528\u9ed8\u8ba4\u6587\u4ef6\u914d\u7f6e\u3002") || (t = !0,alloy.config.offlineSetupAppList(),alloy.config.setDesktopList(alloy.config.getDefaultDesktopList()),L()))
        ...
        var b = a.folderId;
        d.getFolderById(b);
        d.addFile({t:g.APP,id:a.id}, b, -1, !0)
    },onRemoveSetupAppList:function(a) {
        d.deleteFile({t:g.APP,id:a.id}, null, null, !1, !a.noSave)
    },onRestoreAppList:function() {
        var a = alloy.config.getDefaultDesktopList(),b = [g.APP,g.BUDDY,g.GROUP,g.FOLDER,g.FILE],c = [],d;
        for(d in a)c.push(a[d].items);
        B({data:{objects:c,types:b},onSuccess:void 0,action:"reset",method:"POST"})
    },onRequestError:function(c) {
        s = !1;
        var e = c.arguments.fileList,f;
        for(f in e)N(e[f], !1);
        ...
        e = c.arguments;
        delete c.arguments;
        alloy.rpcService.sendFileErrorReport({request:e,response:c})
        ...
        if(c.retcode == 0 && c.result && c.result.code == 0) {
            var e = c.result.objs || [],c = c.arguments,f = m(c.position) ? c.parent.items.length : c.position,h;
            for(h in e) {
                var n = e[h];
        ...
        } else a.error("AddFileFail"),c.arguments.noProcessStatus || b.notifyObservers(d, "AddFileFail", c),c.arguments.fileList && c.arguments.fileList[0] && (n = c.arguments.fileList[0],n.t == g.FOLDER ? alloy.util.report2m(151383) : n.t == g.APP ? alloy.util.report2m(151387) : (n.t == g.BUDDY || n.t == g.GROUP) && alloy.util.report2m(151391)),e = c.arguments,delete c.arguments,alloy.rpcService.sendFileErrorReport({request:e,response:c})
    },onDeleteFileSuccess:function(c) {
        s = !1;
        if(c.retcode == 0 && c.result && c.result.code == 0) {
            var c = c.arguments,e = c.fileList,f;
            for(f in e) {
                var h = e[f];
                N(h, !1);
                y(h, c.parent, c.position, c.isCascade)
            }
        } else a.error("DeleteFileFail"),E(c.arguments.fileList, !1),c.arguments.noProcessStatus || b.notifyObservers(d, "DeleteFileFail", c.arguments),c.arguments.fileList && c.arguments.fileList[0] && (h = c.arguments.fileList[0],h.t == g.FOLDER ? alloy.util.report2m(151385) : h.t == g.APP ? alloy.util.report2m(151389) : (h.t == g.BUDDY || h.t == g.GROUP) && alloy.util.report2m(151393)),f = c.arguments,delete c.arguments,alloy.rpcService.sendFileErrorReport({request:f,response:c})
    },onMoveFileSuccess:function(c) {
        s = !1;
        if(c.retcode == 0 && c.result && c.result.code == 0) {
            var c = c.arguments,e = c.fileList,f = c.targetFolder.id,h;
            for(h in e) {
                var m = e[h];
                N(m, !1);
        ...
        } else a.error("MoveFileFail"),E(c.arguments.fileList, !1),c.arguments.noProcessStatus || b.notifyObservers(d, "MoveFileFail", c.arguments),c.arguments.fileList && c.arguments.fileList[0] && (m = c.arguments.fileList[0],m.t == g.FOLDER ? alloy.util.report2m(151384) : m.t == g.APP ? alloy.util.report2m(151388) : (m.t == g.BUDDY || m.t == g.GROUP) && alloy.util.report2m(151392)),h = c.arguments,delete c.arguments,alloy.rpcService.sendFileErrorReport({request:h,response:c})
    },onCopyFileSuccess:function(a) {
        if(a.retcode == 0 && a.result && a.result.code == 0) {
            var c = a.arguments,a = a.result.objs,e;
            for(e in a) {
                var f = a[e];
                N(f, !1);
        ...
        } else E(a.arguments.fileList, !1),a.arguments.noProcessStatus || b.notifyObservers(d, "CopyFileFail", a.arguments),c = a.arguments,delete a.arguments,alloy.rpcService.sendFileErrorReport({request:c,
            response:a})
        ...
        s = !1;
        if(c.retcode == 0 && c.result && c.result.code == 0) {
            var c = c.arguments.fileList,e;
            for(e in c) {
                var f = c[e];
                N(f, !1);
                n(f)
            }
        } else a.error("UpdateFileFail"),E(c.arguments.fileList, !1),c.arguments.noProcessStatus || b.notifyObservers(d, "UpdateFileFail", c.arguments),c.arguments.fileList && c.arguments.fileList[0] && (f = c.arguments.fileList[0],f.t == g.FOLDER ? alloy.util.report2m(151386) : f.t == g.APP ? alloy.util.report2m(151390) : (f.t == g.BUDDY || f.t == g.GROUP) && alloy.util.report2m(151394)),e = c.arguments,delete c.arguments,alloy.rpcService.sendFileErrorReport({request:e,
            response:c})
    }},V = function(a) {
        ...
        if(a.isArray(b))for(var d in b)N(b[d], c); else N(b, c)
    },
            L = function() {
                k();
                j = {};
        ...
        if(!(b.retcode == 0 && b.result && b.result.code == 0)) {
            ...
            var c = b.arguments;
            delete b.arguments;
            alloy.rpcService.sendFileErrorReport({request:c,response:b})
        }
    },T = function(a) {
        R.push(a)
    },$ = function() {
        for(var a; a = R.shift();)setTimeout(a, 500)
    },C = function() {
        var b = alloy.config.getSetupAppList(),c = alloy.config.configList.defaultScreen,c = m(c) ? 2 : c - 1,e = d.getFolderById(c),f = d.getFolderById(5),h = [],n,C = !1,k = alloy.config.getMustInstallAppList(),y;
        for(y in k) {
            var r = Number(y);
            alloy.config.isInSetupAppList(r) || (C = !0,n = {t:g.APP,id:r},b.push(r),d.getFileByFile(n) || (h.push(n),d.addFile(n, 5, 0, !1, !0)))
        }
        if(C && (a.profile("forceInstallApp"),alloy.config.sendSetSetupAppList(),h.length)) {
            var q = f.items.length,x = h.concat();
            T(function() {
                F(x, 5, q, P, {fileList:x}, !0)
            })
        }
        h = [];
        if(f.items.length > 5)for(n = f.items; n.length > 5;)r = n.length - 1,h.push(n[r]),d.moveFile(n[r], c, null, 5, r, !1, !0);
        if(h.length && (a.profile("checkDock"),!C)) {
            var ja = h.concat();
            T(function() {
                Q(ja, c, 0, 5, null, W, {fileList:ja}, !0)
            })
        }
        h = [];
        C = d.getFilesByType(g.APP);
        for(y in b)C[b[y]] || (n = {t:g.APP,id:b[y]},h.push(n));
        if(h.length) {
            a.profile("addMissApp");
            d.addFiles(h, c, -1, !1, !0);
            var u = h.concat(),R = e.items.length;
            T(function() {
                F(u, c, R, P, {fileList:u}, !0)
            })
        }
        var e = {},h = !1,l;
        for(l in C)if((r = Number(C[l].id)) && a.array.indexOf(b, r) == -1)h = !0,n = C[l],y = d.getFileInfoByFile(n),e[y.parent.id] || (e[y.parent.id] = {}),e[y.parent.id][n.id] = n,d.deleteFile(n, null, null, !1, !1, !0);
        if(h) {
    ...
    this.createRecentContactFolder = function(a) {
        if(!f()) {
            ...
            if(b) {
                if(a.length) {
                    var c = 16 - b.items.length;
                    a.length > c && a.splice(c);
                    d.addFiles(a, b.id, null, !1);
                    F(a, b.id, 0, P, null, !0)
                }
                alloy.config.setPortalConfig("hasRecentFolder", 1)
            } else b = {t:g.FOLDER,n:"\u5e38\u7528\u8054\u7cfb\u4eba"},d.createFile(b, alloy.config.configList.defaultScreen - 1, null, function(b) {
                alloy.config.setPortalConfig("hasRecentFolder", 1);
...
Jx().$package("alloy.storage", function(a) {
    var d = this,b = alloy.storage.rpcService,e = a.event,g = a.dom,e = a.event,j = a.string,l = null,p = [],o = [],s = this.DISK = {QQDISK:"qqdisk",KINGSOFT:"kingsoft"},v = d.diskConfig = {qqdisk:{id:0,key:s.QQDISK,icon:"./module/diskexplorer/images/qqdisk.png",name:"QQ\u7f51\u76d8",userUsedSpace:0,userTotalSpace:1073741824,isPwdOpen:0,isLocked:0,dataReady:!1},kingsoft:{id:1,key:s.KINGSOFT,icon:"./module/diskexplorer/images/kingsoft.png",name:"\u91d1\u5c71\u5feb\u76d8",userUsedSpace:0,
        userTotalSpace:5368709120,isPwdOpen:0,isLocked:0,dataReady:!1}},w = [];
    (function() {
        var a,b = 0;
    ...
    this.getTotalSpaceById = function(a) {
        if(a == s.QQDISK)switch(alloy.portal.getPortalSelf().vip) {case 1:return 3221225472;case 2:return 4294967296;case 3:return 5368709120;
            case 4:return 6442450944;case 5:return 7516192768;case 6:return 8589934592;case 7:return 10737418240;default:return 1073741824} else if(a == s.KINGSOFT)return 5368709120
    };
    ...
    this.sendSetBoundDisk = function(a) {
        alloy.rpcService.sendSetConfig({data:{r:{appid:0,value:{diskList:a}}}})
    };
    ...
    this.sendSetBoundAndDefaultDisk = function(a, b) {
        ...
        b = b || l;
        alloy.rpcService.sendSetConfig({data:{r:{appid:0,value:{defaultDisk:b,diskList:a}}}})
    };
    this.getDefaultDisk = function() {
        l = l || "qqdisk";
        return v[l]
    };
    this.useSpace = function(b, f) {
    ...
    this.receiveFile = function(b) {
        ...
        if(typeof d == "undefined" || d == null)d = document.createElement("IFRAME"),d.id = "fs_download",d.name = "fs_download",d.src = alloy.CONST.MAIN_URL + "domain.html",d.style.display = "none",document.body.appendChild(d);
        d.src = b.url
    };
    this.fileDownload = function(a, e) {
        b.fileDownload({data:{target:e,obj:a},onSuccess:function(a) {
            a.retcode == 0 && a.result && a.result.code == 0 && d.receiveFile(a.result)
        }})
    };
    this.fileView = function(d, e) {
        b.fileDownload({data:{target:e,obj:d},onSuccess:function(b) {
            if(b.retcode == 0 && b.result && b.result.code == 0) {
    ...
    this.createFile = function(a, f) {
        var k = this.getExplorerInstance(),g = k.getCurFolder(),r = k.getCurDisk(),k = a.fileSize;
        alloy.storage.getFreeSpaceById(r) < k ? alloy.storage.storageFullAlert(r) : (g = {target:r,file:{t:alloy.fileSystem.FILE_TYPE.FILE,n:a.fileName,size:k,md5:"",sha:""},parent:g},g.parent == "root" && delete g.parent,b.fileUpload({data:g,onSuccess:function(a) {
            a.retcode == 0 && a.result && a.result.code == 0 ? (a = a.result.obj,a.upload = 1,d.useSpace(r, a.size),e.notifyObservers(d, "ExplorerFileAdd", a),f && f(a)) : a.retcode == 0 && a.result && a.result.code == 30001 ? alloy.storage.storageFullAlert() : alloy.layout.alert("\u4e0a\u4f20\u6587\u4ef6\u5931\u8d25\uff01")
        }}))
    };
    ...
    *?
        "<>|]/g,"
        ")!=a)return'\u540d\u79f0\u4e0d\u80fd\u5305\u542b\\/:*?" < > |\u7b49\u7279\u6b8a\u5b57\u7b26
        ';else if(j.byteLength(a)>48)return"\u6587\u4ef6\u5939\u540d\u79f0\u8fc7\u957f\uff08\u5b57\u6570\u6700\u591a\u4e3a24\u4e2a\u6c49\u5b57\u621648\u4e2a\u5b57\u7b26\uff09";return 0};this.fileRename=function(a,b){var k=t(b);if(k==
        0
    )
    {
        ...
        alloy.layout.alert(k, null, {title:"\u91cd\u547d\u540d"})
    };
    this.fileRemove = function(a) {
    ...
    this.storageFullAlert = function(a) {
        a ? alloy.layout.alert("\u60a8\u7684" + v[a].name + "\u5269\u4f59\u7a7a\u95f4\u4e0d\u8db3\uff0c\u8bf7\u4fee\u6539\u9ed8\u8ba4\u786c\u76d8\u540e\u91cd\u65b0\u4e0a\u4f20", function() {
    ...
    this.checkPassword = function(a, b) {
        ...
        g.onSuccess = function(b) {
            if(b.retcode == 0 && b.result && b.result.code == 0)e.notifyObservers(d, "ExploreCheckPassword", {target:a,code:1}); else if(!d._passwordErrorWin)d._passwordErrorWin = alloy.layout.alert("\u5bc6\u7801\u9519\u8bef\uff0c\u8bf7\u91cd\u8bd5\uff01", r, null, r);
    ...
    var r = {onPortalReady:function() {
        ...
        for(var f = 0,b = 0; b < p.length; b++) {
            var k = {};
            k.data = {target:p[b]};
            k.arguments = {target:p[b]};
            k.onSuccess = function(b) {
                if(b.retcode == 0 && b.result && b.result.code == 0) {
                    var m = b.arguments.target,c = b.result.config || {},h = parseInt(b.result.userUsedSpaceBytes),b = parseInt(b.result.userTotalSpaceBytes);
                    v[m].userUsedSpace = h > b ? b : h;
                    v[m].userTotalSpace = b;
                    v[m].dataReady = !0;
                    v[m].isPwdOpen = a.isUndefined(c.is_pwd_open) ? 0 : c.is_pwd_open;
                    v[m].isLocked = v[m].isPwdOpen == 0 ? 0 : 1;
                    f++;
        ...
        if((Number(b.appid) || Number(b.aid)) == 400011741) {
            var b = a.json.parse(a.string.decodeHtmlSimple(b.m)),f = alloy.storage.getDiskById(b.source);
            if(f) {
                var k = parseInt(b.userUsedSpaceBytes),g = parseInt(b.userTotalSpaceBytes);
                f.userUsedSpace = k > g ? g : k;
                f.userTotalSpace = g;
...
Jx().$package("alloy.desktopContact", function(a) {
    var d = this,b = a.event,b = a.event,e = alloy.fileSystem.FILE_TYPE,g = !1,j = {onBuddySelected:function(a, b) {
        var d = b;
        d == -1 && (d = alloy.desktopManager.getCurrentDesktopIndex());
        var k = [],g;
        for(g in a) {
            var l = a[g],c;
            l.gcode ? (c = Number(l.gcode),l = {id:l.gcode,n:l.name,t:alloy.fileSystem.FILE_TYPE.GROUP,gid:l.gid || 0}) : (c = Number(l.uin),l = {id:l.uin,n:l.name,t:alloy.fileSystem.FILE_TYPE.BUDDY});
            isNaN(c) || alloy.fileSystem.getFileByFile(l) || k.push(l)
        }
        k.length && (g = alloy.fileSystem.getFileAmount(e.BUDDY),c = alloy.fileSystem.getFileAmount(e.GROUP),g + c + k.length >= 200 ? alloy.layout.alert("\u684c\u9762\u8054\u7cfb\u4eba\u5df2\u8d85\u8fc7200\u4eba\u4e0a\u9650\uff0c\u8bf7\u5220\u51cf\u540e\u518d\u521b\u5efa\u3002") : alloy.fileSystem.getFolderById(d) ? alloy.fileSystem.addFiles(k, d, null, !0) : alloy.layout.alert("\u6587\u4ef6\u5939\u5df2\u7ecf\u4e0d\u5b58\u5728\uff0c\u6dfb\u52a0\u5931\u8d25\u3002"));
        ...
        w();
        var a = alloy.fileSystem.getFilesByType(e.BUDDY),d;
        for(d in a)t(a[d].id);
        ...
        if(a == 2 && a < alloy.portal.getOldLoginLevel()) {
            var b = alloy.fileSystem.getFilesByType(e.BUDDY),d;
            for(d in b)b[d].notifyNumber = 0,alloy.iconFactory.updateNotifyNumber(b[d]);
            var b = alloy.fileSystem.getFilesByType(e.GROUP),g;
        ...
        if(!alloy.config.configList.hasRecentFolder) {
            for(var a = EQQ.Model.BuddyList.getRecentList(),b = [],d,g,l = 0; l < a.length; l++) {
                ...
                d = null;
                if(a[l].type == 0)(g = EQQ.Model.BuddyList.getBuddyByUin(a[l].uin)) && (d = {t:e.BUDDY,id:a[l].uin,n:g.showName}); else if(a[l].type == 1)(g = EQQ.Model.BuddyList.getGroupByGid(a[l].uin)) && (d = {t:e.GROUP,id:g.code,n:g.showName,gid:a[l].uin}); else continue;
        ...
        var b = alloy.fileSystem.getFilesByType(e.BUDDY),g,f,k = !1,l = {},j,c,h;
        for(h in b) {
            g = b[h];
        ...
        var b = alloy.fileSystem.getFilesByType(e.GROUP),A;
        for(A in b) {
            g = b[A];
        ...
        if(k)for(var x in l) {
            ...
            s(a.bind(function(a) {
                alloy.fileSystem.sendUpdateFiles(a.fileList, a.folderId, o, null, !0)
            }, d, {fileList:g,folderId:k}))
        }
        v()
    },t = this.updateContactIconState = function(a, b, d) {
        var b = alloy.iconFactory.getIcons(a, e.BUDDY),g;
        if(b)if(d = d || EQQ.Model.BuddyList.getState(a)) {
            a = 0;
    ...
    this.addContactIcon = function(a, b, d) {
        ...
        if(g)a = g.parent.id,a == 5 ? b = "\u8be5\u8054\u7cfb\u4eba\u5df2\u6dfb\u52a0\uff0c\u4f4d\u4e8e\u201c\u5e94\u7528\u7801\u5934\u201d\u3002" : a >= 0 && a < 5 ? b = "\u8be5\u8054\u7cfb\u4eba\u5df2\u6dfb\u52a0\uff0c\u4f4d\u4e8e" + ("\u201c\u684c\u9762" + (a + 1) + "\u201d") + "\u3002" : a == b ? b = "\u8be5\u8054\u7cfb\u4eba\u5df2\u4f4d\u4e8e\u8be5\u6587\u4ef6\u5939\u3002" : (b = "\u6587\u4ef6\u5939\u201c" + (g.parent.n || g.parent.id) + "\u201d",b = "\u8be5\u8054\u7cfb\u4eba\u5df2\u6dfb\u52a0\uff0c\u4f4d\u4e8e" + b + "\u3002"),alloy.layout.alert(b); else {
            var g = alloy.fileSystem.getFileAmount(e.BUDDY),l = alloy.fileSystem.getFileAmount(e.GROUP);
    ...
    this.getCurrentContacts = function() {
        var a = {},b,d = alloy.fileSystem.getFilesByType(e.BUDDY),g;
        for(g in d)b = d[g],a[b.id] = {type:b.t,uin:b.id,name:b.n};
        d = alloy.fileSystem.getFilesByType(e.GROUP);
        for(g in d)b = d[g],a[b.id] = {type:b.t,uin:b.gid,name:b.n,gcode:b.id};
        return a
    };
    this.showSelectBuddyBox = function(a) {
        typeof a == "undefined" && (a = -1);
        if(alloy.portal.getLoginLevel() == alloy.CONST.LOGIN_LEVEL_NONE)alloy.layout.showLoginWindow("selectBuddy"); else {
            var b = d.getCurrentContacts();
            alloy.portal.runApp("selectBuddy", {id:"desktopContact",title:"\u6dfb\u52a0\u684c\u9762\u8054\u7cfb\u4eba",isAddSelf:!1,maxBuddy:0,initList:b,lockInitList:!0,onlyNewMember:!0,groupDisplayType:"group",cbParam:a,onSelected:j.onBuddySelected})
        }
    }
});
Jx().$package("alloy.desktopFolder", function(a) {
    var d = a.event,b = a.dom,d = a.event,e = a.string,g = alloy.fileSystem.MAX_FOLDER_AMOUNT,j = alloy.fileSystem.FILE_TYPE,l = {onFileUpdate:function(a) {
        var b = alloy.iconFactory.getIcons(a.id, a.t);
        if(b)for(var d = 0,e = b.length; d < e; d++)b[d].setText(a.n),b[d].file.n = a.n
    },onFileCreateSuccess:function(a) {
        var b = alloy.iconFactory.getIcons(a.id, a.t);
        if(b)for(var d = 0,g = b.length; d < g; d++)b[d].setText(e.encodeHtml(a.n))
    },onFileAdd:function(a) {
        if(a = alloy.iconFactory.getIcons(a.parent.id, a.parent.type))for(var b = 0,d = a.length; b < d; b++)a[b].update()
    },onFileDelete:function(a) {
        if(a = alloy.iconFactory.getIcons(a.parent.id, a.parent.type))for(var b = 0,d = a.length; b < d; b++)a[b].update()
    },onFileMove:function(a) {
        var b = a.targetId,a = a.sourceId,d = alloy.iconFactory.getIcons(b, j.FOLDER);
    ...
    this.createFolder = function() {
        alloy.fileSystem.getFileAmount(j.FOLDER) >= g ? alloy.layout.alert("\u6587\u4ef6\u5939\u5df2\u8d85\u8fc7" + g + "\u4e2a\u4e0a\u9650\uff0c\u8bf7\u5220\u51cf\u540e\u518d\u521b\u5efa\u3002") : alloy.system.getLoginLevel() > 1 ? new o({callback:function(a) {
            var b = alloy.desktopManager.getCurrentDesktopIndex();
            alloy.fileSystem.createFile({t:alloy.fileSystem.FILE_TYPE.FOLDER,n:a.n,c:a.c}, b, null, l.onFileCreateSuccess)
        }}) : alloy.layout.showLoginWindow("")
    };
    this.deleteFolder = function(a) {
        var b = alloy.fileSystem.getFolderById(a.id).items,d = !1,e = !1;
        ...
        }, {title:"\u5220\u9664\u6587\u4ef6\u5939"}) : alloy.fileSystem.deleteFile(a, null, null, !1, !0)
    };
    var p = function(b) {
        var d = alloy.CONST.CDN_URL + "style/images/filesys/" + b + ".png",e = alloy.CONST.CDN_URL + "style/images/transparent.gif";
        return a.browser.ie == 6 ? '<img class="fcDropdown_img" src="' + e + '" style="' + ("background:node;filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + d + "', sizingMethod='scale')") + '" idx="' + b + '" />' : '<img class="fcDropdown_img" src="' + d + '" idx="' + b + '" />'
    },o = new a.Class({init:function(e) {
        var g = this,e = e || {};
        e.id = e.id || +new Date;
        e.callback = e.callback || function() {
        };
        g.option = e;
        var l = g.folderWindow = alloy.windowFactory.createWindow("Window", {title:"\u65b0\u5efa\u6587\u4ef6\u5939",modeSwitch:!0,dragable:!0,width:380,height:120,hasCloseButton:!0,hasOkButton:!0,
            hasCancelButton:!0,doubleClickModeSwitch:!1,isSetCentered:!0}),t = '\t\t\t\t<div class="folderCreator" id="folderCreator_' + e.id + '">\t\t\t\t\t<a class="folderSelector" id="folderSelector_' + e.id + '">' + p("folder") + '</a>\t\t\t\t\t<div class="folderNameTxt">\u8bf7\u8f93\u5165\u6587\u4ef6\u5939\u540d\u79f0\uff1a</div>\t\t\t\t\t<div class="folderInput"><input class="folderName" id="folderName_' + e.id + '"></input></div>\t\t\t\t\t<div class="folderNameError" id="folderNameError_' + e.id + '"></div>\t\t\t\t</div>\t\t\t';
        l.setHtml(t);
        ...
        t = '\t\t\t\t<div class="fcDropdown_title" id="fcDropdown_title_' + e.id + '">\u56fe\u6807</div>\t\t\t\t<div class="fcDropdown_body" id ="fcDropdown_body_' + e.id + '">\t\t\t\t\t<a class="fcDropdown_item" title="\u9ed8\u8ba4">' + p("folder") + '</a>\t\t\t\t\t<a class="fcDropdown_item" title="\u8054\u7cfb\u4eba">' + p("contact") + '</a>\t\t\t\t\t<a class="fcDropdown_item" title="\u6587\u672c">' + p("doc") + '</a>\t\t\t\t\t<a class="fcDropdown_item" title="\u6e38\u620f">' + p("game") + '</a>\t\t\t\t\t<a class="fcDropdown_item" title="\u751f\u6d3b">' + p("life") + '</a>\t\t\t\t\t<a class="fcDropdown_item" title="\u97f3\u4e50">' + p("music") + '</a>\t\t\t\t\t<a class="fcDropdown_item" title="\u5de5\u5177">' + p("tool") + '</a>\t\t\t\t\t<a class="fcDropdown_item" title="\u89c6\u9891">' + p("video") + "</a>\t\t\t\t</div>\t\t\t";
        g.dropdown = b.node("div", {id:"fcDropdown_" + e.id,"class":"folderCreatorDropdown"});
        g.dropdown.innerHTML = t;
        ...
        b.hide(g.dropdown);
        g.dropdownPanel = new a.ui.PopupBox({noCatchMouseUp:!0,container:g.dropdown});
        g.folderName.value = alloy.fileSystem.getDefaultFolderName();
        g.folderName.select();
        var r = {onClick:function(a) {
            a.preventDefault();
            a.stopPropagation();
            g.showDropDown()
            ...
            var a = g.getFolderByName(),d = g.getSelectedCate(),k = alloy.fileSystem.isFileNameAvailable(a, j.FOLDER);
        ...
        d.on(g.selector, "click", r.onClick);
...
Jx().$package("alloy.desktopFile", function(a) {
    var d = {onFileCreateSuccess:function() {
    }};
    this.init = function() {
    };
    this.createFile = function(b, e) {
        if(alloy.system.getLoginLevel() > 1) {
            var g = b.folderId,j = alloy.storage.getDefaultDisk().key;
            alloy.storage.getFreeSpaceById(j) < b.fileSize ? alloy.storage.storageFullAlert(j) : (g == -1 && (g = alloy.desktopManager.getCurrentDesktopIndex()),alloy.fileSystem.createFile({t:alloy.fileSystem.FILE_TYPE.FILE,n:b.fileName,size:b.fileSize,md5:"",sha:"",s:j}, g, null, a.bind(function(a) {
...
Jx().$package("alloy.windowFactory", function(a) {
    var d = this,b = a.dom,e = a.event,g,j,l,p,o,s = {onDesktopResize:function() {
        var a,b = alloy.windowManager.getWindowList(),d;
        for(d in b) {
            a = b[d];
            var e = a.getBoxStatus();
            if(e == "max" || e == "fullscreen")a:{
                var g = void 0,l = void 0,j = void 0,c = e = void 0,c = l = g = e = j = void 0,c = a.getBoxStatus(),j = alloy.layout.getAreaWidth("left"),e = alloy.layout.getAreaHeight("top"),g = alloy.layout.getClientWidth(),l = alloy.layout.getClientHeight();
                if(c == "fullscreen")c = 5,g += c * 2,l += c * 2,j = -j - c,e = -e - c; else if(c == "max")c = 10,g += c * 2,l += c * 2,j = -j - c,e = -e - c; else break a;
        ...
        var a = alloy.layout.getClientWidth(),b = alloy.layout.getClientHeight(),a = a > this.getWidth() ? (a - this.getWidth()) / 2 : 0,b = b > this.getHeight() ? (b - this.getHeight()) / 2 : 0;
        this.setXY(a, b)
        ...
        onWindowMax:function() {
            var a = alloy.layout.getClientWidth(),b = alloy.layout.getClientHeight(),d = alloy.layout.getAreaWidth("left"),e = alloy.layout.getAreaHeight("top");
            this.setXY(-d - 10, -e - 10);
            this.setWinWidth(a + 20);
            this.setWinHeight(b + 20)
        },onWindowRestore:function() {
    },onWindowFullscreen:function() {
        var d = alloy.layout.getClientWidth(),e = alloy.layout.getClientHeight(),g = alloy.layout.getAreaWidth("left"),f = alloy.layout.getAreaHeight("top");
        this.setXY(-g - 5, -f - 5);
        this.setWinWidth(d + 10);
        this.setWinHeight(e + 10);
        this.setZIndexLevel(3);
        w(this);
        a.browser.mobileSafari || (j || (j = b.node("div", {id:"fullscreen_tip","class":"fullscreen_tip"}),document.body.appendChild(j)),b.setStyle(j, "zIndex", alloy.layout.getTopZIndex(3)),b.show(j),this.subMode == 1 && this.isSubWinFloat && this.subWin && this.isShow() && (this.subWin.setZIndexLevel(3),w(this.subWin)),setTimeout(function() {
            b.hide(j)
        }, 3E3))
        ...
        this.setDragLimite({topMargin:a,bottomMargin:b})
    }},v = function(b) {
        if(b) {
            var d = b.option || {};
            d.isSetCurrent ? b.setCurrent({fromInit:!0}) : b.setNotCurrent({fromInit:!0});
            var e = alloy.layout.getAvailableWidth(),f = alloy.layout.getAvailableHeight(),g = b.getWidth(),l = b.getHeight();
            b.getX();
            b.getY();
            l > f && (l = f);
            g > e && (g = e);
            ...
            switch(d.defaultMode) {case "max":b.max();b._restoreWidth = d.defaultWidth;b._restoreHeight = d.defaultHeight;break;case "min":b.min();break;case "fullscreen":b.fullscreen()}
            if(alloy.app.gravity)b.b2Box = alloy.app.gravity.createBox(b);
            d.isSetCentered && b.setWindowCentered()
        }
    },w = function(a) {
        if(!a.isLockZIndex()) {
            var b = a.getZIndexLevel() || 0,b = alloy.layout.getTopZIndex(b);
            a.setZIndex(b)
        }
    };
    this.init = function() {
        ...
        p = 0;
        o = !1;
        g || (g = b.node("input", {id:"qqweb_focus_input"}),g.setAttribute("type", "text"),document.body.appendChild(g));
    ...
    this.createWindow = function(g, j, m) {
        ...
        if(f) {
            ...
            e.addObserver(f, "beforeDragStart", s.onWindowBeforeDragStart);
            ...
            if(a.isUndefined(j.x) && a.isUndefined(j.y)) {
                var k,q;
                q = k = 0;
                var j = f.option.clientWidth || alloy.layout.getAvailableWidth(),g = f.option.clientHeight || alloy.layout.getAvailableHeight(),w = j - f.getWidth(),c = g - f.getHeight(),h = w > 0 ? w / 2 : 0,A = c > 0 ? c / 2 : 0,x = f.getId(),x = alloy.windowManager.getWindowList().length == 1 ? 0 : x < 0 ? 0 : x;
                k = (h + x * 25) % w + k;
                q = (A + x * 25) % c + q;
                k = k > 0 ? k : 0;
                q = q > 0 ? q : 0;
...
Jx().$package("alloy.windowManager", function(a) {
    var d = a.event,b,e,g,j,l = {onWidnowCreated:function(a) {
        b.push(a);
        e[a.getId()] = a;
...
Jx().$package("alloy.desktopManager", function(a) {
    var d = a.dom,b = a.event,e = a.fx.transitions,g = {NORMAL:1,EDIT:2,DRAG:3,MANAGE:4},j,l,p,o,s,v,w,t,r,m,f = [],k = {},q = [],D = [],c = {},h = g.NORMAL,A = [],x = [],z,y,u,n = [0,0,0,0,0],B = alloy.fileSystem.FILE_TYPE,F = 142,H = 112,Q = 0,J = 0,I = 0,M = function(a) {
        return a === null || typeof a === "undefined"
    },K = function() {
    ...
    },O = [{text:"\u4e0a\u4f20\u6587\u4ef6",type:"flash",icon:{className:"add_file_icon"},onClick:function() {
    }},{text:"\u6dfb\u52a0\u5e94\u7528",icon:{className:"add_app_icon"},onClick:function() {
        alloy.portal.runApp("appMarket");
        qqweb.util.report2qqweb("screen|" + alloy.desktopManager.getCurrentDesktopIndex() + "|addapp")
    }},{text:"\u6dfb\u52a0\u684c\u9762\u8054\u7cfb\u4eba",icon:{className:"add_contact_icon"},onClick:function() {
        alloy.desktopContact.showSelectBuddyBox();
        qqweb.util.report2qqweb("add|desktop|adddeskcontanct")
    }},
    {type:"separator"},{text:"\u65b0\u5efa\u6587\u4ef6\u5939",icon:{className:"add_folder_icon"},onClick:function() {
        alloy.desktopFolder.createFolder();
        qqweb.util.report2qqweb("add|desktop|addfolder")
    }}],G = {onWindowCreated:function(c) {
        if(this.isWindowInDesktop(c)) {
            ...
            if(c.windowType != "widget") {
                var d = this,e = function() {
                    ...
                    a.array.remove(d._maxWindowArray, this);
    ...
    }},V = new a.Class({init:function(c) {
        this._desktopIndex = c.desktopIndex;
        this._windowArray = [];
        this._preCurrentWindow = this._currentWindow = null;
        this._maxWindowArray = [];
        b.addObserver(alloy.windowFactory, "WindowCreated", a.bind(G.onWindowCreated, this));
        b.addObserver(alloy.portal, "DesktopSwitch", a.bind(G.onDesktopSwitch, this))
    },isWindowInDesktop:function(a) {
        if(M(a.desktopIndex))return this._desktopIndex == alloy.desktopManager.getCurrentDesktopIndex(); else if(this._desktopIndex == a.desktopIndex)return!0;
        return!1
    ...
    }}),N = new a.Class({init:function(c) {
        var e = this._index = c.index,f = this._el = d.node("div", {index:e,"class":"desktopContainer"}),h = this._iconContainer = d.node("div", {"class":"appListContainer",customAcceptDrop:1,index:e});
        ...
        f.appendChild(h);
        if(a.browser.mobileSafari)d.setStyle(h, "overflow-y", "auto"),d.setStyle(h, "overflow-x", "hidden"),new a.ui.TouchScroller(h); else {
        ...
        this._windowManager = new V({desktopIndex:e});
        if(a.browser.engine.webkit) {
            ...
            b.on(this._el, "webkitTransitionEnd", function() {
                ...
                n[C._index]--;
                a:{
                    for(var a in n)if(n[a] > 0)break a;
                    d.addClass(l, "desktopsContainerEx")
                }
            })
        }
        ...
        this._isCurrent = !0;
        var e = this._el,f = this;
        d.setClass(e, "desktopContainer desktop_current");
        if(c || h === g.DRAG)a.browser.engine.webkit && (d.addClass(l, "desktopsContainerEx"),d.addClass(e, "desktop_current_noanimation")); else if(a.browser.engine.webkit && (n[this._index] = 2,d.removeClass(l, "desktopsContainerEx")),a.browser.engine.webkit || a.browser.firefox)this._showAnimationTimer && clearTimeout(this._showAnimationTimer),this._disappearAnimationTimer && clearTimeout(this._disappearAnimationTimer),d.addClass(e, "desktop_show_prepare" + b),this._showAnimationTimer = setTimeout(function() {
        ...
        if(!(c || h === g.DRAG))if(a.browser.engine.webkit)a.browser.engine.webkit && (n[this._index] = 1,d.removeClass(l, "desktopsContainerEx")),d.addClass(e, "desktop_disappear_prepare" + b),d.addClass(e, "desktop_disappear_animation" + b); else if(a.browser.firefox)this._showAnimationTimer && clearTimeout(this._showAnimationTimer),this._disappearAnimationTimer && clearTimeout(this._disappearAnimationTimer),d.addClass(e, "desktop_disappear_prepare" + b),this._disappearAnimationTimer = setTimeout(function() {
        ...
        a = I / a;
        a > 50 ? W(!0) : a < -50 ? R(!0) : I > 60 ? W(!0) : I < -60 ? R(!0) : I = 0
    },onSwipe:function() {
    },onDesktopContainerDragMove:function() {
    },onDesktopContainerDrop:function(a) {
        var b = a.pos,e = b.x,f = b.y;
        f += this.scrollTop;
        var b = a.dragEl,a = this.getAttribute("index") || o,h = d.getClientXY(this);
        e -= h[0];
        f -= h[1];
        e = Math.floor(e / F);
        f = Math.floor(f / H);
        ...
        var g,n = b.getAttribute("type"),f = {t:n},h = alloy.fileSystem.FILE_TYPE;
        g = parseInt(b.getAttribute("fileId"));
        if(!isNaN(g)) {
            if(n == h.FILE) {
                var C = alloy.iconFactory.getIcons(g, alloy.fileSystem.FILE_TYPE.FILE);
                i = 0;
                for(len = C.length; i < len; i++)if(C[i].isUploading())return
            }
            f.id = g;
            if(n == h.GROUP)f.gid = parseInt(b.getAttribute("gid"));
            b = b.getAttribute("from");
            g = k[a][e];
            b == "buddy" ? (g && c[g] && c[g].type == h.FOLDER ? alloy.fileSystem.moveFile(f, c[g].fileId, null, null, null, !0) : alloy.desktopContact.addContactIcon(f, a, e),qqweb.util.report2qqweb("deskcontact|create|drag")) : alloy.fileSystem.isInFolder(f, alloy.fileSystem.getRootFolder(), !0) && (g && c[g] && c[g].type == h.FOLDER && f.t != h.FOLDER ? alloy.fileSystem.moveFile(f, c[g].fileId, null, null, null, !0) : alloy.fileSystem.moveFile(f, a, e, null, null, !0))
        }
        ...
        q = [];
        D = [];
        var c = alloy.fileSystem.getRootFolder(),d = c.items,c = alloy.fileSystem.getFolderById(o, c);
        ...
        if(a.targetId >= 0 && a.targetId < 5) {
            if(a.targetId == a.sourceId)var b = X(a.file.id, a.file.t); else a.sourceId >= 0 && a.sourceId < 5 && (b = X(a.file.id, a.file.t)) && aa(b, a.sourceId, a.sourcePosition),b = C(a.file, p[a.targetId].getIconContainer(), a.targetId);
            b && ca(b, a)
        } else a.sourceId >= 0 && a.sourceId < 5 && (b = X(a.file.id, a.file.t)) && aa(b, a.sourceId, a.sourcePosition)
    },onFileAdd:function(a) {
        var b = a.parent.id;
        if(b >= 0 && b < 5) {
            var c = {targetId:b,targetPosition:a.position,
                sourceId:-1,sourcePosition:-1};
        ...
        var b = alloy.layout.getAvailableWidth(),c = alloy.layout.getAvailableHeight(),b = {width:b,height:c};
        if(b.width) {
            var c = alloy.layout.getAreaWidth("left"),e = alloy.layout.getAreaWidth("right");
            z = b.width;
            y = z + c + e;
            d.setStyle(l, "width", z + "px");
            for(var e = 0,f = p.length; e < f; ++e)c = p[e],d.setStyle(c.getIconContainer(), "width", b.width - 28 + "px"),d.setStyle(c.getIconContainer(), "marginLeft", "28px"),a.browser.engine.webkit && d.setStyle(c.getElement(), "left", y + "px"),d.setStyle(c.getElement(), "width", b.width + "px")
        }
        if(b.height) {
            u = b.height - alloy.layout.getAreaHeight("bottom");
            d.setStyle(l, "height", u + "px");
            e = 0;
            for(f = p.length; e < f; ++e)d.setStyle(p[e].getIconContainer(), "height", u - 46 + "px"),d.setStyle(p[e].getIconContainer(), "marginTop", "46px"),d.setStyle(p[e].getElement(), "height", u + "px")
        }
        ...
        h === g.DRAG && P(g.NORMAL);
        var b = a.apperceiveEl,a = b.getAttribute("fileId"),b = b.getAttribute("type");
        if(a && b && (a = {id:a,t:b},(a = alloy.fileSystem.getFileByFile(a)) && a.processing))if(a = alloy.iconFactory.getIcons(a.id, a.t))for(var b = 0,c = a.length; b < c; b++)a[b].disable()
        ...
        o = c;
        p[c].setCurrent(f, e);
        a.browser.ie == 6 && d.setStyle(document.body, "height", d.getStyle(document.body, "height"));
        x[c] && Y(c);
        ...
        h = a;
        b.notifyObservers(alloy.portal, "DesktopSwitchStatus", {status:a});
        return a
    ...
    var $ = function(a) {
        a.stopPropagation();
        h === g.EDIT ? (P(g.NORMAL),alloy.util.report2qqweb("screen|ipad|edited")) : (alloy.layout.showContextMenu({x:a.clientX,y:a.clientY}, {items:O}),alloy.util.report2qqweb("add|add|" + alloy.desktopManager.getCurrentDesktopIndex()))
    },C = function(b, d) {
        var e = {parentNode:d},f;
        if(b.t == B.APP) {
            var h = b.id;
        ...
        } else if(b.t == B.BUDDY || b.t == B.GROUP)f = alloy.iconFactory.createIcon(b.t, e, b); else if(b.t == B.FOLDER || b.t == B.FILE)f = alloy.iconFactory.createIcon(b.t, e, b);
        f && (c[f.getId()] = f,s.addDragClass(f.getElement()));
        return f
    },ca = function(a, b) {
        var c = b.targetId,d = b.targetPosition,e = b.sourcePosition,f = -1;
        ...
        if(!v[c]) {
            ...
            d.hide(h);
            var g = new a.fx.Animation({element:h,property:"opacity",from:0,to:1,unit:!1,duration:2E3,fps:30,transition:e.sinusoidal.easeOut});
        ...
        var e = r || (r = d.getWidth(a)),f = m || (m = d.getHeight(a)),b = (F - e) / 2 + b,c = (H - f) / 2 + c;
        d.setStyle(a, "left", b + "px");
        d.setStyle(a, "top", c + "px")
    },Y = function(a, b, c) {
        var b = 0,c = -1,d = k[a],e = d.length;
        if(e == 0)ba(f[a], 0, 0); else {
            b !== void 0 ? b > e - 1 && (b = e - 1) : b = 0;
            if(c == void 0 || c == -1 || c > e - 1)c = e - 1;
            var h = Math.floor(b / w) * F,g = b % w * H,n = w * t <= b + 1;
            n && (h = b % t * F,g = Math.floor(b / t) * H);
            for(; b <= c; b++)if(n = d[b],n != void 0 && (n = X(n)))ba(n.getElement(), h, g),(n = w * t <= b + 1) ? (b + 1) % t == 0 ? (h = 0,g += H) : h += F : (b + 1) % w == 0 ? (g = 0,h += F) : g += H;
            c == e - 1 && ba(f[a], h, g);
            A[a] && A[a].update(a);
            x[a] = 0
        }
        ...
        x = [1,1,1,1,1];
        Y(o);
        c && alloy.portal.getLoginLevel() > alloy.CONST.LOGIN_LEVEL_NONE && (e ? alloy.rpcService.sendMSetConfigDelay({data:{0:{desktopIconStyle:a}},delay:e}) : alloy.rpcService.sendSetConfig({data:{r:{appid:0,value:{desktopIconStyle:a}}}}));
        b.notifyObservers(alloy.desktopManager, "DesktopIconStyleChanged", a)
    };
    this.init = function(c) {
        var e = c.initializeLength || 5,c = c.currentDesktopIndex || Math.floor(e / 2);
        ...
        p = [];
        for(var g = 0; g < e; ++g) {
            h = new N({index:g,appendTo:l});
            p.push(h);
            s.addDropTarget({el:h.getIconContainer(),level:0});
            k[g] = [];
            h = g;
            var n = T.cloneNode(!0);
    ...
    this.setDefaultDesktop = function(a, b, c) {
        a = Number(a);
        if(b && alloy.portal.getLoginLevel() > alloy.CONST.LOGIN_LEVEL_NONE)alloy.config.configList.defaultScreen = a,c ? alloy.rpcService.sendMSetConfigDelay({data:{0:{defaultScreen:a}},delay:c}) : alloy.rpcService.sendSetConfig({data:{r:{appid:0,value:{defaultScreen:a}}}})
    };
    this.getDesktopIconStyle = ga;
    this.setDesktopIconStyle = ha
});
Jx().$package("alloy.portal", function(a) {
    var d = this,b = a.dom,e = a.event,g = a.http,j = a.cookie,l,p = !1,o,s = alloy.CONST.LOGIN_LEVEL_NONE,v = 0,w,t = 1,r,m,f = !1,k = !1,q = 0,D = 0,c,h = !1,A = "",x,z,y = "",u = "",n = null,B = 0,F = !1,H,Q,J,I,M = !1,K,U,O = [],G = [],V = "socket",N,E = {},L,R = null,W = !0;
    alloy.system = d;
    var P = [],T = ["pgv_info","ptisp","uin","skey","ptwebqq"];
    d.saveAndDelLockCookie = function() {
        for(var a in T)P.push({name:T[a],value:j.get(T[a])}),j.remove(T[a], alloy.CONST.MAIN_DOMAIN)
    };
    d.revertLockCookie = function() {
        for(var a = P.length - 1; a >= 0; a--)j.set(P[a].name, P[a].value, alloy.CONST.MAIN_DOMAIN, "/");
        P = []
    };
    ...
    var $ = function() {
        ...
        alloy.notifier.init();
        d.runApp("tips", {callback:function() {
            a.profile("runCoreApps Finish!", "portal!")
        }})
    },C = function() {
        var a = d.getLoginLevel(),b;
    ...
    var ca = function() {
        ...
        if(O) {
            for(var b = 0; b < O.length; ++b) {
                var c,e;
                a.isArray(O[b]) ? (c = O[b][0],e = O[b][1],e = d.getUrlOption(c) || e,d.removeUrlOption(c)) : c = O[b];
                var f = d.getApp(c);
                f && !f.isRunning() && (c == alloy.config.__eqqid ? (c = C(),a.debug("run EQQ in [reRunBeforeLoginApps],level:" + d.getLoginLevel() + ": " + c, "_plogin"),d.runApp(alloy.config.__eqqid, {loginMode:c})) : e ? d.runApp(c, e) : d.runApp(c))
            }
            d.setReRunAppList([])
        }
    ...
    var Z = function() {
        ...
        var b = Z();
        if(a.isObject(b))for(var c in b)alloy.portal.runApp(c, d.getUrlOption(c) || {runFrom:"url"});
        ...
        } else if(a.isArray(b))for(var d = 0; d < b.length; d++)if(a.isObject(b[d]) || a.isArray(b[d])) {
        ...
        var b = Z();
        if(a.isObject(b))for(var c in b)if(a.isObject(b[c]))ia(b[c]) ? (b[c].runFrom = "url",m = {},~~c != 0 && !d.getAllConfig(c) && (m.appMarket = {page:"introduce",option:{appid:c},runFrom:"url"}),m[c] = b[c]) : b[c].runFrom = "url"
    };
    ...
    var da = function() {
        ...
        pt_logout.logout(function(b) {
            switch(b) {default:a.out("ptLogout fail!");
                break;case 1:a.out("SuperKey has been clean...");break;case 2:a.out(":LogoutSuccess...")}
        });
        ...
        if(w) {
            ...
            if(b) {
                M = !0;
                for(var c = 0; c < b.appList.length; c++) {
        ...
        if(s > alloy.CONST.LOGIN_LEVEL_NONE)if(alloy.util.report2h("get_vfwebqq", "start"),v = d.getCookieUin(),Q) {
            if(d.setUin(v),fa() ? ea() : K = !1,s == alloy.CONST.LOGIN_LEVEL_ALL) {
        ...
        } else alloy.rpcService.sendGetSeftInfo(v); else v = 0,d.setUin(v),Y();
        a.profile("tryLogin finish!", "portal!")
    },Y = function() {
        e.notifyObservers(d, "SimpleUACReady", {uacLoaded:3})
    },fa = function() {
        return d.getUin() === d.getOldUin() ? (a.debug("uin not change: " + d.getUin(), "_plogin"),!1) : (a.debug("uin change: " + d.getOldUin() + " -> " + d.getUin(), "_plogin"),!0)
    },ga = function() {
    ...
    var ja = function() {
            ...
            setTimeout(function() {
                ...
                if(a.isObject(b))X(),aa(); else {
                    ...
                    if(b) {
                        ...
                        var e,f;
                        for(f in b)c = Number(f),e = b[f],d.runApp(c, {desktopIndex:e});
                    ...
                    if(d.getLoginLevel() < alloy.CONST.LOGIN_LEVEL_NOCHAT) {
                        ...
                        f = [];
                        b = d.getLoginLevel();
                        for(c = 0; c < f.length; ++c)f[c] == alloy.config.__eqqid ? b != 3 && (e = C(),a.debug("run EQQ in [runDefaultApps],level:" + b + ": " + e, "_plogin"),d.runApp(alloy.config.__eqqid, {loginMode:e})) : d.runApp(f[c]);
                    ...
                    f = [];
                    for(b = 0; b < f.length; ++b)switch(f[b]) {default:d.runApp(f[b])}
        ...
        if(B == 1) {
            ...
            try {
                typeof pgvMain == "function" && (window.webTop ? pgvMain("", {virtualDomain:alloy.CONST.DEFAULT_DOMAIN}) : pgvMain("", {virtualDomain:"web.qq.com"})),qqweb.util.report2h("portal", "end", "ok"),qqweb.portal.speedTest.sRTS(8, "end", new Date, !0)
            } catch(c) {
            }
        }
        ...
        a.profile("onGetVfWebQQSuccess, vfwebqq:" + n, "portal!");
        qqweb.util.report2h("get_vfwebqq", "end", "ok");
        ea();
        e.notifyObservers(alloy.portal, "GetLoginInfoSuccess", {isSelfInfoLoad:!0})
        ...
        if(b.retcode == 0) {
            var c = b.arguments.uin,d = b.result;
            if(alloy.portal.getUin() == c)d.uiuin = alloy.portal.getCookiePTUiUin(),alloy.portal.setPortalSelf(d),e.notifyObservers(alloy.portal, "selfInfoReady", alloy.portal.getPortalSelf()),qqweb.util.report2h("get_selfinfo", "end", ["ok"][b.retcode] || b.retcode),alloy.util.stat.report()
        ...
        w ? e.notifyObservers(alloy.portal, "AlloyReady") : e.notifyObservers(alloy.portal, "FrameWorkReady")
        ...
        g.loadCss(alloy.CONST.CDN_URL + "style/qqweb.main.2.css?t=" + alloy.CONST.UPDATE_TIME_STAMP, {onSuccess:function() {
        }});
        g.loadScript(c + b + "/qqweb.part2.js?t=" + alloy.CONST.UPDATE_TIME_STAMP, {onSuccess:function() {
            w = !0;
        ...
        if(!(alloy.portal.getLoginLevel() == alloy.CONST.LOGIN_LEVEL_NONE || !alloy.portal.getVfWebQQ() || !Number(a)))if((a = alloy.portal.getAllConfig(a)) && !(a.preview || a.windowType != "widget"))a = la(),alloy.rpcService.sendMSetConfigDelay({data:{0:{runWidgets:a}},delay:2E3})
        ...
        if(!(alloy.portal.getLoginLevel() == alloy.CONST.LOGIN_LEVEL_NONE || !alloy.portal.getVfWebQQ() || M || a.preview)) {
            ...
            if(b && (a = Number(a.option.id)) && /(window)|(widget)/.test(b.windowType)) {
                ...
                if(c)if(c.selfConfig = c.selfConfig || {},b.windowType == "widget") {
                    ...
                    delete b[a];
                    c[0] = {runWidgets:b};
                    alloy.rpcService.sendMSetConfigDelay({data:c,delay:1E3})
                } else if(b.option.resize) {
                    var d = b.getBodyWidth(),e = b.getBodyHeight(),b = b.getBoxStatus();
                    c.selfConfig.defaultMode = b;
                    c.selfConfig.width = d;
                    c.selfConfig.height = e;
                    c = {};
                    c.defaultMode = b;
                    if(b != "fullscreen" && b != "max")c.width = d,c.height = e;
                    alloy.rpcService.sendSetConfig({data:{r:{appid:a,value:c}}})
                }
            }
        }
    ...
    this.init = function() {
        ...
        e.addObserver(alloy.portal, "loginLevelChange", S.onLoginLevelChange);
    ...
    var sa = function() {
        ...
        var c,d,e = !1,f;
        for(f in E)if(d = Number(f))e = !0,c = E[f],b - c.createTime >= oa ? (a.debug("\u8fc7\u671f\u91cd\u62c9(appId: " + d + "):" + (b - c.createTime) / 1E3, "OpenKey"),alloy.config.reRequestGrant({appId:d})) : b - c.lastUpdateTime >= na && (a.debug("\u7eed\u671f(appId: " + d + "):" + (b - c.lastUpdateTime) / 1E3, "OpenKey"),alloy.config.renewalGrant({appId:d,openId:c.openId,openKey:c.openKey}));
        e || (clearInterval(L),L = 0,a.debug("stop check open key", "OpenKey"))
    };
    this.cacheOpenkey = function(b) {
        var c = +new Date;
        b.renewal && E[b.appId] ? E[b.appId].lastUpdateTime = c : E[b.appId] = {gaid:b.gaid,openKey:b.openKey,openId:b.openId,createTime:c,lastUpdateTime:c};
        L || (L = setInterval(sa, ma),a.debug("start check open key", "OpenKey"))
    };
    ...
    this.acceptSocket = function(b) {
        var b = decodeURI(b),c = a.json.parse(b);
        if(c.e == 0)if(a.isUndefined(c.appid)) {
            if(c.sid)G = c.al,alloy.util.report2qqweb("push|loginsuccess")
        } else a.event.notifyObservers(qqweb.portal, "message", c); else d.longPollLogin(),V = "longPoll",a.error("PushService error: " + b),alloy.util.report2qqweb("push|loginfail")
    };
    this.reportAppState = function(c, d) {
        if(V == "socket")if(N)for(var e = 0; e < G.length; ++e) {
            if(c == G[e]) {
                N.reportAppState && N.reportAppState(c, d);
                break
            }
        } else N = a.browser.ie ? b.id("Socket") || window.Socket : document.Socket; else for(e = 0; e < G.length; ++e)if(c == G[e])break
    };
    this.reportOpen = function(b) {
        var c = a.json.parse(b);
        if(c.appid)a.event.notifyObservers(qqweb.portal, "message", c),a.event.notifyObservers(qqweb.portal, "message" + c.appId, b); else if(c.sid)G = c.al
    };
    ...
    this.setLoginLevel = function(a) {
        a != t && (o = t,t = a,ga() && (e.notifyObservers(alloy.portal, "loginLevelChange", a),a > 1 && I < 1 && d.addExitConfirm()),a != 1 && (a == 2 ? o == 1 && (alloy.util.report2qqweb("signin|visitortoweakness"),d.getPtwebqq() ? alloy.util.report2qqweb("signin|visitortoweakness|signinwithptwebqq") : alloy.util.report2qqweb("signin|visitortoweakness|signin")) : a == 3 && (o == 1 ? (alloy.util.report2qqweb("signin|visitortostrength"),alloy.util.report2qqweb("signin|visitortostrength|" + d.getTryLoginState())) : o == 2 && (d.isWithPtwebqqLogin() ? (alloy.util.report2qqweb("signin|weaknesstostrength|signinwithptwebqq"),alloy.util.report2qqweb("signin|weaknesstostrength|signinwithptwebqq|" + d.getTryLoginState())) : (alloy.util.report2qqweb("signin|weaknesstostrength|signin"),alloy.util.report2qqweb("signin|weaknesstostrength|signin|" + d.getTryLoginState()))))),d.setWithPtwebqqLogin(d.getPtwebqq() || !1))
    };
    ...
    this.validatePTLoginSuccess = function(b) {
        ...
        if(Number(b.login2qq) === 1) {
            ...
            pgvSendClick({hottag:"WEB2QQ.STRONGLOGIN"})
        } else s = 2,alloy.portal.setTryLoginType(!1),pgvSendClick({hottag:"WEB2QQ.WEAKLOGIN"});
        a.profile("validatePTLoginSuccess, tryLoginLevel:" + s, "portal!");
    ...
    this.getSSOForm = function(b) {
        ...
        if(!b)return{};
        var b = a.json.parse(b),c = b.skey,e = b.cgi,f = b.custom,h = {};
        h[b.uin] = d.getUin();
        h[c] = d.getCookieSkey();
        a.extend(h, f);
    ...
    this.getCookieUin = function() {
        var b = a.cookie.get("p_uin", alloy.CONST.MAIN_DOMAIN),b = b ? parseInt(b.substr(1), 10) : null;
        a.out("Cookie uin:" + b);
        return b
    };
    ...
    this.runApp = function(b, c) {
        if(w) {
            var c = c || {},b = b == "eqq" ? alloy.config.__eqqid : b,e = this.getAllConfig(b);
            if(!e)return a.out("id:" + b),e = c.runFrom,b = Number(b),c.preview ? ta(b, c) : b != 19 && (f ? alloy.portal.runApp("appMarket", {page:"introduce",option:{appid:b},runFrom:e}) : alert("\u56e0\u7f51\u7edc\u73af\u5883\u95ee\u9898\u5bfc\u81f4\u52a0\u8f7d\u5f02\u5e38\uff0c\u8bf7\u5c1d\u8bd5\u91cd\u65b0\u767b\u5f55\u3002")),!1;
            if(b == "appMarket" && !f)return alert("\u56e0\u7f51\u7edc\u73af\u5883\u95ee\u9898\u5bfc\u81f4\u52a0\u8f7d\u5f02\u5e38\uff0c\u8bf7\u5c1d\u8bd5\u91cd\u65b0\u767b\u5f55\u3002"),!1;
            var h = this.getApp(b),c = d.getUrlOption(b) || c;
            h ? (h.run && (~~b > 0 && !e.preview && !e.selfConfigLoaded && d.getLoginLevel() > alloy.CONST.LOGIN_LEVEL_NONE ? (h = ["width","height","defaultMode"],e.windowType == "widget" && (h = ["x","y"]),alloy.rpcService.sendGetConfig({arguments:{appConfig:e,option:c},data:{r:{appid:e.id,itemlist:h}},action:"get",onSuccess:pa,onError:pa})) : (e.selfConfig && a.extend(c, e.selfConfig),h.run(c),d.removeUrlOption(b))),c && a.isFunction(c.callback) && c.callback()) : e && (~~b > 0 ? e.appType == 1 ? alloy.portal.loadApp(e, c) : e.appType == 2 && (qqweb.app["app" + b] = new qqweb.businessClass.App(e),alloy.portal.runApp(b, c)) : e.appType == 1 ? alloy.portal.loadApp(e, c) : e.appType == 2 && (alloy.app[b] = new alloy.businessClass.App(e),alloy.portal.runApp(b, c)),d.removeUrlOption(b),d.removeUrlOption(b));
            e && (W = !1);
    ...
    this.loadApp = function(b, c) {
        ...
        if(!this.getAppLoading(b.id)) {
            ...
            var d = b.id,e = alloy.util.getAppRoot(d),
                    f = e + (b.css || "style.css");
            e += b.js || "main.js";
            (b.css || a.isNumber(d)) && g.loadCss(f + "?" + alloy.CONST.UPDATE_TIME_STAMP);
            g.loadScript(e + "?" + alloy.CONST.UPDATE_TIME_STAMP, {onSuccess:function() {
                alloy.portal.runApp(b.id, c)
            }})
        }
    };
    var pa = function(b) {
        var c = b.arguments.appConfig,e = b.arguments.option;
    ...
    this.closeHook = function(b) {
        ...
        if(a.browser.safari || a.browser.chrome)return c; else a.browser.ie > 0 ? window.event.returnValue = c : b.returnValue = c
    };
    ...
    var qa = function(b) {
        ...
        W && pgvSendClick({hottag:"WEB2QQ.NOAPP.USER.ALL"})
    };
    ...
    this.getRunningAppStatus = function() {
        var a = alloy.windowManager.getCurrentWindow(),b = "",c;
        a && (b = a.getAppId());
        for(var a = {currentAppId:b,appList:[]},b = alloy.windowManager.getWindowList(),d = 0; d < b.length; d++) {
            var e = b[d],f = e.getAppId();
            if(!(f === "eqq--" || f === "sceneChristmas")) {
                ...
                if(e.windowType === "window") {
                    ...
                    if(g !== "min") {
                        var n = e.getWidth(),e = e.getHeight();
                        c = {appId:f,defaultMode:g,x:c,y:h,width:n,height:e};
                        f && a.appList.push(c)
                    }
                } else e.windowType === "widget" && (c = {appId:f,x:c,y:h},a.appList.push(c))
            }
        }
        return a
    };
    d.runSettingCenter = function(a) {
        ...
        switch(a && a.pageID || b[0]) {case b[0]:return d.runApp("settingCenter");case b[1]:return d.runApp("notifications");case b[2]:return d.runApp("themeSetting")}
    };
    ...
    this.openFile = function(a) {
        if("type"in a)switch(a.type) {case "image":case "img":case "pic":case "photo":case "jpg":case "jpeg":case "bmp":case "png":case "gif":alloy.portal.runApp("imgViewer", a);break;case "sound":case "music":case "audio":alloy.portal.runApp("audioPlayer", a);break;case "txt":case "doc":case "docx":case "ppt":case "pptx":case "xls":case "xlsx":case "pdf":alloy.portal.runApp("docViewer", a);break;default:alloy.system.alert("\u672a\u77e5\u6587\u4ef6\u7c7b\u578b")}
    };
    ...
    if(window.webTop) {
        var ra = function() {
            ...
            d.openInWebBrowser({url:a,title:"\u6d4f\u89c8\u7f51\u9875"})
        },
            17:function(a, b) {
                alloy.navbar.setNavBarPosition(Number(a), Number(b));
                if(webTop.ui.channel.postCmd(22)) {
                    var c = alloy.layout.createBubble({hasCloseButton:!1});
                    c.setTitle("\u8fd4\u56de\u7cfb\u7edf\u684c\u9762");
                    c.setContent('<div class="webtop-sysbtn-thumb"></div>');
                    c.showButton("ok", "\u77e5\u9053\u5566");
                    c.show({pointerPosition:"top left",target:alloy.navbar.getSystemButton()})
                }
            },18:function(a) {
...
Jet().$package("alloy.layout", function(a) {
    var d = this,b = a.dom,e = a.event,g = a.fx.transitions,j = b.getDocumentElement(),l = document.body,p = b.id("startingCover"),o = document.title,s = null,v = b.id("desktop"),w = !0,t,r,m = !1,f = {},k = [10,1E5,2E5,3E5,4E5],q,D,c,h,A,x,z,y,u = [],n = null,B = alloy.CONST.DAID,F = [{text:"\u663e\u793a\u684c\u9762",onClick:function() {
        qqweb.layout.showDesktop();
        qqweb.rpcService.reportQstatic("contextmenu|desktop|dispdesk")
    }},{text:"\u9501\u5b9a",onClick:function() {
        qqweb.portal.runApp("screenLocker");
        qqweb.rpcService.reportQstatic("contextmenu|desktop|lock")
    }},{type:"separator"},{text:"\u6dfb\u52a0",type:"submenu",items:[{text:"\u6dfb\u52a0\u5e94\u7528",icon:{className:"add_app_icon"},onClick:function() {
    ...
    {text:"\u4e0a\u4f20\u6587\u4ef6",type:"flash",icon:{className:"add_file_icon"},onClick:function() {
    }},{text:"\u65b0\u5efa\u6587\u4ef6\u5939",icon:{className:"add_folder_icon"},onClick:function() {
        alloy.desktopFolder.createFolder();
        qqweb.util.report2qqweb("add|contextmenu|createfolder")
    }},{text:"\u7c98\u8d34",onClick:function() {
        var a = alloy.clipBoard.getData();
        if(a) {
            var b = a.data,c = alloy.desktopManager.getCurrentDesktopIndex();
    ...
    }},{type:"separator"},{text:"QQ\u4e91\u8bcd\u5178",onClick:function() {
        qqweb.portal.runApp("qqWebDict");
        qqweb.rpcService.reportQstatic("contextmenu|desktop|clouddic")
    }},{type:"separator"},{text:"\u4e3b\u9898\u8bbe\u7f6e",onClick:function() {
        qqweb.portal.runApp("themeSetting");
        qqweb.rpcService.reportQstatic("contextmenu|desktop|theme")
    }},{text:"\u7cfb\u7edf\u8bbe\u7f6e",onClick:function() {
        qqweb.portal.runApp("settingCenter");
        qqweb.rpcService.reportQstatic("contextmenu|desktop|config")
    }},
    {text:"\u56fe\u6807\u8bbe\u7f6e",type:"submenu",beforeShow:function(a) {
        alloy.desktopManager.getDesktopIconStyle() ? (a.getItemAt(0).setIcon({className:"desktop_icon_style_checked"}),a.getItemAt(1).setIcon()) : (a.getItemAt(0).setIcon(),a.getItemAt(1).setIcon({className:"desktop_icon_style_checked"}))
    },items:[{text:"\u5c0f\u56fe\u6807",onClick:function() {
    ...
    {text:"\u5927\u56fe\u6807",onClick:function() {
    ...
    }}]},{type:"separator"},{text:"\u53cd\u9988",onClick:function() {
        ...
        if(alloy.portal.isWebTop())if(alloy.portal.getLoginLevel() == alloy.CONST.LOGIN_LEVEL_ALL) {
            var a = alloy.windowManager.getCurrentWindow();
            a ? alloy.portal.runApp("screenCapture2", {mode:a.mode,uin:a.uin,chatBoxType:a.chatBoxType}) : alloy.portal.runApp("screenCapture2")
        } else alloy.portal.runApp("screenCapture2"); else alloy.portal.runApp("screenCapture")
    ...
    var J = {stopPropagation:function(a) {
        a.stopPropagation()
        ...
        if(q == d && D == f)a.out("resize nothing"); else {
            d = b.getClientWidth();
            f = b.getClientHeight();
            a.browser.ie == 6 && (d = d % 2 + d,f = f % 2 + f);
            q = d;
            ...
            g ? b.setStyle(v, "position", "absolute") : b.setStyle(v, "position", "static");
        ...
        if(b.hasClass(a.target, "zoomWallpaper") || b.hasClass(a.target, "desktopContainer") || b.hasClass(a.target, "appListContainer")) {
            ...
            alloy.layout.showContextMenu({x:a.clientX,
                y:a.clientY}, {beforeShow:V,items:c});
        ...
        for(var a in H) {
            var b = H[a],c = alloy.hotkeyManager.getHotkeyInfo(a);
            if(!c.disable)for(var d in c.keys) {
                var e = c.keys[d];
                Q["" + (e.ctrlKey ? 1 : 0) + (e.shiftKey ? 1 : 0) + (e.altKey ? 1 : 0) + "_" + e.keyCode] = {keyId:a,action:b}
            }
        }
    };
    ...
    var M = function() {
        ...
        var b = alloy.windowManager.getOnlyWindowList(),c = alloy.windowManager.getCurrentWindow(),d;
        if(c)for(var e = 0,f = b.length; e < f; e++) {
            if(d = b[e],c == d) {
                c = e;
    ...
    },O = new a.fx.Animation({element:p,property:"opacity",from:1,to:0,unit:!1,duration:1E3,fps:30,transition:g.sinusoidal.easeOut});
    e.addObserver(O, "end", function() {
        b.hide(p)
    });
    var G = new a.fx.Animation({element:v,property:"opacity",from:1,to:0,unit:!1,duration:1E3,fps:30,transition:g.sinusoidal.easeOut});
    e.addObserver(G, "end", function() {
        b.hide(v)
    });
    var V = function(a) {
        if(alloy.portal.getLoginLevel() != alloy.CONST.LOGIN_LEVEL_NONE) {
            var b = alloy.clipBoard.getData(),c = alloy.clipBoard.CLIP_BOARD_TYPE;
            b && (b.type == c.FILE || b.type == c.FOLDER) ? a.getItemAt(6).enable() : a.getItemAt(6).disable()
        }
    },N = function() {
        a.profile("DesktopCreate");
        var c = b.id("desktopWrapper"),h = b.id("topBar"),g = b.id("bottomBar"),n = b.id("rightBar"),k = b.id("leftBar");
        f.topArea = h;
        f.bottomArea = g;
        f.mainArea = c;
        f.leftArea = k;
        f.rightArea = n;
        if(a.browser.mobileSafari)c = b.id("touchpad"),b.show(c),c.src = qqweb.CONST.MAIN_URL + "./touchpad.html?20101021001",e.on(l, "touchmove", function(a) {
            a.touches && a.touches.length == 1 && a.preventDefault()
        }, !0);
        c = y.createPanel({id:"desktop",name:"desktop",container:d.getBody(),body:v,html:""});
        ...
        "onfocusin"in document ? (e.on(document, "focusin", J.onFocusDesktop),e.on(document, "focusout", J.onBlurDesktop)) : (e.on(window, "focus", J.onFocusDesktop),e.on(window, "blur", J.onBlurDesktop));
        a.profile("DesktopCreateFinish");
        return c
    },E = a.Class({init:function() {
        this.panelList = []
    ...
    this.init = function() {
        ...
        alloy.desktopManager.init({initializeLength:5});
        if(a.browser.firefox)setTimeout(J.onWindowResize, 100); else J.onWindowResize();
        e.addObserver(qqweb.portal, "AlloyJsReady", M);
        e.addObserver(alloy.layout, "desktopKeyup", K);
        alloy.dock.init({dragController:alloy.desktopManager.getDragController()});
        alloy.taskBar.init();
        I();
        L()
    };
    ...
    this.getAvailSize = function() {
        return{width:this.getAvailableWidth(),height:this.getAvailableHeight()}
    };
    ...
    this.getClientSize = function() {
        return{width:d.getClientWidth(),height:d.getClientHeight()}
    };
    ...
    this.getMaskLayer = function(b) {
        return b ? (b = new a.ui.MaskLayer({appendTo:this.getDesktop().body,zIndex:1,opacity:0.5}),b.reset(),b) : (r || (r = new a.ui.MaskLayer({appendTo:this.getDesktop().body,zIndex:1,opacity:0.5})),r.reset(),r)
    };
    ...
    this.setTitle = function(a, b) {
        ...
        b.speed = b.speed || 500;
        if(b.roll) {
            if(!(a.length < 1))o = document.title,s && clearInterval(s),s = setInterval(function() {
                document.title = a;
    ...
    this.setIe9IconOverLay = function(a) {
        var b = alloy.CONST.DOMAIN,c = ["overlay1","overlay2","overlay3","overlay4","overlay5","overlay6","overlay7","overlay8","overlay9","overlay10"];
        if(a == 0)try {
    ...
    this.showContextMenu = function(b, c) {
        t || (t = new a.ui.ContextMenu({container:alloy.layout.getDesktop().body}));
    ...
    this.showLoginBox = this.showLoginWindow = function(b, c, e, f) {
        b = {width:380,height:390,title:"\u767b\u5f55Q+ Web",hasCloseButton:!0,isSetCurrent:!0,isSetCentered:!0,dragable:!0,src:"",modal:!0,zIndex:d.getTopZIndex(3),appendTo:d.getDesktop().body,onClose:function() {
            m = null
        }};
        ...
        var h = encodeURIComponent(window.location.protocol + "//" + window.location.host + "/loginproxy.html"),g = "",f = f || "",g = "";
        ...
        c ? (b.src = "https://ui.ptlogin2.qq.com/cgi-bin/login?daid=" + B + "&target=self&style=5&mibao_css=m_webqq&appid=1003903&enable_qlogin=0&no_verifyimg=1&s_url=" + h + "&f_url=loginerroralert&strong_login=1&login_state=" + e + "&t=" + alloy.CONST.UPDATE_TIME_STAMP,g = '            <div id="login_window_content_area" class="login_content_area"><div class="login_logo_qq"></div>' + g + '<div class="login_window_wrap">            <iframe id="ifram_login"  src="' + b.src + '" scrolling="no" frameborder="no" allowtransparency="true" scrolling="hidden" hidefocus ></iframe>                    </div></div>') : (b.src = "https://ui.ptlogin2.qq.com/cgi-bin/login?daid=" + B + "&target=self&style=5&mibao_css=m_webqq&appid=1003903&enable_qlogin=0&no_verifyimg=1&s_url=" + h + "&f_url=loginerroralert&strong_login=0&login_state=" + e + "&t=" + alloy.CONST.UPDATE_TIME_STAMP,g = '<div id="login_window_content_area" class="login_content_area"><div class="login_logo_webqq"></div>' + g + '<div class="login_window_wrap">            <iframe id="ifram_login"  src="' + b.src + '" scrolling="no" frameborder="no" allowtransparency="true" scrolling="hidden" hidefocus ></iframe>                    </div></div>');
        m = new a.ui.Boxy(b);
        m.getPanel().setHtml(g);
        return m
    };
    this.setLoginWindowHeight = function(c) {
        d.loginWindowInfoHeight && (c += 18);
    ...
    this.onAirInstallSuccess = function() {
        var a = b.id("airInstallTip"),c = b.id("airCloseTip");
...
Jx().$package("alloy.dock", function(a) {
    var d = this,b = a.dom,e = a.event,g,j,l,p,o,s,v,w,t,r,m = 0,f = {},k = {},q,D,c,h = function(a, b) {
        y.onDockMenuItemClick(a, b)
    },A = [{text:"\u5411\u5de6\u505c\u9760",icon:{className:"dock_menu_item_left"},argument:{location:"left"},onClick:h},{text:"\u5411\u4e0a\u505c\u9760",icon:{className:"dock_menu_item_top"},argument:{location:"top"},onClick:h},{text:"\u5411\u53f3\u505c\u9760",icon:{className:"dock_menu_item_right"},argument:{location:"right"},onClick:h}],x = function() {
        var a = alloy.portal.getSystemConfig("appMarket");
        c = alloy.iconFactory.createIcon("app", {className:"appMarket",longTouchable:!1,deleteable:!1,icon:{url:alloy.CONST.CDN_URL + "style/images/appmarket.png?20111011001"},contextMenu:[{text:"\u6253\u5f00\u5e94\u7528\u5e02\u573a",onClick:function() {
            alloy.portal.runApp("appMarket")
        }},{type:"separator"},{text:"\u5378\u8f7d",enable:!1}],onClick:function() {
            if(c.isNotifyShow()) {
                alloy.portal.runApp("appMarket", {page:"all",option:{cat:-1,orderBy:2}});
                if(alloy.portal.getLoginLevel() > 1) {
                    var a = {context:this,action:"reset",data:{appid:1E6,value:{appReadTime:(new Date).getTime()}}};
        ...
        D = alloy.iconFactory.createIcon("app", {className:"diskExplorer",longTouchable:!1,
            deleteable:!1,icon:{url:alloy.CONST.CDN_URL + "style/images/diskexplorer.png?20111011001"},contextMenu:[{text:"\u6253\u5f00\u6211\u7684\u7f51\u76d8",onClick:function() {
            alloy.system.getLoginLevel() > 1 ? alloy.system.runApp("diskExplorer") : alloy.layout.showLoginWindow("diskExplorer")
        }},{type:"separator"},{text:"\u5378\u8f7d",enable:!1}],onClick:function() {
            alloy.system.getLoginLevel() > 1 ? alloy.system.runApp("diskExplorer") : alloy.layout.showLoginWindow("diskExplorer");
            return!1
        }}, a);
        o.parentNode.insertBefore(D.getElement(), o);
        b.hide(D.getElement())
    },y = {onQuickListContainerDragMove:function() {
    },onAlloyJsReady:function() {
        x();
        z();
        ...
        onDockContextMenu:function(a) {
            a.preventDefault();
            a.stopPropagation();
            alloy.layout.showContextMenu({x:a.clientX,y:a.clientY}, {items:A,beforeShow:function() {
        ...
        var c = a.apperceiveEl,d = c.getAttribute("type"),e = a.pos,f = b.getXY(o),a = parseInt(c.getAttribute("fileId"));
        if(!isNaN(a)) {
            e = t == "top" ? Math.ceil((e.x - f[0] - 29) / 58) : Math.ceil((e.y - f[1] - 29) / 58);
            e < 0 ? e = 0 : e > 5 && (e = 5);
            d = {t:d,id:a};
            c.getAttribute("from");
            var h;
        ...
        var b = a.orientEvent.pageX,a = a.orientEvent.pageY,c = alloy.layout.getClientWidth(),d = alloy.layout.getClientHeight(),b = a < d * 0.2 ? "top" : b < c / 2 ? "left" : "right";
        b !== w && u(b)
    },onFileAdd:function() {
    },onFileMove:function(a) {
        if(a.targetId == 5)if(a.sourceId == 5) {
            var b = k[alloy.iconFactory.getIconId(a.file.t, a.file.id)],c = a.targetPosition;
            a.targetPosition > a.sourcePosition && c++;
            B(b, c)
        } else n(a.file, a.targetPosition); else a.sourceId == 5 && F(a.file)
    },onFileDelete:function(a) {
        ...
        H();
        alloy.appconfig.getAllConfig(50) && n({id:50,t:"app"})
    },onGetAppConfigComplete:function() {
        ...
        var a = alloy.util.formatFileSize(alloy.storage.getTotalUsedSpace()),b = alloy.util.formatFileSize(alloy.storage.getTotalSpace());
        D.setTitle("\u6211\u7684\u7f51\u76d8 " + a + "/" + b)
    }},u = function(a) {
        w = a || t;
    ...
    this.setDockLocation = function(a, c, d) {
        if("left right top".indexOf(a) != -1) {
            ...
            h.appendChild(g);
            v && (b.setStyle(v, "width", "0px"),b.setStyle(v, "height", "0px"));
            v = h;
            ...
            if(c) {
                if(alloy.portal.getLoginLevel() > alloy.CONST.LOGIN_LEVEL_NONE)alloy.config.configList.dockLoca = a,d ? alloy.rpcService.sendMSetConfigDelay({data:{0:{dockLoca:a}},delay:d}) : alloy.rpcService.sendSetConfig({data:{r:{appid:0,value:{dockLoca:a}}}});
                alloy.util.report2qqweb("dockpositon|" + a)
            }
            e.notifyObservers(alloy.dock, "DockLocationChanged", {loca:a,oldLoca:f})
        }
    };
    ...
    var n = function(b, c) {
        ...
        a:{
            ...
            } else if(b.t == e.BUDDY || b.t == e.GROUP)d = alloy.iconFactory.createIcon(b.t, d, b); else if(b.t == e.FOLDER || b.t == e.FILE)d.file = b,d = alloy.iconFactory.createIcon(b.t, d, b); else {
                d = null;
                break a
            }
        ...
        var d = b.getElement();
        if(a.isUndefined(c))o.appendChild(d); else {
            var e = o.childNodes;
    ...
    this.init = function(c) {
        ...
        r = c.dragController;
        g = b.node("div", {id:"dockContainer","class":"dock_container"});
        ...
        e.on(g, "contextmenu", y.onDockContextMenu);
        ...
        r.addDropTarget({el:o,level:1});
        j = {top:b.node("div", {"class":"dock_drap_effect dock_drap_effect_top"}),left:b.node("div", {"class":"dock_drap_effect dock_drap_effect_left"}),right:b.node("div", {"class":"dock_drap_effect dock_drap_effect_right"})};
        c.appendChild(j.top);
        c.appendChild(j.left);
        c.appendChild(j.right);
        l = b.node("div", {"class":"dock_drap_proxy"});
        c.appendChild(l);
        p = b.node("div", {"class":"dock_drap_mask"});
        ...
        e.addObserver(alloy.appconfig, "GetAppConfigComplete", y.onGetAppConfigComplete);
...
Jx().$package("alloy.startMenu", function(a) {
    var d = this,b = a.dom,e = a.event,g,j,l,p,o,s,v,w = {weibo:{url:"http://t.qq.com/Qplus_Web",title:"\u5b98\u65b9\u5fae\u535a"},support:{url:"http://support.qq.com/portal/discuss_pdt/513_1.html",title:"\u53cd\u9988\u8bba\u575b"},blog:{url:"http://webqq.qzone.qq.com",title:"\u5b98\u65b9\u535a\u5ba2"},question:{url:"http://service.qq.com/category/webQQ.html",title:"\u5e38\u89c1\u95ee\u9898"},imqq:{url:"http://www.qplus.com/productForWeb.shtml",title:"Q+\u5b98\u65b9\u7f51\u7ad9 -\u4ea7\u54c1\u4e2d\u5fc3"},
        download:{url:"http://www.qplus.com/productForPC.shtml",title:"Q+\u5b98\u65b9\u7f51\u7ad9 -\u4ea7\u54c1\u4e2d\u5fc3"}},t = {stopPropagation:function(a) {
        a.stopPropagation()
    },onStartMenuBodyClick:function(a) {
        var b = alloy.util.getActionTarget(a, 2);
        if(b && b != "help")switch(l.hide(),a.preventDefault(),a.stopPropagation(),a = b.getAttribute("cmd"),a) {case "home":pgvSendClick({hottag:"WEB2QQ.TASKBAR.HOMEPAGE.LOGIN"});alloy.util.report2qqweb("taskbar|start|homepage");alloy.util.setHomePage();break;case "favorite":pgvSendClick({hottag:"WEB2QQ.TASKBAR.FAVORITE.LOGIN"});
            alloy.util.report2qqweb("taskbar|start|favorite");alloy.util.addFavorite();break;case "shortcut":pgvSendClick({hottag:"WEB2QQ.TASKBAR.SHORTCUT.LOGIN"});alloy.util.report2qqweb("taskbar|start|desktop");open("./QPlusWeb.url");break;case "lock":alloy.portal.runApp("screenLocker");pgvSendClick({hottag:"WEB2QQ.TASKBAR.SCREENLOCKER.LOGIN"});alloy.util.report2qqweb("taskbar|start|screenlocker");break;case "setting":alloy.portal.runApp("settingCenter");pgvSendClick({hottag:"WEB2QQ.TASKBAR.SETTING.LOGIN"});
            alloy.util.report2qqweb("taskbar|start|setting");break;case "logout":alloy.portal.exit();e.notifyObservers(alloy.portal, "Exit");window.webTop && webTop.ui.channel.postCmd(23);pgvSendClick({hottag:"WEB2QQ.TASKBAR.EXIT.LOGIN"});alloy.util.report2qqweb("taskbar|start|exit");break;case "exit":f();break;case "download":c(w.download);break;case "support":window.open(w[a].url);break;case "helper":A();break;case "about":k()}
    },onHelpMenuClick:function(a) {
        var b = alloy.util.getActionTarget(a, 2);
        if(b)switch(a.preventDefault(),a = b.getAttribute("cmd"),a) {case "hot":alloy.util.report2qqweb("taskbar|help|tips");alloy.app.tips.showNews();break;case "weibo":c(w[a]);alloy.util.report2qqweb("taskbar|help|officialmicroblog");break;case "support":window.open(w[a].url);alloy.util.report2qqweb("taskbar|help|support");break;case "report":h();break;case "blog":c(w[a]);alloy.util.report2qqweb("taskbar|help|officialblog");break;case "helper":A();break;case "question":c(w[a]);alloy.util.report2qqweb("taskbar|help|faq");break;case "imqq":c(w[a])}
    },
        ...
        a.preventDefault();
        if(alloy.portal.getLoginLevel() == alloy.CONST.LOGIN_LEVEL_NONE)alloy.layout.showLoginWindow(""),alloy.util.report2qqweb("taskbar|start|signin"); else if(a = parseInt(this.getAttribute("uin"), 10))alloy.portal.runApp("userDetails", a),alloy.util.report2qqweb("taskbar|start|profile")
    },
        ...
        var a = alloy.dock.getDockLocation(),c = b.getXY(g),e,f;
    ...
    this.toggleStartMenu = function(a) {
        g = a || g;
        l && l.isShow() ? m() : r();
        pgvSendClick({hottag:"WEB2QQ.TASKBAR.START.LOGIN"});
    ...
    var f = function() {
        ...
        alloy.util.report2qqweb("taskbar|start|quit")
            ...
            k = function() {
                if(!p) {
                    ...
                    var d = b.node("div", {"class":"helpMenuImg taskbar_help_menu_container"});
                    b.hide(d);
                    alloy.layout.getDesktop().body.appendChild(d);
                    p = new alloy.layout.PopupBox({container:d,parentPopupBox:l,html:c});
        ...
        alloy.portal.openInWebBrowser(a)
            ...
            h = function() {
                ...
                }, {title:"\u9519\u8bef\u62a5\u544a",width:365,height:100,modal:!0});
                alloy.util.report2qqweb("taskbar|help|report")
            },A = function() {
        alloy.portal.runApp("helper");
        pgvSendClick({hottag:"WEB2QQ.TASKBAR.HELPER.LOGIN"});
        alloy.util.report2qqweb("taskbar|help|helper")
            ...
            '<li cmd="exit"><a href="###" title="\u9000\u51fa">\u9000\u51fa</a></li>','<li cmd="download"><a href="###" title="\u4e0b\u8f7d\u5ba2\u6237\u7aef">\u4e0b\u8f7d\u5ba2\u6237\u7aef</a></li>','<li cmd="helper"><a href="###" title="\u65b0\u624b\u6307\u5bfc">\u65b0\u624b\u6307\u5bfc</a></li>'],z = [1,2,8,5,9];
    this.init = function() {
        ...
        a.browser.ie && (c += '<iframe width="100%" height="100%" class="fullscreen_bg_iframe"></iframe>');
        o = b.node("div", {"class":"taskbar_start_menu_container",id:"startMenuContainer"});
        o.innerHTML = c;
        alloy.layout.getDesktop().body.appendChild(o);
        c = !1;
        a.browser.mobileSafari && (c = !0);
        l = new alloy.layout.PopupBox({container:o,noCatchMouseUp:c});
...
Jx().$package("alloy.appManager", function(a) {
    var d = this,b = a.dom,e = a.event,g,j = [],l,p,o,s,v,w = {},t,r = function() {
        g = b.node("div", {id:"appManagerPanel","class":"appManagerPanel"});
        ...
        a.array.forEach(s, function(b, c) {
            j[c] = new a.ui.ScrollBar(b, {ipadTouchArea:!0})
        });
        v.addDropTarget({el:l,level:0});
        e.addObserver(l, "drop", m.onDockContainerDrop);
        a.array.forEach(s, function(a) {
            v.addDropTarget({el:a,level:0});
        ...
        var c = a.apperceiveEl,d = c.getAttribute("type"),e = a.pos,f = a.currentDropTarget,a = parseInt(f.getAttribute("index"));
        xy = b.getXY(f);
        ...
        if(a.targetId >= 0 && a.targetId < 5) {
            if(a.targetId == a.sourceId) {
                ...
                if(b) {
                    var b = b.getElement(),c = b.parentNode;
                    c.removeChild(b);
    ...
    var D = function() {
        ...
        var a = alloy.portal.getSystemConfig("appMarket");
        appMarketButton = alloy.iconFactory.createIcon(alloy.fileSystem.FILE_TYPE.APP, {className:"appMarket",longTouchable:!1,deleteable:!1,isShowNotify:!1,parentNode:l,icon:{url:alloy.CONST.CDN_URL + "style/images/appmarket.png?20111011001"},
            onClick:function() {
                d.close();
                alloy.portal.runApp("appMarket");
                return!1
        ...
        var c = [],f = {parentNode:l,longTouchable:!1,isShowNotify:!1},h = function() {
            d.close();
        ...
        var f = [],h = {parentNode:o[c],longTouchable:!1,isShowNotify:!1,className:"amg_folder_appbutton"},g = function() {
            d.close();
            alloy.util.report2app("navbar|fullview|runapp")
        },k;
        for(k in b) {
            var l = x(b[k], a.clone(h));
        ...
        } else if(b.t == e.BUDDY || b.t == e.GROUP)d = alloy.iconFactory.createIcon(b.t, c, b); else if(b.t == e.FOLDER || b.t == e.FILE)c.file = b,d = alloy.iconFactory.createIcon(b.t, c, b);
        w[d.getId()] = d;
...
Jx().$package("alloy.taskBar", function(a) {
    var d = this,b = a.dom,e = a.event,g = a.string;
    this.init = function() {
        ...
        e.addObserver(alloy.layout, "desktopResize", J);
    ...
    this.getTaskItem = function(b, c) {
        ...
        var d = M({appId:b,id:c});
        if(d = q(d.appId))return d.getItem(c)
    };
    var j = null,l = null,p = !1,o = !1,s = !1,v = alloy.CONST.CDN_URL + "style/images/transparent.gif",w = alloy.CONST.CDN_URL + "style/images/mid.png",t = {appId:"5_0",appName:"\u6b63\u5728\u804a\u5929...",
        appIcon:alloy.CONST.CDN_URL + "style/images/task/eqq_chatbox.png"},r = {appId:"_folder",appName:"\u6587\u4ef6\u5939"},m = {appId:"_diskAdmin",appName:"\u8d44\u6e90\u7ba1\u7406\u5668"},f = 0,k = {},q = function(a) {
        return a == 0 ? !1 : k[a]
    },D = function(b, c) {
        if(a.isUndefined(b) || a.isUndefined(c))return!1;
        var d = q(b);
        ...
        return b == "" ? "" : a.browser.ie == 6 ? '<img src="' + v + '" style="' + ("background:node;filter: progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + b + "', sizingMethod='scale')") + '" />' : '<img src="' + b + '" />'
    },h = function(c) {
        if(a.browser.ie == 6)return!1;
        if(c = b.mini(".taskItemIcon img", c)[0])e.on(c, "error", function() {
            this.src = w
        })
    },A = 0,x = null,z = function(f) {
        var n = f.id,k = f.icon || "",l = f.name.toString() || "\u4efb\u52a1\u680f\u9879",j = f.title || l,x = f.win,m = A++,p = f._appId,z = g.encodeHtmlSimple(l),q = null;
        ...
        this.createDom = function() {
            var a = b.node("a", {id:"taskItem_" + m,"class":"taskItem",href:"#",appid:p,tid:n,title:j});
        ...
        this.onRightClick = function(a) {
            a.preventDefault();
            var b = T(p, n);
            b && alloy.layout.showContextMenu({x:a.clientX,
                y:a.clientY}, {argument:{appId:p,id:n},items:b})
        };
        ...
        this.jumpUp = function() {
            var a = "",a = b.hasClass(q, "fistTaskItem") ? "firstTaskItemHight" : "taskItemHight";
            b.addClass(q, a);
        ...
        var f = d.appId || 0,j = d.srcAppId || 0,x = d.groupId || f,m = d.groupType || "single",A = d.appIcon || "",q = d.preSiblingAppId || null,p = d.appName.toString() || "",B = d.appType,r = this,s = g.encodeHtmlSimple(p),o = {},y = [],t = null,v = null,w = null,F = null,D = 0;
        this.init = function() {
            o = {};
            y = [];
            var c = b.node("div", {id:"taskGroup_" + f,"class":"taskGroup"});
            c.innerHTML = '<div class="taskItemBox"></div>';
            t = c;
            v = b.mini(".taskItemBox", c)[0];
            if(l.innerHTML == "")l.appendChild(c); else {
        ...
        this.onRightClick = function(a) {
            a.preventDefault();
            var b = T(f);
            b && alloy.layout.showContextMenu({x:a.clientX,y:a.clientY}, {argument:{appId:f},items:b})
        };
        this.checkTask = function() {
            if(this.getItemCount() > 1) {
                if(w)b.show(w); else {
                    var a = b.node("div", {id:"taskGroupItem_" + f,"class":"taskItem taskGroupItem",title:p});
                    a.innerHTML = '<div class="taskItemIcon">' + c(A) + '</div>\t\t\t\t\t\t\t  <div class="taskItemCount"></div>\t\t\t\t\t\t\t  <div class="taskItemTxt">' + s + '</div>\t\t\t\t\t\t\t  <div class="taskItemGroupIcon"></div>';
                    w = a;
    ...
    },u = {_curAppId:0,_mainDom:null,_contentDom:null,_contentInnerDom:null,_maskIframe:null,_domPageUp:null,_domPageDown:null,_turnPageMaxHeight:120,_turnPageHeight:40,_touchStartY:0,_touchEndY:0,_isMove:!1,init:function() {
        var a = alloy.layout.getArea("bottom"),c = b.node("iframe", {id:"taskMenuMask",name:"taskMenuMask","class":"taskMenuMask",frameBorder:"0",allowtransparency:"true",scrolling:"no",style:"display:none",
            src:"./domain.html"});
        this._maskIframe = c;
        a.parentNode.insertBefore(c, a);
        c = b.node("div", {id:"taskMenuBox","class":"taskMenuBox ",style:"display:none"});
        ...
        var a = b.mini(".taskItem", this._mainDom),c;
        ...
        var d = b.mini(".taskItem", this._contentInnerDom),e;
        for(e in d) {
            var f = d[e];
        ...
        a.preventDefault();
        var b = this.getAttribute("appid"),a = this.getAttribute("tid"),b = q(b);
        b.onClick(a);
        ...
        var b = this.getAttribute("appid"),
                c = this.getAttribute("tid"),d = T(b, c);
        d && alloy.layout.showContextMenu({x:a.clientX,y:a.clientY}, {argument:{appId:b,id:c},items:d})
        ...
        if(d > c) {
            if(!this._domPageUp)this._domPageUp = d = b.node("a", {"class":"taskMenuUp taskMenuUpDisable",href:"#",hidefocus:"true"}),e.on(d, "click", this.menuUp),e.on(d, "mouseup", function(a) {
                a.stopPropagation()
            }),this._mainDom.insertBefore(d, a.browser.ie && a.browser.ie < 9 ? this._mainDom.firstChild : this._mainDom.firstElementChild),d = b.node("a", {"class":"taskMenuDown",href:"#",hidefocus:"true"}),e.on(d, "click", this.menuDown),e.on(d, "mouseup", function(a) {
                a.stopPropagation()
        ...
        this._domPageUp && this._turnPageMaxHeight < a ? (b.show(this._domPageUp),b.show(this._domPageDown),b.addClass(u._domPageUp, "taskMenuUpDisable"),b.removeClass(u._domPageDown, "taskMenuDownDisable")) : (b.hide(this._domPageUp),b.hide(this._domPageDown),b.addClass(u._domPageUp, "taskMenuUpDisable"),b.addClass(u._domPageDown, "taskMenuDownDisable"))
    },resize:function() {
        ...
        var d = parseInt(b.getStyle(u._contentInnerDom, "marginTop") || 0),e = b.getHeight(u._contentDom),
                f = b.getClientHeight(u._contentInnerDom);
        if(d >= 0 || e >= f)return!1;
        b.setStyle(u._contentInnerDom, "marginTop", (-d > c ? d + c : 0) + "px");
        -d <= c && b.addClass(u._domPageUp, "taskMenuUpDisable");
        ...
        var a = b.getClientHeight(this._mainDom),c = b.getClientHeight(this._contentInnerDom);
        ...
        a.addEventListener("touchend", function(a) {
            u._isMove && (a.preventDefault(),a.stopPropagation());
            u._isMove = !1
        }, !0)
    },removeIpad:function() {
        var a = this._contentInnerDom;
    ...
    }},n = {_pre:null,_preBox:null,_next:null,_nextBox:null,_dockMarginDom:null,_dockMarginWidth:-1,_touchStartX:0,_touchEndX:0,_isMove:!1,init:function() {
        ...
        if(!o) {
            ...
            if(c > a) {
                if(!p) {
                    ...
                    var h = x.getGroupId(),a = x.getCurrentItemId(),c = -1;
                    k = {};
                    for(f in e)if(d = e[f],d.getGroupType() == "group") {
                        var g = d.getItemList(),j = d.getAppId(),m = d.getGroupId(),A;
                        for(A in g) {
                            var z = g[A],u = z.getWin();
                            F(u, j);
                            m == h && z.getId() == a && (x = q(m),c = a);
                            V(j, z.getId()) && (u = I(u),G(j, z.getId()),O(u))
                        }
                        d.removeTask()
                    } else g = d.getSrcAppId(),g = M({appId:g,id:g}),d.setAppId(g.appId),k[g.appId] = d;
                    c != -1 && x.setCurrent(a)
                }
            } else if(p) {
                p = !1;
                ...
                c = -1;
                k = {};
                for(e in f)if(d = f[e],d.getGroupType() == "group") {
                    d.getItemList();
                    j = d.getItemArr();
                    g = [];
                    if(j.length > 1 && j[0].getDid() > j[1].getDid())for(h = j.length - 1; h >= 0; h--)g.push(j[h].getId()); else for(h in j)g.push(j[h].getId());
                    m = j = d.getAppId();
                    z = d.getGroupId();
                    for(h in g) {
                        var u = d.getItem(g[h]),B = u.getWin();
                        F(B, m);
                        var r = I(B),m = r.appId;
                        if(z == A && u.getId() == a)x = q(r.appId),c = r.id;
                        d.removeItem(u.getId());
                        V(j, u.getId()) && (r = I(B),G(j, u.getId()),O(r))
                    }
                } else g = d.getSrcAppId(),g = M({appId:g,id:g}),d.setAppId(g.appId),k[g.appId] = d;
                c != -1 && x.setCurrent(a)
            }
        ...
        if((b.getClientHeight() - a) / 2 - 64 < 0) {
            if(this._dockMarginWidth == 0)a = n.getAvailableWidth(),this._dockMarginWidth = b.getClientWidth() - a,this.setBottomAreaWidth()
        } else this._dockMarginWidth = 0,this.setBottomAreaWidth()
    },resizeCurrentTask:function() {
        var a = n.getAvailableWidth(),c = b.getWidth(l);
        if(!x)return!1;
        x.getAppId();
        var d = b.mini(".taskGroup", l);
        n.getInnerRight();
        var e = 0,f;
        for(f in d)if(e++,b.hasClass(d[f], "taskCurrent"))break;
        e = d.length - e + 1;
        a -= 114;
        e = c - e * 114;
        c - e < a && (e = c - a);
        ...
        var c = c || 114,d = b.getWidth(l),e = b.getWidth(j),f = n.getInnerRight();
        ...
        var a = b.getWidth(l),c = b.getWidth(j),d = n.getInnerRight(),e = this._pre;
        a - c + d > 10 ? b.hasClass(e, "taskPreDisable") && b.removeClass(e, "taskPreDisable") : b.hasClass(e, "taskPreDisable") || b.addClass(e, "taskPreDisable")
    },onNext:function(a, c) {
        a && a.preventDefault();
        ...
        if(e >= d || f >= 0)return!1;
        d = c;
        n.setInnerRight(f + (-f > c ? c : -f));
        -f <= c && n.checkNextBtn();
        n.checkPreBtn()
    },checkNextBtn:function() {
        var a = this._next;
        n.getInnerRight() < 0 ? b.hasClass(a, "taskNextDisable") && b.removeClass(a, "taskNextDisable") : b.hasClass(a, "taskNextDisable") || b.addClass(a, "taskNextDisable")
    ...
    }},B = {onNewTaskItem:function(b) {
        var c = b.appId || "task_" + f++,d = q(c);
        if(a.isUndefined(d) || !d)d = new y(b),d.init(),k[c] = d;
        d.addItem({id:b.id,
            name:b.name,title:b.title,preSiblingAppId:b.preSiblingAppId,icon:b.icon,win:b.win})
        ...
        if(f == "app") {
            var f = b.option,h = alloy.portal.getAllConfig(f.appId);
            if(!(a.isUndefined(h) || h.appLevel && h.appLevel == "system" && !h.quickPanel)) {
                var g = g = d.getAppIcon(h),f = {appId:f.appId,srcAppId:f.appId,appName:h.appName,appIcon:g,appType:"app",
                    groupType:"single",id:f.appId,name:h.appName,icon:g,win:b},f = M(f);
                B.onNewTaskItem(f)
            }
        } else if(f == "chatBox") {
            h = b.option;
            f = h.chatBoxType;
            h = h.userOrGroup;
            g = {appId:t.appId,srcAppId:t.appId,appName:t.appName,appIcon:t.appIcon,appType:"chatBox",groupType:"group",preSiblingAppId:c,win:b};
            if(f == "single")g.id = h.uin,g.name = h.markName || h.nick,g.title = g.name + " - " + EQQ.hash.onlineStatusText[h.state],g.icon = alloy.util.getUserAvatar(h.uin); else if(f == "group")g.id = h.gid,g.name = h.markName || h.name,g.icon = alloy.util.getGroupAvatar(h.code); else if(f == "discu")g.id = h.did,g.name = h.name,g.icon = alloy.util.getDiscuAvatar(h.did);
            if(!p)g.groupId = g.appId,g.appId = g.appId + "_" + g.id;
            B.onNewTaskItem(g);
            f == "single" && R({id:h.uin,state:h.state})
        } else if(f == "folder") {
            f = b.option;
            h = alloy.CONST.CDN_URL + "/style/images/filesys/folder.png?t=20111011001";
            f = {appId:r.appId,srcAppId:r.appId,appName:r.appName,appIcon:h,appType:"folder",groupType:"group",preSiblingAppId:c,id:f.windowId,name:f.title,icon:h,win:b};
            if(!p)f.groupId = f.appId,f.appId = f.appId + "_" + f.id;
            B.onNewTaskItem(f)
        } else if(f == "diskAdmin") {
            f = b.option;
            h = alloy.CONST.CDN_URL + "/style/images/diskexplorer.png?t=20111011001";
            f = {appId:m.appId,srcAppId:m.appId,appName:m.appName,appIcon:h,appType:"diskAdmin",groupType:"group",preSiblingAppId:c,id:f.windowId,name:f.title,icon:h,win:b};
            if(!p)f.groupId = f.appId,f.appId = f.appId + "_" + f.id;
            B.onNewTaskItem(f)
        }
        ...
        if(a = I(a))B.onSetCurrent(a),G(a.appId, a.id)
    },J = function() {
        n.resize();
        u.resize()
    },I = function(a) {
        var b = a.option,c = b.taskType || "",d = {};
        if(c == "app")d = {appId:b.appId,id:b.appId}; else if(c == "chatBox")d = {appId:t.appId,id:a.uin}; else if(c == "folder")d = {appId:r.appId,id:b.windowId}; else if(c == "diskAdmin")d = {appId:m.appId,id:b.windowId}; else return!1;
        return M(d)
    },M = function(a) {
    ...
    this.getAppIcon = function(a) {
        ...
        if(b == "appMarket")return b = alloy.CONST.CDN_URL_0 + "/style/images/appbar_manage.png"; else if(b == "docViewer")return b = alloy.CONST.CDN_URL_0 + "/style/images/docviewer.png"; else if(b == "imgViewer")return b = alloy.CONST.CDN_URL_0 + "/style/images/imgviewer.png"; else if(b == "messageCenter")return b = alloy.CONST.CDN_URL_0 + "/style/images/messagecenter.png";
    ...
    var R = function(b) {
        ...
        var c = M({appId:t.appId,id:b.id}),c = q(c.appId);
        ...
        var c = M({appId:50,id:50}),d = q(c.appId);
        a.isUndefined(d) || (c = d.getItem(c.id),a.isUndefined(c) || c.getDom().setAttribute("class", "taskItem taskItem_" + b.state))
    },P = {_default:[{text:"\u6700\u5927\u5316",onClick:function(a, b, c) {
        a = c.getArgument();
        (a = D(a.appId, a.id)) && a.winMax()
    }},{text:"\u6700\u5c0f\u5316",onClick:function(a, b, c) {
        a = c.getArgument();
        (a = D(a.appId, a.id)) && a.winMin()
    }},{type:"separator"},{text:"\u5173\u95ed",onClick:function(a, b, c) {
        a = c.getArgument();
        (a = D(a.appId, a.id)) && a.close()
    }}],_defaultNoMax:[{text:"\u6700\u5c0f\u5316",onClick:function(a, b, c) {
        a = c.getArgument();
        (a = D(a.appId, a.id)) && a.winMin()
    }},{type:"separator"},{text:"\u5173\u95ed",onClick:function(a, b, c) {
        a = c.getArgument();
        (a = D(a.appId, a.id)) && a.close()
    }}],_defaultGroup:[{text:"\u6700\u5c0f\u5316\u7ec4",
        onClick:function(a, b, c) {
            a = c.getArgument();
            d.getTask(a.appId).winMin()
        }},{type:"separator"},{text:"\u5173\u95ed\u7ec4",onClick:function(a, b, c) {
        a = c.getArgument();
        a = d.getTask(a.appId);
        s = !0;
        a.close();
        ...
        if(a.isUndefined(b))return!1;
        var d = b,e = [];
        if(a.isUndefined(c))e = P[d],a.isUndefined(e) && (e = P._defaultGroup); else if(d += "_" + c,e = P[d],d.indexOf("50_") > -1 && alloy.portal.getLoginLevel() == alloy.CONST.LOGIN_LEVEL_ALL && (e = !1),a.isUndefined(e)) {
            d = D(b, c);
            e = !0;
            try {
            ...
            e = e ? P._default : P._defaultNoMax
        }
        return!e ? !1 : e
    },$ = function() {
        n.setDockMargin();
...
Jx().$package("alloy.rpcService", function(a) {
    var d = this,b = a.dom,e = a.event,g,j,l = 0,p,o = new a.Class({init:function(a) {
        ...
        var e = {iframeName:d.iframeName,method:d.method || "GET",contentType:d.contentType || "",enctype:d.enctype || "",data:d.data || {},param:d.param || {},arguments:d.arguments || {},context:d.context || null,timeout:d.timeout || 3E4,onSuccess:function(b) {
            var b = b.responseText || "-",c = {};
            try {
                c = a.json.parse(b)
            } catch(e) {
    ...
    }}),s = new a.Class({init:function(c, e) {
        var f = "qqweb_proxySendIframe_" + c,g = this,k;
        this.iframeName = f;
        this._ajaxCallbacks = [];
        this._proxyAjaxSend = this._proxySend = null;
        e += (/\?/.test(e) ? "&" : "?") + "id=" + c;
        a.out("ProxyRequest >>>>> init: " + e, "ProxyRequest");
        var j = function() {
            ...
            try {
                ...
                a.error("ProxyRequest >>>>> ajaxProxy error: " + e.message + " !!!!", "ProxyRequest"),alloy.util.report2h("proxyrequest_error2", "start")
            }
        };
        k = document.body;
        var l = b.node("div", {"class":"hiddenIframe"});
    ...
    }}),v = new a.Class({init:function(c, d) {
        ...
        var k = document.body,j = b.node("div", {"class":"hiddenIframe"});
        j.innerHTML = '<iframe id="' + f + '" class="hiddenIframe" name="' + f + '" src="' + d + '" width="1" height="1"></iframe>';
        k.appendChild(j);
        proxyIframe = b.id(f);
        e.on(proxyIframe, "load", function() {
        ...
        e = a.json.stringify({id:e,option:{method:d.method || "GET",data:d.data || null,isAsync:d.isAsync || !0,timeout:d.timeout,contentType:d.contentType || "",type:d.type,uri:c},uri:c,iframeName:d.iframeName,host:alloy.CONST.MAIN_URL,timestamp:+new Date});
        RegExp(/(^http(s)?:\/\/[\w\.]+)\//).test(c);
        var f = RegExp.$1;
        if(!a.isUndefined(window.postMessage) && !a.browser.ie)window.frames[d.iframeName].postMessage(e, f); else {
            var g = b.node("div");
            g.innerHTML = '<iframe class="hiddenCFProxy" name="' + encodeURIComponent(e) + '" src="' + (f + "/app.rpc.proxy.html") + '" onload="alloy.rpcService.removeCF(this)"></iframe>';
            document.body.appendChild(g)
        }
    }});
    this.rpcProxyCallback = function(b) {
        var b = a.json.parse(decodeURIComponent(b)),d = b.type,e = b.id,f = m[e];
        delete m[e];
        if(f)f[d](b.option)
    };
    var w = function(a) {
    ...
    var t = new a.Class({init:function() {
        this._proxyArr = {};
        this._cFproxyArr = {};
        this._proxyId = 1
    },getProxyId:function() {
        ...
        var a = a.replace("proxy.html", "cfproxy.html").replace("http://", "https://"),b = this._cFproxyArr[a];
    ...
    this.onAjaxFrameLoad = function(b) {
        if(a.isUndefined(b))this.onAjaxFrameLoad2(); else(b = j.getProxyById(b)) && b.onAjaxFrameLoad()
    };
    var f = {_iframes:[],_tick:0,_select:function() {
        this._tick++;
        return this._iframes[(this._tick - 1) % this._len]
    },init:function(a) {
        if(this._isInit != !0) {
            this._len = a;
            for(var d = document.body,e,f = 0; f < a; f++)e = b.node("div", {"class":"RPCService_hDiv"}),b.hide(e),e.innerHTML = '<iframe id="RPCService_hIframe_' + f + '" name="RPCService_hIframe_' + f + '" src="' + alloy.CONST.MAIN_URL + 'domain.html"></iframe>',d.appendChild(e),this._iframes[f] = [e,null,"RPCService_hIframe_" + f];
            this._isInit = !0
        }
    },take:function(a) {
        var b = this._select();
    ...
    this.formSend = function(a, d) {
        f.init(2);
        var e = {method:d.method || "GET",enctype:d.enctype || "",data:d.data || {},onSuccess:d.onSuccess || function() {
        },onError:d.onError || function() {
        },onComplete:d.onComplete || function() {
        },onTimeout:d.onTimeout || function() {
        },timeout:d.timeout ? d.timeout : 1E4},g = b.node("form", {"class":"RPCService_form",method:e.method,action:a + "?t=" + (new Date).getTime(),enctype:e.enctype});
        if(Object.prototype.toString.call(e.data).indexOf("String") > -1) {
            var k = b.node("input");
            k.type = "text";
            k.name = e.data;
            g.appendChild(k)
        } else for(var j in e.data)k = b.node("input"),k.type = "text",k.name = j,k.setAttribute("value", e.data[j]),g.appendChild(k);
        f.take(g);
        g.submit()
    };
    this.sendGetVfWebQQ = function(b, d, f) {
        alloy.portal.getTryUin() && alloy.portal.getSkey() ? (alloy.portal.speedTest.sRTS(1, "start", new Date),this.send(alloy.CONST.API_SERVER_URL + "get_vfwebqq2", {context:this,data:{},arguments:{uin:b},onSuccess:d || function(b) {
            b.retcode === 0 && b.result && b.result.length === 2 && b.result[0] == "vfwebqq" ? (a.out(":GetVfWebQQSuccess..."),e.notifyObservers(this, "GetVfWebQQSuccess", b)) : (a.out("[sendGetVfWebQQ\uff1a\u6570\u636e\u683c\u5f0f\u9519\u8bef] error: " + b.retcode + "-" + b.errmsg),e.notifyObservers(this, "GetVfWebQQError", b));
    ...
    this.sendGetSeftInfo = function(b, d, f) {
        alloy.portal.getTryUin() && alloy.portal.getSkey() ? (alloy.portal.speedTest.sRTS(1, "start", new Date),this.send(alloy.CONST.API_SERVER_URL + "get_self_info2", {context:this,data:{},arguments:{uin:b},timeout:2E4,onSuccess:d || function(b) {
            b.retcode === 0 && b.result ? (alloy.util.report2qqweb("config|vfwebqq|success"),a.out(":GetVfWebQQSuccess..."),e.notifyObservers(this, "GetVfWebQQSuccess", b),e.notifyObservers(this, "GetUserInfoSuccess", b)) : (a.out("[sendGetVfWebQQ\uff1a\u6570\u636e\u683c\u5f0f\u9519\u8bef] error: " + b.retcode + "-" + b.errmsg),e.notifyObservers(this, "GetVfWebQQError", b));
            alloy.portal.speedTest.sRTS(1, "end", new Date, !0);
            alloy.portal.speedTest.sRTS(4, "start", new Date);
            alloy.portal.speedTest.sRTS(5, "start", new Date)
        },onError:f || function(b) {
            ...
            timeoutConfirm("\u83b7\u53d6\u4e2a\u4eba\u767b\u5f55\u4fe1\u606f\u5931\u8d25,\u662f\u5426\u5237\u65b0\u91cd\u8bd5\uff1f(\u70b9\u51fb\u53d6\u6d88\u5c06\u4ee5\u6e38\u5ba2\u6001\u767b\u5f55)") || e.notifyObservers(this, "GetVfWebQQError", b);
            alloy.portal.speedTest.sRTS(1, "end", new Date, !0)
        },onTimeout:function() {
    ...
    this.sendGetUserInfo = function(a, f, g, j) {
        this.send(alloy.CONST.API_SERVER_URL + "get_friend_info2", {context:this,data:{tuin:a,verifysession:g || "",code:f || "",vfwebqq:alloy.portal.getVfWebQQ()},
            arguments:{uin:a},onSuccess:function(f) {
    ...
    this.sendGetSingleInfo = function(a, f, g, j) {
        ...
        }) : this.send(alloy.CONST.API_SERVER_URL + "get_single_info2", {context:this,data:{tuin:a,verifysession:g || "",code:f || "",vfwebqq:alloy.portal.getVfWebQQ()},arguments:{uin:a},onSuccess:function(f) {
    ...
    this.sendGetUserInfo_with_code = function(c, f, g, j, l) {
        f = f || "";
        this.send(alloy.CONST.API_SERVER_URL + "get_stranger_info2", {context:this,data:{tuin:c,verifysession:g || "",gid:0,code:f,vfwebqq:alloy.portal.getVfWebQQ()},arguments:{uin:c,code:f},onSuccess:j || function(a) {
    ...
    this.sendGetFriendUin2 = function(c, f, g, j, l, m) {
        this.send(alloy.CONST.API_SERVER_URL + "get_friend_uin2", {context:this,data:{tuin:c,verifysession:l || "",type:f,code:j || "",vfwebqq:alloy.portal.getVfWebQQ()},arguments:{uin:c},onSuccess:function(a) {
    ...
    this.sendModifyMyDetails = function(b) {
        b.vfwebqq = alloy.portal.getVfWebQQ();
        this.send(alloy.CONST.API_SERVER_URL + "modify_my_details2", {context:this,method:"POST",data:{r:a.json.stringify(b)},
            arguments:{},onSuccess:function(b) {
    ...
    this.sendModifyMyAvatar = function(b) {
        b.vfwebqq = alloy.portal.getVfWebQQ();
        this.send(alloy.CONST.API_SERVER_URL + "modify_my_head", {context:this,method:"POST",data:{r:a.json.stringify(b)},arguments:{},onSuccess:function(a) {
    ...
    this.sendGetGroupInfoByGid = function(b) {
        this.send(alloy.CONST.API_SERVER_URL + "get_group_info_ext2", {context:this,data:{gcode:b,vfwebqq:alloy.portal.getVfWebQQ()},arguments:{gcode:b},
    ...
    this.sendGetGroupPublicInfo = function(b, d, f, g) {
        this.send(alloy.CONST.API_SERVER_URL + "get_group_public_info2", {context:this,data:{gcode:b,vfwebqq:alloy.portal.getVfWebQQ()},arguments:d || {gcode:b},onSuccess:f || function(b) {
            ...
            a.out("\u83b7\u53d6\u7fa4\u7684\u516c\u5171\u4fe1\u606f\u5931\u8d25");
            e.notifyObservers(this, "GetGroupPublicInfoError", b)
        }})
    };
    this.sendGetGCardInfo = function(b) {
        this.send(alloy.CONST.API_SERVER_URL + "get_self_business_card2", {context:this,data:{gcode:b,vfwebqq:alloy.portal.getVfWebQQ()},arguments:{gcode:b},onSuccess:function(b) {
    ...
    this.sendGetBuddyList = function(b, d, f) {
        ...
        this.send(alloy.CONST.API_SERVER_URL + "get_user_friends2", {context:this,arguments:b,method:"POST",data:{r:a.json.stringify(b)},onSuccess:d || function(b) {
            if(b.retcode === 0) {
    ...
    this.sendBatchGetVipInfo = function(b, d, f, g) {
        ...
        this.send(alloy.CONST.API_SERVER_URL + "batch_get_vipinfo", {context:this,arguments:d || param,method:"POST",data:param,onSuccess:f || function(b) {
    ...
    this.sendGetGroupList = function(b, d, f) {
        b = b || {};
        b.vfwebqq = alloy.portal.getVfWebQQ();
        this.send(alloy.CONST.API_SERVER_URL + "get_group_name_list_mask2", {context:this,arguments:b,method:"POST",data:{r:a.json.stringify(b)},onSuccess:d || function(b) {
    ...
    this.sendGetRecentList = function(b, d, f) {
        b = b || {};
        b.vfwebqq = alloy.portal.getVfWebQQ();
        this.send(alloy.CONST.API_SERVER_URL + "get_recent_contact2", {context:this,method:"POST",data:{r:a.json.stringify(b)},onSuccess:d || function(b) {
    ...
    this.sendGetGroupInfo = function(b, d, f) {
        b = b || {};
        b.vfwebqq = alloy.portal.getVfWebQQ();
        this.send(alloy.CONST.API_SERVER_URL + "get_group_info_ext2", {context:this,data:b,arguments:b,onSuccess:d || function(b) {
            b.retcode === 0 ? (a.out(":GetGroupInfoSuccess 1..."),e.notifyObservers(this, "GetGroupInfoSuccess", b.result),a.out(":GetGroupInfoSuccess 2...")) : (a.out("[sendGetGroupInfo] error: " + b.retcode + "-" + b.errmsg),e.notifyObservers(this, "GetGroupInfoError", b))
        },onError:f || function(b) {
            a.out("\u7fa4\u8d44\u6599\u5931\u8d25");
    ...
    this.sendGetQQAllow = function(a, b) {
        this.send(alloy.CONST.API_SERVER_URL + "get_allow_info2", {context:this,method:"GET",data:{tuin:a,retainKey:"allow",vfwebqq:alloy.portal.getVfWebQQ()},arguments:{uin:a},onSuccess:b || function() {
        },onError:function() {
        }})
    };
    this.sendGetQQLevel = function(b) {
        this.send(alloy.CONST.API_SERVER_URL + "get_qq_level2", {context:this,method:"GET",data:{tuin:b,
            vfwebqq:alloy.portal.getVfWebQQ()},arguments:{uin:b},onSuccess:function(b) {
    ...
    this.sendSetSignature = function(b) {
        alloy.rpcService.send(alloy.CONST.API_SERVER_URL + "set_long_nick2", {context:d,method:"POST",data:{r:a.json.stringify({nlk:b,vfwebqq:alloy.portal.getVfWebQQ()})},arguments:{nlk:b},onSuccess:function(f) {
    ...
    this.sendGetSignature = function(b) {
        this.send(alloy.CONST.API_SERVER_URL + "get_single_long_nick2", {context:this,method:"GET",data:{tuin:b,vfwebqq:alloy.portal.getVfWebQQ()},arguments:{uin:b},
            onSuccess:function(b) {
    ...
    this.sendGetMultiSignature = function(b) {
        this.send(alloy.CONST.API_SERVER_URL + "get_long_nick", {context:this,method:"GET",data:{tuin:b,vfwebqq:alloy.portal.getVfWebQQ()},onSuccess:function(b) {
            b.retcode === 0 ? e.notifyObservers(d, "GetMultiBuddySignatureSuccess", b) : a.out("[sendGetSignature] error: " + b.retcode + "-" + b.errmsg)
        },onError:function() {
            a.out(" sendGetSignatureError")
        }})
    };
    this.sendGetTipsInfo = function(b) {
        b = b || {};
        alloy.rpcService.selfSend(alloy.CONST.MAIN_URL + "web2/get_msg_tip", {context:d,method:"GET",data:{uin:b.uin || "",tp:b.tp || 1,id:b.id || 0,retype:b.retype || 1,rc:b.rc || 0,lv:alloy.portal.getLoginLevel() || ""},onSuccess:b.onSuccess ? b.onSuccess : function(b) {
            b.c === 0 ? e.notifyObservers(d, "GetTipsInfoSuccess", b) : b.c !== 1 && a.error("[sendGetTipsInfo] error!")
        }})
    };
    this._sendQuitGroup = function(b) {
        alloy.rpcService.send(alloy.CONST.API_SERVER_URL + "quit_group2", {context:this,method:"POST",data:{r:a.json.stringify(b)},arguments:b,onSuccess:function(b) {
    ...
    this.dismissOrQuit = function(a, b) {
        var d = this;
        this.sendGetFriendUin2(a, 1, function(a) {
            a.result.account == alloy.portal.getUin() ? d.sendGetFriendUin2(b.gcode, 4, function(a) {
                alloy.system.openURL({url:"http://id.qq.com/?guin=" + a.result.account + "#qun-dismiss",isOpenNewTab:!0})
            }) : d._sendQuitGroup(b)
        })
    };
    this.sendQuitGroup = function(a) {
        ...
        if(EQQ) {
            ...
            if(b && b.owner)this.dismissOrQuit(b.owner, a); else {
                var d = this;
                EQQ.Model.BuddyList.sendGetGroupInfo({gcode:a.gcode}, function(b) {
                    d.dismissOrQuit(b, a)
                })
            }
    ...
    this.getAppInfo = function(b, d, e, f) {
        b = {appid:parseInt(b),loadMethod:0};
        if(d)b.val = d;
        b.vfwebqq = alloy.portal.getVfWebQQ();
        alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "keycgi/qqweb/market/getappinfo.do", {context:b.context || this,method:"GET",data:{appattrib:a.json.stringify(b)},arguments:b,onSuccess:e || function() {
        },onError:f || function() {
        }})
    };
    this.setAppVote = function(b, f, g) {
        alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "cgi/qqweb/market/updateapphot.do", {context:b.context || this,method:"POST",data:{appattrib:a.json.stringify(b),vfwebqq:alloy.portal.getVfWebQQ()},arguments:b,onSuccess:f || function() {
        },onError:g || function(b) {
            a.out("\u5e94\u7528\u8bc4\u5206\u5931\u8d25");
    ...
    this.createAppComment = function(a, b, d) {
        ...
        a.vfwebqq = alloy.portal.getVfWebQQ();
        alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "cgi/qqweb/market/createappcomment.do", {context:a.context || this,method:"POST",data:a,arguments:a,onSuccess:b || function() {
        },onError:d || function() {
        }})
    };
    this.createAppComplain = function(b, d, e) {
        ...
        b.vfwebqq = alloy.portal.getVfWebQQ();
        alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "cgi/qqweb/market/appusercomplain.do", {context:b.context || this,method:"POST",data:{appattrib:a.json.stringify(b)},arguments:b,onSuccess:d || function() {
        },
            onError:e || function() {
            }})
    };
    this.sendSetConfig = function(b) {
        if(alloy.portal.getTryUin() && alloy.portal.getSkey()) {
            ...
            this.cgiSend(alloy.CONST.JAVA_CGI_URL + "keycgi/qqweb/newuac/" + d + ".do", {method:"POST",data:b.data,onSuccess:b.onSuccess,context:b.context})
        }
    };
    this.sendMessageFilterConfig = function(a) {
        a.data.vfwebqq = qqweb.portal.getVfWebQQ();
        this.cgiSend(alloy.CONST.JAVA_CGI_URL + "keycgi/qqweb/uac/messagefilter.do", {method:"POST",data:a.data,onSuccess:a.onSuccess,context:a.context})
    };
    this.sendSetConfigNew = function(b) {
        this.cgiSend(alloy.CONST.JAVA_CGI_URL + "keycgi/qqweb/newuac/" + (b.action || "set") + ".do", {method:"POST",data:{r:a.json.stringify(b.data),vfwebqq:alloy.portal.getVfWebQQ()},arguments:b.arguments,onSuccess:b.onSuccess,context:b.context})
    };
    this.sendMSetConfig = function(b) {
        this.cgiSend(alloy.CONST.JAVA_CGI_URL + "keycgi/qqweb/newuac/mset.do", {method:"POST",data:{r:a.json.stringify(b.data),vfwebqq:alloy.portal.getVfWebQQ()},
            onSuccess:b.onSuccess,context:b.context})
    };
    var D = function() {
        p && (d.sendMSetConfig({data:p}),p = null)
    };
    ...
    this.sendGetConfig = function(b) {
        ...
        b.data && b.data.r && (b.data.r = a.json.stringify(b.data.r));
        this.cgiSend(alloy.CONST.JAVA_CGI_URL + "keycgi/qqweb/newuac/" + b.action + ".do", {data:b.data,arguments:b.arguments,
            method:"POST",timeout:2E4,onSuccess:b.onSuccess,onError:b.onError,onComplete:b.onComplete,onTimeout:b.onTimeout,context:b.context})
    };
    this.sendGetAllConfig = function(b) {
        b.data = b.data || {};
        b.data.uin = alloy.portal.getUin();
        b.data && b.data.r && (b.data.r = a.json.stringify(b.data.r));
        this.cgiSend(alloy.CONST.JAVA_CGI_URL + "keycgi/qqweb/newuac/getall.do", {data:b.data,arguments:b.arguments,method:"POST",onSuccess:b.onSuccess,context:b.context})
    };
    this.sendGetNewAppCount = function() {
        var a = {};
        this.cgiSend(alloy.CONST.JAVA_CGI_URL + "cgi/qqweb/market/getnewappnumber.do", {context:this,method:"GET",data:{r:'{"appid":1000000,"type":[1,-1]}'},onSuccess:function(b) {
            b.retcode === 0 ? e.notifyObservers(alloy.rpcService, "SendGetNewAppCountSuccess", b) : e.notifyObservers(alloy.rpcService, "SendMsgError", {uin:a.to,retcode:b.retcode,errmsg:b.errmsg})
        },onError:function() {
        }})
    };
    this.sendGetDefaultAppIntroduce = function(b, f, g) {
        alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "keycgi/qqweb/market/getdefaultappinfo.do", {context:d,method:"POST",data:{appattrib:a.json.stringify(b),
            vfwebqq:alloy.portal.getVfWebQQ()},arguments:b,onSuccess:f || function(b) {
    ...
    this.sendReport = function(b) {
        alloy.rpcService.formSend("http://tj.qstatic.com/log", {method:"POST",data:{r:a.string.trim(b)}})
    };
    ...
    this.sendSearchGroup = function(a) {
        a.data.vfwebqq = qqweb.portal.getVfWebQQ();
        this.cgiSend(alloy.CONST.JAVA_CGI_URL + "keycgi/qqweb/group/search.do", {data:a.data,arguments:a.data,onSuccess:a.onSuccess,onError:a.onError,context:a.context})
    };
    this.sendGetGroupLog2 = function(b, f, g) {
        ...
        k = {ps:b.ps,bs:k,es:j,gid:b.gcode,mode:b.mode,vfwebqq:qqweb.portal.getVfWebQQ()};
        this.cgiSend(alloy.CONST.JAVA_CGI_URL + "keycgi/top/groupchatlog", {context:this,data:k,arguments:{gid:b.gid,gcode:b.gcode},onSuccess:f || function(a) {
    ...
    this.sendGetGroupLogDates = function(b, d, e) {
        ...
        this.cgiSend(alloy.CONST.JAVA_CGI_URL + "keycgi/top/chatlogdates", {context:this,data:b,onSuccess:d || function() {
        },onError:e || function() {
            a.out("[SendGetGroupLog] error")
        }})
    };
    this.sendGetDiscuLog = function(b, d, e) {
        var f = {p:b.p,gid:b.did.slice(1),c:b.c,ty:2,vfwebqq:qqweb.portal.getVfWebQQ()};
        this.cgiSend(alloy.CONST.JAVA_CGI_URL + "cgi/top/get_one_page", {context:this,data:f,arguments:{did:b.did,p:b.p,c:b.c},onSuccess:d || function() {
        },onError:e || function() {
            a.out("[SendGetGroupLog] error")
        }})
    };
    this.sendGetGroupLogByTime = function(b, f, g) {
        arguments = {gid:b.gid,gcode:b.gcode};
        var k = b;
        k.gid = b.gcode;
        k.vfwebqq = qqweb.portal.getVfWebQQ();
        this.cgiSend(alloy.CONST.JAVA_CGI_URL + "keycgi/qqweb/group/uintimechatlog.do", {context:this,
            data:k,arguments:arguments,onSuccess:f || function(a) {
    ...
    this.reportAppRun = function(b) {
        b = {appid:0,rappid:parseInt(b)};
        alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "cgi/qqweb/market/record.do", {context:b.context || this,method:"POST",data:{appattrib:a.json.stringify(b),vfwebqq:alloy.portal.getVfWebQQ()},arguments:b})
    };
    this.reportAppShare = function(b) {
        b = {type:parseInt(b.type),appid:parseInt(b.appId)};
        alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "cgi/qqweb/market/appshare.do", {context:b.context || this,method:"POST",data:{appattrib:a.json.stringify(b),vfwebqq:alloy.portal.getVfWebQQ()},arguments:b})
    };
    this.sendGetAPISkey = function(b) {
        b = b || {};
        alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "cgi/qqweb/app/loadapp.do", {context:d,method:"GET",data:{r:a.json.stringify({appid:b.appid})},timeout:1E4,onSuccess:b.onSuccess,onError:b.onError,onTimeout:b.onTimeout})
    };
    this.sendCheckHack = function(a) {
        alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "cgi/qqweb/check.do", {context:d,method:"POST",data:{k:a.key},onSuccess:a.onSuccess})
    };
    this.sendGetVipConfig = function(a, b, f) {
        if(alloy.portal.getLoginLevel() > alloy.CONST.LOGIN_LEVEL_NONE) {
            var g = {level:a.level};
            g.vfwebqq = qqweb.portal.getVfWebQQ();
            this.send(alloy.CONST.API_SERVER_URL + "get_vipconfig", {context:a.context || this,data:g,onSuccess:b || function(a) {
    ...
    this.sendSetVipConfig = function(b, f, g) {
        if(alloy.portal.getLoginLevel() > alloy.CONST.LOGIN_LEVEL_NONE) {
            ...
            this.send(alloy.CONST.API_SERVER_URL + "set_vipconfig", {context:b.context || this,
                method:"POST",arguments:b.arguments,data:k,onSuccess:f || function(a) {
    ...
    this.getAppInfoMulti = function(b) {
        var d = {appid:b.appList,loadMethod:4};
        alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "keycgi/qqweb/market/getappinfo.do", {context:d.context || this,
            method:"GET",data:{appattrib:a.json.stringify(d)},arguments:d,onSuccess:b.onSuccess || function() {
        },onError:b.onError || function() {
        },onTimeout:b.onError || function() {
        }})
    };
    this.sendGetRecentChat = function(a) {
        this.send(alloy.CONST.API_SERVER_URL + "recent_chat", {context:this,method:"GET",timeout:1E4,data:{vfwebqq:alloy.portal.getVfWebQQ()},onSuccess:a.onSuccess,onError:a.onError})
    };
    this.sendFileErrorReport = function(b) {
        this.cgiSend(alloy.CONST.JAVA_CGI_URL + "cgi/top/save_logs", {context:d,method:"POST",data:{logdata:a.json.stringify(b),
            vfwebqq:alloy.portal.getVfWebQQ()}})
    }
});
Jx().$package("alloy.layout.themeManager", function(a) {
    var d = this,b = a.dom,e = a.event,g,j,l,p,o = {id:"theme_blue_glow"},s = null,v = 0;
    window.webTop && (o = {id:"theme_blue_glow"});
    var w;
    this.themeConfig = {theme_blue:{id:"theme_blue",name:"\u68a6\u5e7b\u5149\u5f71",skin:"blue",wallpaper:{url:"blue.jpg?t=20111011001",mode:"centerRepeat"}},theme_pinky_night:{id:"theme_pinky_night",name:"\u7c89\u7ea2\u4e4b\u591c",skin:"pink",wallpaper:{url:"pinky_night.jpg?t=20111011001",mode:"centerRepeat"}},theme_green:{id:"theme_green",
        name:"\u9752\u9752\u4e16\u754c",skin:"light_green",wallpaper:{url:"green.jpg",mode:"centerRepeat"}},theme_wood1:{id:"theme_wood1",name:"\u6e29\u99a8\u6728\u7eb9",skin:"dark_brown",wallpaper:{url:"wood1.jpg",mode:"centerRepeat"}},theme_wood2:{id:"theme_wood2",name:"\u9ed1\u8272\u6728\u7eb9",skin:"black",wallpaper:{url:"wood2.jpg",mode:"centerRepeat"}},theme_universe:{id:"theme_universe",name:"\u795e\u79d8\u661f\u9645",skin:"dark_blue",wallpaper:{url:"universe.jpg?t=20111011001",mode:"centerRepeat"}},
        theme_metal:{id:"theme_metal",name:"\u9177\u70ab\u91d1\u5c5e",skin:"grey",wallpaper:{url:"metal.jpg?t=20111011001",mode:"centerRepeat"}},theme_pinky_light:{id:"theme_pinky_light",name:"\u5e7b\u5f69\u8367\u5149",skin:"light_violet",wallpaper:{url:"pinky_light.jpg?t=20111011001",mode:"fill"}},theme_pinky_flower:{id:"theme_pinky_flower",name:"\u7eda\u70c2\u7e41\u82b1",skin:"dark_voilet",wallpaper:{url:"pinky_flower.jpg?t=20111011001",mode:"fill"}},theme_christmas:{id:"theme_christmas",name:"\u5723\u8bde\u5feb\u4e50",
        skin:"light_blue",wallpaper:{url:"christmas.jpg?t=20111011001",mode:"fill"},scene:"sceneChristmas"},theme_2011:{id:"theme_2011",name:"\u6b22\u5e86\u5143\u65e6",skin:"black",wallpaper:{url:"2011.jpg",mode:"fill"}},theme_blue1:{id:"theme_blue1",name:"\u5e7b\u5f69\u84dd\u5929",skin:"dark_blue",wallpaper:{url:"blue1.jpg?t=20111011001",mode:"fill"}},theme_spring_festival:{id:"theme_spring_festival",name:"\u559c\u8fce\u65b0\u6625",skin:"grey",wallpaper:{url:"spring_festival.jpg?t=20111011001",mode:"centerRepeat"}},
        theme_valentinesDay:{id:"theme_valentinesDay",name:"\u751c\u871c\u60c5\u4eba\u8282",skin:"valentinesDay",wallpaper:{url:"valentinesDay.jpg?t=20111011001",mode:"fill"}},theme_cloud:{id:"theme_cloud",name:"\u6674\u7a7a\u884c\u4e91",skin:"blue",wallpaper:{url:"cloud.jpg?t=20111011001",mode:"centerRepeat"},scene:"cloud"},theme_gravity:{id:"theme_gravity",name:"\u84b2\u516c\u82f1",skin:"blue",wallpaper:{url:"cloud.jpg?t=20111011001",mode:"centerRepeat"},scene:"gravity"},theme_blue_glow:{id:"theme_blue_glow",
        name:"\u6df1\u6d77\u4ef0\u671b",skin:"grey",wallpaper:{url:"blue_glow.jpg",mode:"zoom"}},theme_green_glow:{id:"theme_green_glow",name:"\u6668\u5149\u5fae\u66e6",skin:"grey",wallpaper:{url:"green_glow.jpg",mode:"zoom"}},theme_orange_glow:{id:"theme_orange_glow",name:"\u68a6\u9192\u65f6\u5206",skin:"grey",wallpaper:{url:"orange_glow.jpg",mode:"zoom"}},theme_7_7:{id:"theme_7_7",name:"\u4e03\u5915",skin:"7_7",wallpaper:{url:"7_7.jpg",mode:"fill"}},theme_teachersDay:{id:"theme_teachersDay",name:"\u6559\u5e08\u8282",
        skin:"teachersDay",wallpaper:{url:"teachersDay.jpg",mode:"zoom"}},theme_midAutumn:{id:"theme_midAutumn",name:"\u4e2d\u79cb\u8282",skin:"pink",wallpaper:{url:"midAutumn.jpg",mode:"fill"}},theme_lookUpSky:{id:"theme_lookUpSky",name:"\u4ef0\u671b\u82cd\u7a79",skin:"blue",wallpaper:{url:"lookUpSky.jpg",mode:"fill"}},theme_grass:{id:"theme_grass",name:"\u832b\u832b\u91ce\u8349",skin:"grey",wallpaper:{url:"grass.jpg",mode:"fill"}},theme_childhood:{id:"theme_childhood",name:"\u7ae5\u5e74\u8bb0\u5fc6",skin:"pink",
        wallpaper:{url:"childhood.jpg",mode:"fill"}},theme_skyBlue:{id:"theme_skyBlue",name:"\u7a7a\u7075\u84dd\u8c03",skin:"blue",wallpaper:{url:"skyBlue.jpg",mode:"fill"}},theme_dandelionDream:{id:"theme_dandelionDream",name:"\u84b2\u82f1\u4e4b\u68a6",skin:"blue",wallpaper:{url:"dandelionDream.jpg",mode:"fill"}},theme_paintingTime:{id:"theme_paintingTime",name:"\u6c34\u58a8\u5e74\u534e",skin:"dark_brown",wallpaper:{url:"paintingTime.jpg",mode:"fill"}},theme_dreamSky:{id:"theme_dreamSky",name:"\u68a6\u7fd4\u5929\u9645",
        skin:"blue",wallpaper:{url:"dreamSky.jpg",mode:"fill"}}};
    var t = [];
    (function() {
        var a,b = 0;
    ...
    var r = {skinRoot:"",timeStamp:20111011001,window:{titleColor:"#6d6d6d",titleHeight:"25px",textColor:"#666666",titleFontWeight:"bold",bodyAreaTop:"0",actionButtonWidth:"21px",
        actionButtonHeight:"19px",bodyColor:"#fff",ie6WindowCenterBackground:"#C2D2C8",ipadContainerBackColor:"rgba(168, 218, 127, .8)"},currentWindow:{titleColor:"#393836",textColor:"#333333",ipadContainerBackColor:"rgba(168, 218, 127, 1)",windowCenterBackground:"#A8DA7F",ie6WindowCenterBackground:"#A8DA7F"},appbar:{aColor:"white"},panel:{ie6Background:"#fff"},indicator:{bgHeight:"40px",ie6BgHeight:"28px",wrapperTop:"0",wrapperPosition:"static",ipadSystemBtn:".mobileSafari #navbar{width:222px;} .mobileSafari #navbar .system_button{display:none;visibility:visible;}"}},
            m = this.skinConfig = {blue:{id:0,key:"blue",name:"\u6de1\u84dd",timeStamp:20111011001,window:{bodyColor:"#C4DCEA",ipadContainerBackColor:"rgba(182,234,253,.8)",ie6WindowCenterBackground:"#C4DEED"},currentWindow:{ipadContainerBackColor:"rgba(182,234,253,1)",ie6WindowCenterBackground:"#B6EAFD"}},black:{id:1,key:"black",name:"\u9ed1\u8272",timeStamp:20111011001,window:{bodyColor:"#E9E9E9",ipadContainerBackColor:"rgba(232,232,232,.8)",ie6WindowCenterBackground:"#C4C4C4"},currentWindow:{ipadContainerBackColor:"rgba(232,232,232,1)",
                ie6WindowCenterBackground:"#e8e8e8"}},light_green:{id:2,key:"light_green",name:"\u5ae9\u7eff",timeStamp:20111011001,window:{bodyColor:"#AFDD8B",ipadContainerBackColor:"rgba(168,218,127,.8)",ie6WindowCenterBackground:"#C2D2C8"},currentWindow:{ipadContainerBackColor:"rgba(168,218,127,1)",ie6WindowCenterBackground:"#A8DA7F"}},pink:{id:3,key:"pink",name:"\u6c34\u7c89",timeStamp:20111011001,window:{bodyColor:"#EFDEE5",ipadContainerBackColor:"rgba(255,225,229,.8)",ie6WindowCenterBackground:"#CCCCCC"},currentWindow:{ipadContainerBackColor:"rgba(255,225,229,1)",
                ie6WindowCenterBackground:"#FFE1E5"}},light_violet:{id:4,key:"light_violet",name:"\u6d45\u7d2b",timeStamp:20111011001,window:{bodyColor:"#EFDEE5",ipadContainerBackColor:"rgba(255,225,229,.8)",ie6WindowCenterBackground:"#CCCCCC"},currentWindow:{ipadContainerBackColor:"rgba(255,225,229,1)",ie6WindowCenterBackground:"#FFE1E5"}},dark_voilet:{id:5,key:"dark_voilet",name:"\u7d20\u7d2b",timeStamp:20111011001,window:{bodyColor:"#EFDEE5",ipadContainerBackColor:"rgba(255,225,229,.8)",ie6WindowCenterBackground:"#CCCCCC"},
                currentWindow:{ipadContainerBackColor:"rgba(255,225,229,1)",ie6WindowCenterBackground:"#FFE1E5"}},grey:{id:6,key:"grey",name:"\u94f6\u7070",timeStamp:20111011001,window:{bodyColor:"#E9E9E9",ipadContainerBackColor:"rgba(232,232,232,.8)",ie6WindowCenterBackground:"#C4C4C4"},currentWindow:{ipadContainerBackColor:"rgba(232,232,232,1)",ie6WindowCenterBackground:"#e8e8e8"}},dark_brown:{id:7,key:"dark_brown",name:"\u6d45\u68d5",timeStamp:20111011001,window:{bodyColor:"#E2D3BB",ipadContainerBackColor:"rgba(234,222,197,.8)",
                ie6WindowCenterBackground:"#C4C4C4"},currentWindow:{ipadContainerBackColor:"rgba(234,222,197,1)",ie6WindowCenterBackground:"#EADEC5"}},dark_blue:{id:8,key:"dark_blue",name:"\u6df1\u84dd",timeStamp:20111011001,window:{bodyColor:"#E9E9E9",ipadContainerBackColor:"rgba(232,232,232,.8)",ie6WindowCenterBackground:"#C4C4C4"},currentWindow:{ipadContainerBackColor:"rgba(232,232,232,1)",ie6WindowCenterBackground:"#e8e8e8"}},light_blue:{id:9,key:"light_blue",name:"\u6d45\u84dd",timeStamp:20111011001,window:{bodyColor:"#C4DCEA",
                ipadContainerBackColor:"rgba(232,232,232,.8)",ie6WindowCenterBackground:"#C4DEED"},currentWindow:{ipadContainerBackColor:"rgba(232,232,232,1)",ie6WindowCenterBackground:"#B6EAFD"}},valentinesDay:{id:10,key:"valentinesDay",name:"\u6d45\u84dd",timeStamp:20111011001,window:{bodyColor:"#E9E9E9",ipadContainerBackColor:"rgba(232,232,232,.8)",ie6WindowCenterBackground:"#C4C4C4"},currentWindow:{ipadContainerBackColor:"rgba(232,232,232,1)",ie6WindowCenterBackground:"#e8e8e8"}},red:{id:11,key:"red",name:"\u4eae\u7ea2",
                timeStamp:20111011001,window:{bodyColor:"#F1B7B7",ipadContainerBackColor:"rgba(245,194,194,.8)",ie6WindowCenterBackground:"#F7CECE"},currentWindow:{ipadContainerBackColor:"rgba(245,194,194,1)",ie6WindowCenterBackground:"#F5C2C2"}},cyan:{id:12,key:"cyan",name:"\u78a7\u9752",timeStamp:20111011001,window:{bodyColor:"#BAE3D7",ipadContainerBackColor:"rgba(194,245,226,.8)",ie6WindowCenterBackground:"#CEF7E8"},currentWindow:{ipadContainerBackColor:"rgba(194,245,226,1)",ie6WindowCenterBackground:"#C2F5E2"}},
                purple:{id:13,key:"purple",name:"\u7d20\u7d2b",timeStamp:20111011001,window:{bodyColor:"#CAB7DE",ipadContainerBackColor:"rgba(224,194,245,.8)",ie6WindowCenterBackground:"#E6CEF7"},currentWindow:{ipadContainerBackColor:"rgba(224,194,245,1)",ie6WindowCenterBackground:"#E0C2F5"}},"7_7":{id:14,key:"7_7",name:"\u6c34\u7c89",timeStamp:20111011001,window:{bodyColor:"#EFDEE5",ipadContainerBackColor:"rgba(255,225,229,.8)",ie6WindowCenterBackground:"#CCCCCC"},currentWindow:{ipadContainerBackColor:"rgba(255,225,229,1)",
                ie6WindowCenterBackground:"#FFE1E5"}},teachersDay:{id:15,key:"teachersDay",name:"\u6de1\u84dd",timeStamp:20111011001,window:{ipadContainerBackColor:"rgba(182,234,253,.8)",ie6WindowCenterBackground:"#C4DEED"},currentWindow:{ipadContainerBackColor:"rgba(182,234,253,1)",ie6WindowCenterBackground:"#B6EAFD"}}};
    this.getSkinArray = function(a) {
        var b = [],c;
        for(c = 0; c < a.length; c++)b[c] = m[a[c]];
        return b
    };
    var f = {},k = {repeat:{isHackNeeded:!1,hackType:""},center:{isHackNeeded:!1,hackType:""},centerRepeat:{isHackNeeded:!1,
        hackType:""},zoom:{isHackNeeded:!0,hackType:"img"},adapt:{isHackNeeded:!0,hackType:"img"},fill:{isHackNeeded:!0,hackType:"img"},iframe:{isHackNeeded:!0,hackType:"iframe"}},q = function() {
        ...
        if(this.isHackLayerNeeded() && (!this.isModeHackNeeded(this._mode) || this.isHackLayerNeed2Change()))this.onInitHackLayer(k[this._nMode].hackType)
        ...
        switch(a) {case "img":this._zoomWallpaperContainer = b.node("div", {id:"zoomWallpaperGrid","class":"zoomWallpaperGrid",style:"position:absolute;z-index:-10;left:0;top:0;overflow:hidden;"});this._zoomWallpaperContext = b.node("img", {id:"zoomWallpaper",
            "class":"zoomWallpaper",style:"position:absolute;"});this._zoomWallpaperContainer.appendChild(this._zoomWallpaperContext);document.body.appendChild(this._zoomWallpaperContainer);e.on(window, "resize", this._onWindowResize);break;case "iframe":this._zoomWallpaperContainer = b.node("div", {id:"zoomWallpaperGrid","class":"zoomWallpaperGrid",style:"position:absolute;left:0;top:0;overflow:hidden;width:100%;height:100%;z-index:-1;"}),this._zoomWallpaperContext = b.node("div"),this._zoomWallpaperContext.innerHTML = '<iframe id ="iframeWallpaper" frameborder="no" border="0" class ="iframeWallpaper" style ="position:absolute;left:0;top:0;overflow:hidden;width:100%;height:100%;"></iframe>',this._zoomWallpaperContainer.appendChild(this._zoomWallpaperContext),document.body.appendChild(this._zoomWallpaperContainer)}
        ...
        var c = {name:"",timeStamp:"",window:{ie6WindowCenterBackground:"",ipadContainerBackColor:""},currentWindow:{ie6WindowCenterBackground:"",ipadContainerBackColor:""},skinRoot:""};
        if(a.isObject(b))c.id = (new Date).getTime(),c.name = b.name || "",c.timeStamp = b.timeStamp || "",c.window.ipadContainerBackColor = b.window.ipadContainerBackColor || "",c.window.ie6WindowCenterBackground = b.window.ie6WindowCenterBackground || "",c.currentWindow.ipadContainerBackColor = b.currentWindow.ipadContainerBackColor || "",c.currentWindow.ie6WindowCenterBackground = b.currentWindow.ie6WindowCenterBackground || "",c.skinRoot = b.skinRoot; else if(m[b]) {
            a.extend(c, m[b]);
            var d = f[b];
        ...
        this._newStyleNode = b.createStyleNode(a, "skinStyleNode" + v++)
        ...
        applyScene:function(a) {
            ...
            if(this.curScene = a)if(alloy.appconfig.getAllConfig(a))alloy.portal.runApp(a); else {
                this._iframeContainer = b.node("div", {id:"sceneGrid","class":"sceneGrid",style:"position:absolute;left:0;top:0;overflow:hidden;width:100%;height:100%;z-index:-1;"});
        ...
        a = a || this.curScene;
        if(alloy.appconfig.getAllConfig(a))(a = alloy.portal.getApp(a)) && a.isRunning() && a.exit(); else if(a = b.id("sceneGrid"))b.id("iframeScene").src = "domain.html",a.parentNode.removeChild(a)
    }}),x = new a.Class({init:function() {
    },
        getCurrentTheme:function() {
            return this._themeId
        },applyTheme:function(a, b) {
        this._themeId = a;
        var c = this.getConfig(a),d = c.skin,e = c.scene,c = c.wallpaper;
        l.applyWallpaper(c.url, c.mode);
        j.applySkin(d);
        b || p.applyScene(e)
    },getConfig:function(b) {
        if(a.isObject(b))return b; else if(d.themeConfig[b]) {
    ...
    this.setTheme = function(b) {
        ...
        if(a.isObject(b)) {
            ...
            var c = l.getCurrentWallpaper(),c = {id:"themeSetting_urlWallpaper",mode:l.getCurrentMode(),url:c};
            b.wallpaper = c;
    ...
    this.setWallpaper = function(a, b) {
        ...
        var c = {id:"themeSetting_urlWallpaper",mode:b,url:a},c = {skin:j.getCurrentSkin(),wallpaper:c};
    ...
    this.setSkin = function(a) {
        ...
        a = {id:"themeSetting_urlWallpaper",mode:l.getCurrentMode(),url:a};
        a = {skin:j.getCurrentSkin(),wallpaper:a};
    ...
    var z = function() {
        if(!alloy.config.getWallpaper().id) {
            var b = alloy.config.getTheme().id,c = d.themeConfig[b].scene,b = 0;
            if(a.browser.ie == 6 || a.browser.ie == 7)b = 500;
            setTimeout(function() {
                p.applyScene(c)
            }, b)
        ...
        if(alloy.portal.getUin() && alloy.portal.getSkey()) {
            var a = alloy.config.getTheme().id,b = alloy.config.getWallpaper().id,c = alloy.config.getWallpaper().mode,e = alloy.config.getWallpaper().url,f = alloy.config.getAppearance().id;
            b ? (d.applyWallpaper(e, c),d.applySkin(f),d.applyScene()) : d.applyTheme(a, !0)
        } else s ? u(s) : q();
        s && s.done && d.themeArray.push(s) && (s = null)
    },u = function(a) {
        o = o || {id:"",mode:"repeat"};
        alloy.rpcService.selfSend(alloy.CONST.MAIN_URL + "web2/get_msg_tip?retype=1&tp=3", {method:"get",onSuccess:function(b) {
...
Jx().$package("alloy.appconfig", function(a) {
    var d = this,b = a.event,e = a.localStorage,d = this,g = !1,j = !1,l = 0,p = 0,o = 0,s = 0;
    this.appConfigList = {};
    this.appTempList = {};
    this.jumptoAppList = {"mail.qq.com":{appid:522005705,daid:4},"qzone.qq.com":{appid:54900912,daid:5},"t.qq.com":{appid:46000101,daid:6}};
    ...
    this.systemConfigList = {50:{id:50,appUrl:"",appName:"QQ",al:null,category:7,iconUrl:"111","New Property":"Value..",minWidth:"260",width:"280",settingCenter:"0",windowMode:"none",ipadincompatible:0,provider:"Tencent \u817e\u8baf",ver:"2.3",alterMode:"",flashMode:"",appDesc:"WebQQ\u662f\u7531Tencent\u63d0\u4f9b\u7684\u7f51\u9875IM\u670d\u52a1\uff0c\u652f\u6301\u5728\u7ebf\u804a\u5929\u3001\u4f20\u8f93\u6587\u4ef6\u3001\u622a\u56fe\u3001\u6d88\u606f\u8bb0\u5f55\u6f2b\u6e38\u7b49\u591a\u79cd\u529f\u80fd\u3002",
        height:"560",loginLevel:"1",defaultMode:"",cannotUninstall:"1",powerLevel:"3",reportName:"eqq",appType:1},taskBar:{id:"taskBar",appName:"\u4efb\u52a1\u680f",appType:1,appLevel:"system",js:"./js/qqweb.system.module.js",windowMode:"none",customLoginValidate:!0,settingCenter:0},dock:{id:"dock",appName:"dock",appType:1,appLevel:"system",css:"./module/dock/style.css",js:"./module/dock/main.js",windowMode:"none"},tips:{id:"tips",appName:"tips",appType:1,appLevel:"system",js:"./js/qqweb.system.module.js",
        windowMode:"none",customLoginValidate:!1,settingCenter:0},shareComponent:{id:"shareComponent",appName:"shareComponent",appType:1,appLevel:"system",js:"./module/sharecomponent/main.js",css:"./module/sharecomponent/style.css",windowMode:"none",customLoginValidate:!1,settingCenter:0},helper:{id:"helper",appName:"WebQQ\u5c0f\u52a9\u624b",appName:"Q+ Web\u5c0f\u52a9\u624b",appType:1,appLevel:"system",css:"./module/helper/style.css",js:"./module/helper/main.js",width:358,height:230,right:5,bottom:5,hasCloseButton:!0,
        settingCenter:0},bubbleTip:{id:"bubbleTip",appName:"\u6c14\u6ce1\u63d0\u793a",appType:1,appLevel:"system",css:"./module/bubbletip/qqweb.app.bubbletip.css",js:"./module/bubbletip/qqweb.app.bubbletip.js",windowMode:"none"},qqWebIme:{id:"qqWebIme",appName:"QQ\u4e91\u8f93\u5165\u6cd5",appType:1,appLevel:"system",css:"./module/qqwebime/style.css",js:"./module/qqwebime/main.js",windowMode:"none",customLoginValidate:!1,click2run:1,quickPanelIcon:"./style/images/pinyin.png",settingCenter:0},qqHandWrite:{id:"qqHandWrite",
        appName:"QQ\u4e91\u624b\u5199\u677f",appType:2,appLevel:"system",appUrl:qqweb.CONST.MAIN_URL + "module/qqhandwrite/qqhandwrite.html?" + qqweb.CONST.UPDATE_TIME_STAMP,hasCloseButton:!0,hasMaxButton:!1,hasMinButton:!1,modeSwitch:!1,resize:!1,width:445,height:292,right:1,bottom:1,hasToolBar:0,loginLevel:alloy.CONST.LOGIN_LEVEL_NONE},qqWebDict:{id:"qqWebDict",appName:"QQ\u4e91\u8bcd\u5178",appType:1,appLevel:"system",css:"./module/qqwebdict/style.css",js:"./module/qqwebdict/main.js",windowMode:"none",customLoginValidate:!1,
        settingCenter:0},appBar:{id:"appBar",appName:"appBar",appType:1,appLevel:"system",css:"./module/appbar/qqweb.app.appbar.css",js:"./module/appbar/qqweb.app.appbar.js",windowMode:"none",settingCenter:0},appMarket:{id:"appMarket",appName:"\u5e94\u7528\u5e02\u573a",appType:2,appDesc:"\u5e94\u7528\u5e02\u573a\u662fWebQQ\u7ed9\u7f51\u53cb\u6dfb\u52a0\u5e94\u7528\u7684\u5e73\u53f0\uff0c\u63d0\u4f9b\u6700\u70ed\uff0c\u6700\u65b0\u7684\u5e94\u7528\uff0c\u7f51\u53cb\u5206\u4eab\u4e5f\u5c3d\u5728\u5176\u4e2d\u3002",
        appDesc:"\u5e94\u7528\u5e02\u573a\u662fQ+ Web\u7ed9\u7f51\u53cb\u6dfb\u52a0\u5e94\u7528\u7684\u5e73\u53f0\uff0c\u63d0\u4f9b\u6700\u70ed\uff0c\u6700\u65b0\u7684\u5e94\u7528\uff0c\u7f51\u53cb\u5206\u4eab\u4e5f\u5c3d\u5728\u5176\u4e2d\u3002",appLevel:"system",appUrl:qqweb.CONST.MAIN_URL + "module/appmarket/appmarket.html?" + qqweb.CONST.UPDATE_TIME_STAMP,hasCloseButton:!0,hasMinButton:!0,hasMaxButton:!0,modeSwitch:!0,resize:!0,width:900,height:570,hasToolBar:0,loginLevel:alloy.CONST.LOGIN_LEVEL_NONE,quickPanel:1,
        titleIcon:"http://0.web.qstatic.com/webqqpic/style/images/appmarket_icon.png",quickPanelIcon:"./style/images/appmarket.png?20111011001",settingCenter:0},notifications:{id:"notifications",appName:"\u901a\u77e5\u8bbe\u7f6e",appType:1,appLevel:"system",css:"./module/notifications/qqweb.app.notifications.css",js:"./module/notifications/qqweb.app.notifications.js",hasMinButton:!1,hasMaxButton:!1,hasOkButton:!0,hasCancelButton:!0,hasToolBar:0,settingCenter:0},themeSetting:{id:"themeSetting",appName:"\u4e3b\u9898\u8bbe\u7f6e",
        appType:1,appLevel:"system",css:"./module/themesetting/qqweb.app.themesetting.css",js:"./module/themesetting/qqweb.app.themesetting.js",hasMinButton:!1,hasMaxButton:!1,hasToolBar:0,resize:!1,settingCenter:0},themeSetting2:{id:"themeSetting2",appName:"\u4e3b\u98982",appType:1,appLevel:"system",css:"./module/themesetting2/qqweb.app.themesetting2.css",js:"./module/themesetting2/qqweb.app.themesetting2.js",hasMinButton:!1,hasMaxButton:!1,hasToolBar:0,resize:!1,windowMode:"none",settingCenter:0},notifySetting:{id:"notifySetting",
        appName:"QQ\u63d0\u9192",appType:1,appLevel:"system",css:"./module/notifysetting/qqweb.app.notifysetting.css",js:"./module/notifysetting/qqweb.app.notifysetting.js",hasMinButton:!1,hasMaxButton:!1,hasOkButton:!0,hasCancelButton:!0,resize:!1,hasToolBar:0,settingCenter:0},desktopSetting:{id:"desktopSetting",appName:"\u684c\u9762\u8bbe\u7f6e",appType:1,appLevel:"system",css:"./module/desktopsetting/style.css",js:"./module/desktopsetting/main.js",hasMinButton:!1,hasMaxButton:!1,hasOkButton:!0,hasCancelButton:!0,
        resize:!1,minWidth:600,minHeight:450,hasToolBar:0,settingCenter:0},hotkeySetting:{id:"hotkeySetting",appName:"\u70ed\u952e",appType:1,appLevel:"system",css:"./module/hotkeysetting/qqweb.app.hotkeysetting.css",js:"./module/hotkeysetting/qqweb.app.hotkeysetting.js",hasMinButton:!1,hasMaxButton:!1,hasOkButton:!0,hasCancelButton:!0,resize:!1,hasToolBar:0,settingCenter:0},ienotification:{id:"ienotification",appType:1,appLevel:"system",appName:"IE\u6d88\u606f\u63d0\u9192",css:"./module/ienotification/qqweb.app.ienotification.css",
        js:"./module/ienotification/qqweb.app.ienotification.js",windowMode:"none"},msgBubble:{id:"msgBubble",appType:1,appLevel:"system",appName:"\u6d88\u606f\u8d70\u9a6c\u706f",css:"./module/messagebubble/qqweb.app.msgbubble.css",js:"./module/messagebubble/qqweb.app.msgbubble.js",windowMode:"none",settingCenter:0},messageManager:{id:"messageManager",appType:1,appLevel:"system",appName:"\u6d88\u606f\u7ba1\u7406\u5668",css:"./module/messagemanager/style.css",js:"./module/messagemanager/main.js",windowMode:"none"},
        chatLogViewer:{id:"chatLogViewer",appName:"\u804a\u5929\u8bb0\u5f55\u7ba1\u7406\u5668",appDesc:"WebQQ\u4e3a\u60a8\u63d0\u4f9b\u7684\u7fa4\u804a\u5929\u8bb0\u5f55\u6f2b\u6e38\u670d\u52a1\uff0c\u652f\u6301\u67e5\u770b7\u5929\u5185\u7fa4\u5185\u6d88\u606f\uff0c\u8fd8\u53ef\u4ee5\u76f4\u63a5\u4ece\u804a\u5929\u8bb0\u5f55\u91cc\u548c\u7fa4\u53cb\u53d1\u8d77\u4e34\u65f6\u4f1a\u8bdd\uff0c\u8d76\u5feb\u6765\u4f53\u9a8c\u5427\uff01",appDesc:"Q+ Web\u4e3a\u60a8\u63d0\u4f9b\u7684\u7fa4\u804a\u5929\u8bb0\u5f55\u6f2b\u6e38\u670d\u52a1\uff0c\u652f\u6301\u67e5\u770b7\u5929\u5185\u7fa4\u5185\u6d88\u606f\uff0c\u8fd8\u53ef\u4ee5\u76f4\u63a5\u4ece\u804a\u5929\u8bb0\u5f55\u91cc\u548c\u7fa4\u53cb\u53d1\u8d77\u4e34\u65f6\u4f1a\u8bdd\uff0c\u8d76\u5feb\u6765\u4f53\u9a8c\u5427\uff01",
            appType:1,appLevel:"system",css:"./module/chatlogviewer/qqweb.app.chatlogviewer.css",js:"./module/chatlogviewer/qqweb.app.chatlogviewer.js",loginLevel:alloy.CONST.LOGIN_LEVEL_ALL,windowMode:"multi",needApp:["eqq"],settingCenter:0},userDetails:{id:"userDetails",appName:"\u8be6\u7ec6\u8d44\u6599",appType:1,appLevel:"system",css:"./module/userdetails/qqweb.app.userdetails.css",js:"./module/userdetails/qqweb.app.userdetails.js",loginLevel:alloy.CONST.LOGIN_LEVEL_NOCHAT,windowMode:"multi",hasToolBar:0,
        needApp:["eqq"],settingCenter:0},avatarChanger:{id:"avatarChanger",appName:"\u66f4\u6362\u5934\u50cf",appType:1,appLevel:"system",css:"./module/avatarchanger/qqweb.app.avatarchanger.css",js:"./module/avatarchanger/qqweb.app.avatarchanger.js",loginLevel:alloy.CONST.LOGIN_LEVEL_NOCHAT,needApp:["eqq"],width:550,windowType:"EqqWindow",height:395,resize:!1,hasMinButton:!1,hasMaxButton:!1,hasOkButton:!0,hasCancelButton:!0,hasToolBar:0,settingCenter:0},groupDetails:{id:"groupDetails",appName:"\u7fa4\u8be6\u7ec6\u8d44\u6599",
        appType:1,appLevel:"system",css:"./module/groupdetails/qqweb.app.groupdetails.css",js:"./module/groupdetails/qqweb.app.groupdetails.js",loginLevel:alloy.CONST.LOGIN_LEVEL_NOCHAT,windowMode:"multi",hasToolBar:0,needApp:["eqq"],settingCenter:0},groupSystemMsg:{id:"groupSystemMsg",appName:"\u7fa4\u7cfb\u7edf\u6d88\u606f",appType:1,appLevel:"system",css:"./module/groupsystemmsg/qqweb.app.groupsystemmsg.css",js:"./module/groupsystemmsg/qqweb.app.groupsystemmsg.js",loginLevel:alloy.CONST.LOGIN_LEVEL_NOCHAT,
        windowMode:"multi",hasToolBar:0,windowType:"EqqWindow",needApp:["eqq"],settingCenter:0},appIntroduce:{id:"appIntroduce",appType:1,appName:"\u5e94\u7528\u4ecb\u7ecd",appLevel:"system",appDesc:"\u5728\u8fd9\u91cc\uff0c\u5e94\u7528\u4ecb\u7ecd",provider:"Tencent \u817e\u8baf",ver:"1.0",css:"./module/appintroduce/qqweb.app.appintroduce.css",js:"./module/appintroduce/qqweb.app.appintroduce.js",loginLevel:alloy.CONST.LOGIN_LEVEL_NOCHAT,width:620,height:500,windowMode:"multi",hasToolBar:0,resize:!1,hasMinButton:!1,
        hasMaxButton:!1,settingCenter:0},buddyAdder:{id:"buddyAdder",appName:"\u6dfb\u52a0\u597d\u53cb",appType:1,appLevel:"system",css:"./module/buddyadder/qqweb.app.buddyadder.css",js:"./module/buddyadder/qqweb.app.buddyadder.js",loginLevel:alloy.CONST.LOGIN_LEVEL_ALL,windowMode:"multi",windowType:"EqqWindow",hasToolBar:0,needApp:["eqq"],settingCenter:0},buddyFinder:{id:"buddyFinder",appName:"\u67e5\u627e\u597d\u53cb/\u7fa4",appDesc:"WebQQ\u4e3a\u4f60\u63d0\u4f9b\u7684\u67e5\u627eQQ\u7fa4\u670d\u52a1\uff0c\u652f\u6301\u901a\u8fc7\u7fa4\u53f7\u7801\uff0c\u5173\u952e\u5b57\u67e5\u627e\u60a8\u6240\u9700\u8981\u7684\u7fa4\u3002\u8be5\u670d\u52a1\u9700\u8981\u767b\u9646QQ\u624d\u80fd\u4f7f\u7528\u3002",
        appDesc:"Q+ Web\u4e3a\u4f60\u63d0\u4f9b\u7684\u67e5\u627eQQ\u7fa4\u670d\u52a1\uff0c\u652f\u6301\u901a\u8fc7\u7fa4\u53f7\u7801\uff0c\u5173\u952e\u5b57\u67e5\u627e\u60a8\u6240\u9700\u8981\u7684\u7fa4\u3002\u8be5\u670d\u52a1\u9700\u8981\u767b\u9646QQ\u624d\u80fd\u4f7f\u7528\u3002",appType:1,appLevel:"system",css:"./module/buddyfinder/qqweb.app.buddyfinder.css",js:"./module/buddyfinder/qqweb.app.buddyfinder.js",loginLevel:alloy.CONST.LOGIN_LEVEL_ALL,width:540,height:362,modeSwitch:!1,resize:!1,hasMinButton:!1,
        hasToolBar:0,hasMaxButton:!1,hasNextButton:!0,windowType:"EqqWindow",hasCancelButton:!0,needApp:["eqq"],settingCenter:0},screenLocker:{id:"screenLocker",appName:"\u9501\u5c4f",appType:1,appLevel:"system",css:"./module/screenlocker/qqweb.app.screenlocker.css",js:"./module/screenlocker/qqweb.app.screenlocker.js",windowMode:"none",hasToolBar:0,settingCenter:0},screenCapture:{id:"screenCapture",appName:"\u622a\u5c4f",appType:1,appLevel:"system",css:"./module/screencapture/qqweb.app.screencapture.css",
        js:"./module/screencapture/qqweb.app.screencapture.js",windowMode:"none",settingCenter:0},screenCapture2:{id:"screenCapture2",appName:"webtop\u622a\u5c4f",appType:1,appLevel:"system",css:"./module/screencapture2/style.css",js:"./module/screencapture2/main.js",windowMode:"none",settingCenter:0},settingCenter:{id:"settingCenter",appName:"\u7cfb\u7edf\u8bbe\u7f6e",appType:1,appLevel:"system",css:"./module/settingcenter/qqweb.app.settingcenter.css",js:"./module/settingcenter/qqweb.app.settingcenter.js",
        hasCloseButton:!0,hasMinButton:!1,hasMaxButton:!1,resize:!1,hasToolBar:0,settingCenter:0},explorer:{id:"explorer",appName:"\u8d44\u6e90\u7ba1\u7406\u5668",appType:1,appLevel:"system",css:"./module/explorer/style.css",js:"./module/explorer/main.js",hasCloseButton:!0,hasMinButton:!0,hasMaxButton:!0,resize:!0,hasToolBar:0,settingCenter:0,windowMode:"multi"},diskExplorer:{id:"diskExplorer",appName:"\u6211\u7684\u7f51\u76d8",appType:1,appLevel:"system",css:"./module/diskexplorer/style.css",js:"./module/diskexplorer/main.js",
        hasCloseButton:!0,hasMinButton:!0,hasMaxButton:!0,resize:!0,hasToolBar:0,settingCenter:0,windowMode:"multi"},layoutSaver:{id:"layoutSaver",appName:"\u8bb0\u5fc6\u684c\u9762\u5e03\u5c40",appType:1,appLevel:"system",css:"./module/layoutsaver/qqweb.app.layoutsaver.css",js:"./module/layoutsaver/qqweb.app.layoutsaver.js",windowMode:"none",settingCenter:0},sceneChristmas:{id:"sceneChristmas",appName:"\u5723\u8bde\u5feb\u4e50",appType:1,appLevel:"system",css:"./scene/christmas/style.css",js:"./scene/christmas/main.js",
        settingCenter:0},gravity:{id:"gravity",appName:"\u83ca\u82b1",appType:1,appLevel:"system",css:"./scene/gravity/style.css",js:"./scene/gravity/main.js",settingCenter:0},urlSave:{id:"urlSave",appType:1,appName:"\u4e00\u952e\u53e6\u5b58\u4e3a\u5e94\u7528",appLevel:"system",appDesc:"\u5728\u8fd9\u91cc\uff0c\u4e00\u952e\u53e6\u5b58\u4e3a",ver:"1.0",css:"./module/urlsave/qqweb.app.urlsave.css",js:"./module/urlsave/qqweb.app.urlsave.js",loginLevel:alloy.CONST.LOGIN_LEVEL_NOCHAT,width:688,height:398,hasMinButton:!1,
        hasMaxButton:!1,resize:!1,hasOkButton:!0,hasCancelButton:!0,hasToolBar:0,settingCenter:0},activityGameCollection:{id:"activityGameCollection",appName:"WebGame\u5927\u96c6\u5408",appDesc:"WebGame\u5927\u96c6\u5408,\u7cbe\u9009WebGame,\u7545\u4eab\u5a31\u4e50",appType:1,appLevel:"system",css:"./activity/gamecollection/style.css",js:"./activity/gamecollection/main.js",hasCloseButton:!0,hasMinButton:!1,hasToolBar:0,width:740,height:530,loginLevel:alloy.CONST.LOGIN_LEVEL_NONE,settingCenter:0},activityChildsday:{id:"activityChildsday",
        appName:"\u513f\u7ae5\u8282\u5927\u96c6\u5408",appDesc:"\u513f\u7ae5\u8282\u5927\u96c6\u5408,\u7545\u4eab\u5a31\u4e50",appType:1,appLevel:"system",css:"./activity/childsday/style.css",js:"./activity/childsday/main.js",hasCloseButton:!0,hasMinButton:!1,hasToolBar:0,width:940,height:550,loginLevel:alloy.CONST.LOGIN_LEVEL_NONE,settingCenter:0},activity3366:{id:"activity3366",appName:"3366\u6d3b\u52a8",appDesc:"3366\u6d3b\u52a8",appType:1,appLevel:"system",css:"./activity/3366/style.css",js:"./activity/3366/main.js",
        hasCloseButton:!0,hasMinButton:!1,hasToolBar:0,width:940,height:550,loginLevel:alloy.CONST.LOGIN_LEVEL_NONE,settingCenter:0},restoreSetting:{id:"restoreSetting",appName:"\u7cfb\u7edf\u8fd8\u539f",appType:1,appLevel:"system",css:"./module/restoresetting/style.css",js:"./module/restoresetting/main.js",hasMinButton:!1,hasMaxButton:!1,hasOkButton:!0,hasCancelButton:!0,resize:!1,hasToolBar:0,settingCenter:0},mapLocation:{id:"mapLocation",appName:"html5\u5730\u56fe\u5b9a\u4f4d",appType:2,x:1,y:420,appDesc:"html5\u5730\u56fe\u5b9a\u4f4d",
        appLevel:"system",appUrl:qqweb.CONST.MAIN_URL + "module/maplocation/maplocation.html",width:224,height:185,windowType:"widget",hasToolBar:0,loginLevel:alloy.CONST.LOGIN_LEVEL_NONE,settingCenter:0},selectBuddy:{id:"selectBuddy",appName:"\u9009\u62e9\u8054\u7cfb\u4eba",appDesc:"\u9009\u62e9\u8054\u7cfb\u4eba",appType:1,appLevel:"system",css:"./module/selectbuddy/style.css",js:"./module/selectbuddy/main.js",loginLevel:alloy.CONST.LOGIN_LEVEL_NOCHAT,windowMode:"multi",settingCenter:0},99999:{id:"99999",
        appName:"\u89c6\u9891\u804a\u5929",appType:2,width:384,height:320,hasMinButton:!1,hasMaxButton:!1,appLevel:"system",appUrl:"http://vcall.hehehi.com",hasToolBar:0,powerLevel:3},cloud:{id:"cloud",appName:"\u4e91\u6735",appType:1,appLevel:"system",css:"./scene/cloud/style.css",js:"./scene/cloud/main.js",settingCenter:0},activitySaturday:{id:"activitySaturday",appName:"\u793c\u62dc\u516d\u56e2\u961f\u4e13\u8bbf",appDesc:"\u793c\u62dc\u516d\u56e2\u961f\u4e13\u8bbf\u3002",appType:1,appLevel:"system",css:"./activity/saturday/style.css",
        js:"./activity/saturday/main.js",hasCloseButton:!0,hasMinButton:!1,hasMaxButton:!0,resize:!0,hasToolBar:0,width:900,height:550,loginLevel:alloy.CONST.LOGIN_LEVEL_NONE,settingCenter:0},activityXindongfang:{id:"activityXindongfang",appName:"\u6dfb\u52a0\u65b0\u4e1c\u65b9\u5e94\u7528\uff0c\u8d62\u53d6\u8d2d\u8bfe\u4ee3\u91d1\u5238",appDesc:"\u6dfb\u52a0\u65b0\u4e1c\u65b9\u5e94\u7528\uff0c\u8d62\u53d6\u8d2d\u8bfe\u4ee3\u91d1\u5238",appType:1,appLevel:"system",css:"./activity/xindongfang/style.css",js:"./activity/xindongfang/main.js",
        hasCloseButton:!0,hasMinButton:!1,hasMaxButton:!0,hasToolBar:0,width:780,height:530,loginLevel:alloy.CONST.LOGIN_LEVEL_NONE,settingCenter:0},appGrant:{id:"appGrant",appName:"\u5e94\u7528\u6388\u6743",appType:1,appLevel:"system",css:"./module/appgrant/qqweb.app.grant.css",js:"./module/appgrant/qqweb.app.grant.js",windowMode:"none",hasToolBar:0,settingCenter:0},imgViewer:{id:"imgViewer",appName:"Q+ Web\u56fe\u7247\u64ad\u653e\u5668",appDesc:"Q+ Web\u56fe\u7247\u64ad\u653e\u5668",appType:1,css:"./module/imgviewer/qqweb.img.viewer.css",
        js:"./module/imgviewer/qqweb.img.viewer.js",hasToolBar:0,width:760,height:502,minWidth:390,minHeight:155,loginLevel:alloy.CONST.LOGIN_LEVEL_NONE,quickPanel:1,settingCenter:0},docViewer:{id:"docViewer",appName:"Q+ Web\u6587\u6863\u6d4f\u89c8\u5668",appDesc:"Q+ Web\u6587\u6863\u6d4f\u89c8\u5668",appType:2,appUrl:qqweb.CONST.MAIN_URL + "module/docviewer/docviewer.html",hasToolBar:0,width:1E3,height:540,minWidth:300,minHeight:320,exinfo:{powerLevel:20},powerLevel:20,quickPanel:1,loginLevel:alloy.CONST.LOGIN_LEVEL_NONE,
        settingCenter:0},audioPlayer:{id:"audioPlayer",appName:"Q+ Web\u97f3\u9891\u64ad\u653e\u5668",appDesc:"Q+ Web\u97f3\u9891\u64ad\u653e\u5668",appType:2,appUrl:qqweb.CONST.MAIN_URL + "module/audioplayer/audioplayer.html?" + qqweb.CONST.UPDATE_TIME_STAMP,windowType:"widget",hasToolBar:0,hasMinButton:!0,hasMaxButton:!1,width:228,height:84,loginLevel:alloy.CONST.LOGIN_LEVEL_NONE,quickPanel:1,quickPanelIcon:"./style/images/audioplayer.gif",settingCenter:0,powerLevel:200,exinfo:{powerLevel:200}},messageCenter:{id:"messageCenter",
        appName:"\u6d88\u606f\u4e2d\u5fc3",appDesc:"Q+ Web \u6d88\u606f\u4e2d\u5fc3",appType:2,appLevel:"system",appUrl:qqweb.CONST.MAIN_URL + "module/messagecenter/messagecenter.html?" + qqweb.CONST.UPDATE_TIME_STAMP,hasCloseButton:!0,hasMinButton:!0,hasMaxButton:!1,modeSwitch:!0,resize:!1,width:640,height:482,hasToolBar:0,loginLevel:alloy.CONST.LOGIN_LEVEL_NOCHAT,settingCenter:0,quickPanel:1}};
    this.getAppConfigList = function() {
        return this.appConfigList
    };
    this.getAllConfig = function(a) {
        return w(a, this.appConfigList) || w(a, this.systemConfigList)
    };
    ...
    this.addAppConfig = function(e) {
        ...
        var g = {appid:e.id,value:1,type:0};
        e.id < 1E5 && t(g);
        b.notifyObservers(d, "AddAppConfig", e);
        if((g = alloy.system.getApp("appMarket")) && g._iframe)g._iframe.contentWindow.appMarket.onAddAppConfig(e)
    };
    ...
    this.removeAppConfig = function(e) {
        ...
        var g = {appid:e.id,value:-1,type:0};
        e.id < 1E5 && t(g);
        b.notifyObservers(d, "RemoveAppConfig", e);
    ...
    var t = function(e) {
        alloy.config.isSetupAppListLoaded() && alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + "cgi/qqweb/market/updateapphot.do", {context:d,method:"POST",data:{appattrib:a.json.stringify(e),vfwebqq:alloy.portal.getVfWebQQ()},arguments:e,onSuccess:function(b) {
        ...
        alloy.rpcService.cgiSend(alloy.CONST.JAVA_CGI_URL + k, {context:d,method:"POST",arguments:f.appid,timeout:2E4,data:{appattrib:a.json.stringify(f),
            vfwebqq:alloy.portal.getVfWebQQ()},onSuccess:function(m) {
            if(m.retcode === 0)if(typeof progress == "function" && progress("get_appinfo end"),alloy.util.report2qqweb("config|appconfig|success"),g)alloy.util.report2h("get_def_appinfo", "end"),this.addAppConfigList(m),e.setItem("UPDATE_TIME_STAMP", alloy.CONST.UPDATE_TIME_STAMP),e.setItem("defaultAppConfig", a.json.stringify(d.getAppConfigList())),b.notifyObservers(d, "GetDefaultAppConfigComplete", this.getAppConfigList()),a.profile("\u9ed8\u8ba4app config\u5b8c\u6210"),alloy.util.report2h("def_appinfo", "end"); else {
                alloy.util.report2h("get_appinfo", "end");
                b.notifyObservers(d, "GetAppConfigAsPartSuccess", m.result);
                l++;
                var p = alloy.config.getSetupAppList(),c = l * 100,h = (l + 1) * 100;
                this.addAppConfigList(m);
                c < p.length ? (p = p.slice(c, h),r({appid:p,loadMethod:3,val:["appName","appType","appUrl","iconUrl","id","category","exinfo","al"]}, "keycgi/qqweb/market/getappinfonew.do")) : (j = !0,a.isUndefined(m.userflag) || alloy.portal.setIsNewUser(m.userflag == 0 ? !0 : !1),b.notifyObservers(d, "GetAppConfigComplete", this.getAppConfigList()),alloy.portal.speedTest.sRTS(5, "end", new Date, !0),a.profile("\u81ea\u5b9a\u4e49app config\u5b8c\u6210"))
            } else m.retcode == 1E5 ? (timeoutConfirm("\u767b\u5f55\u4fe1\u606f\u8d85\u65f6,\u662f\u5426\u5237\u65b0\u91cd\u8bd5\uff1f"),alloy.util.report2qqweb("config|appconfig|logintimeout"),s < 1 ? (++s,r(f, k)) : (timeoutConfirm("\u767b\u5f55\u4fe1\u606f\u8d85\u65f6,\u662f\u5426\u5237\u65b0\u91cd\u8bd5\uff1f"),alloy.util.report2qqweb("config|appconfig|logintimeout"))) : (timeoutConfirm("\u83b7\u53d6\u5e94\u7528\u4fe1\u606f\u51fa\u9519,\u662f\u5426\u5237\u65b0\u91cd\u8bd5\uff1f"),alloy.util.report2qqweb("config|appconfig|reterror"),b.notifyObservers(d, "GetAppConfigError", m.resutlt),a.error("get app config \u8fd4\u56de\u7ed3\u679c\u4e0d\u6b63\u786e. data: " + m, "AppConfig"),s < 1 ? (++s,r(f, k)) : (timeoutConfirm("\u83b7\u53d6\u5e94\u7528\u4fe1\u606f\u51fa\u9519,\u662f\u5426\u5237\u65b0\u91cd\u8bd5\uff1f"),alloy.util.report2qqweb("config|appconfig|reterror"),b.notifyObservers(d, "GetAppConfigError", m.resutlt),a.error("get app config \u8fd4\u56de\u7ed3\u679c\u4e0d\u6b63\u786e. data: " + m, "AppConfig")));
            ...
            s < 1 ? (++s,r(f, k)) : (qqweb.util.report2h(g ? "def_appinfo" : "appinfo", "end", "error"),b.notifyObservers(d, "GetAppConfigError", e.resutlt),timeoutConfirm("\u83b7\u53d6\u5e94\u7528\u4fe1\u606f\u51fa\u9519,\u662f\u5426\u5237\u65b0\u91cd\u8bd5\uff1f"),alloy.util.report2qqweb("config|appconfig|error"))
            ...
            s < 1 ? (++s,r(f, k)) : (timeoutConfirm("\u83b7\u53d6\u5e94\u7528\u4fe1\u606f\u8d85\u65f6,\u662f\u5426\u5237\u65b0\u91cd\u8bd5\uff1f"),alloy.util.report2qqweb("config|appconfig|timeout"),b.notifyObservers(d, "GetAppConfigError", a.resutlt),qqweb.util.report2h(g ? "def_appinfo" : "appinfo", "end", "timeout"))
        }})
    },m = {onAlloyReady:function() {
        a.profile("UACReady\uff1a" + alloy.config.isSetupAppListLoaded());
        if(alloy.config.isSetupAppListLoaded())if(j)b.notifyObservers(d, "GetAppConfigComplete"); else {
            ...
            r({appid:f,loadMethod:3,val:["appName","appType","appUrl","iconUrl","id","category","exinfo","al","gaid"]}, "keycgi/qqweb/market/getappinfonew.do")
        } else {
            g = !0;
            ...
            r({appid:alloy.config.getDefaultSetupAppList(),loadMethod:3,val:["appName","appType","appUrl","iconUrl","id","category","exinfo","al","gaid"]}, "keycgi/qqweb/market/getdefaultappinfonew.do")
        }
    },onReset:function() {
        j = !1
    }};
...
Jx().$package("alloy.hotkeyManager", function(a) {
    var d = a.event,b = this,e = !0,g = !1,j = {eqq_chatbox_read:{id:"eqq_chatbox_read",name:"\u63d0\u53d6\u6700\u65b0\u6d88\u606f",limit:!0,keys:[{ctrlKey:1,shiftKey:0,altKey:1,keyCode:90,des:"Ctrl + Alt + Z"},{ctrlKey:0,shiftKey:0,altKey:1,keyCode:87,des:"Alt + W"}]},eqq_chatbox_sendmsg:{id:"eqq_chatbox_sendmsg",name:"\u53d1\u9001\u6d88\u606f",limit:!0,mutexKeys:[{ctrlKey:1,shiftKey:0,altKey:0,keyCode:13,selected:!0,des:"Ctrl + Enter"},{ctrlKey:0,shiftKey:0,altKey:0,
        keyCode:13,des:"Enter"}],keys:[{ctrlKey:0,shiftKey:0,altKey:1,keyCode:83,des:"Alt + S"}]},eqq_chatbox_classall:{id:"eqq_chatbox_classall",name:"\u5173\u95ed\u6240\u6709\u804a\u5929\u7a97\u53e3",limit:!0,keys:[{ctrlKey:1,shiftKey:0,altKey:1,keyCode:67,des:"Ctrl + Alt + C"}]},open_msg_manager:{id:"open_msg_manager",name:"\u6253\u5f00\u6d88\u606f\u7ba1\u7406\u5668",limit:!0,keys:[{ctrlKey:1,shiftKey:0,altKey:1,keyCode:83,des:"Ctrl + Alt + S"}]},layout_window_current_close:{id:"layout_window_current_close",
        name:"\u5173\u95ed\u5f53\u524d\u7a97\u53e3",disable:!1,keys:[{ctrlKey:0,shiftKey:0,altKey:1,keyCode:67,des:"Alt + C"}]},layout_window_closeall:{id:"layout_window_closeall",name:"\u5173\u95ed\u6240\u6709\u5e94\u7528\u7a97\u53e3",limit:!0,keys:[{ctrlKey:0,shiftKey:1,altKey:1,keyCode:81,des:"Alt + Shift + Q"}]},layout_window_goleft:{id:"layout_window_goleft",name:"\u5207\u6362\u5230\u4e0a\u4e00\u4e2a\u7a97\u53e3",limit:!0,keys:[{ctrlKey:1,shiftKey:0,altKey:0,keyCode:37,des:"Ctrl + \u2190"}]},layout_window_goright:{id:"layout_window_goright",
        name:"\u5207\u6362\u5230\u4e0b\u4e00\u4e2a\u7a97\u53e3",limit:!0,keys:[{ctrlKey:1,shiftKey:0,altKey:0,keyCode:39,des:"Ctrl + \u2192"}]},layout_showdesktop:{id:"layout_showdesktop",name:"\u663e\u793a\u684c\u9762",limit:!0,keys:[{ctrlKey:1,shiftKey:0,altKey:1,keyCode:68,des:"Ctrl + Alt + D"}]},layout_screencaptrue:{id:"layout_screencaptrue",name:"\u622a\u5c4f",keys:[{ctrlKey:1,shiftKey:0,altKey:1,keyCode:65,des:"Ctrl + Alt + A"},{ctrlKey:1,shiftKey:1,altKey:1,keyCode:65,des:"Ctrl + Shift + Alt + A"}]},
        layout_lock:{id:"layout_lock",name:"\u9501\u5b9a",limit:!0,keys:[{ctrlKey:1,shiftKey:0,altKey:1,keyCode:76,des:"Ctrl + Alt + L"}]},layout_exit:{id:"layout_exit",name:"\u6ce8\u9500",limit:!0,keys:[{ctrlKey:1,shiftKey:0,altKey:1,keyCode:69,des:"Ctrl + Alt + E"}]},layout_desktop_goleft:{id:"layout_desktop_goleft",name:"\u5207\u6362\u5230\u4e0a\u4e00\u4e2a\u684c\u9762",limit:!0,keys:[{ctrlKey:1,shiftKey:0,altKey:1,keyCode:37,des:"Ctrl + Alt + \u2190"}]},layout_desktop_goright:{id:"layout_desktop_goright",
        name:"\u5207\u6362\u5230\u4e0b\u4e00\u4e2a\u684c\u9762",limit:!0,keys:[{ctrlKey:1,shiftKey:0,altKey:1,keyCode:39,des:"Ctrl + Alt + \u2192"}]},layout_desktop_gospecific:{id:"layout_desktop_gospecific",name:"\u5207\u6362\u5230\u6307\u5b9a\u684c\u9762",limit:!0,des:"Ctrl + Alt + (1/2/3/4/5)",keys:[{ctrlKey:1,shiftKey:0,altKey:1,keyCode:49,des:"Ctrl + Alt + 1"},{ctrlKey:1,shiftKey:0,altKey:1,keyCode:50,des:"Ctrl + Alt + 2"},{ctrlKey:1,shiftKey:0,altKey:1,keyCode:51,des:"Ctrl + Alt + 3"},{ctrlKey:1,shiftKey:0,
        altKey:1,keyCode:52,des:"Ctrl + Alt + 4"},{ctrlKey:1,shiftKey:0,altKey:1,keyCode:53,des:"Ctrl + Alt + 5"},{ctrlKey:1,shiftKey:0,altKey:1,keyCode:97,des:"Ctrl + Alt + 1"},{ctrlKey:1,shiftKey:0,altKey:1,keyCode:98,des:"Ctrl + Alt + 2"},{ctrlKey:1,shiftKey:0,altKey:1,keyCode:99,des:"Ctrl + Alt + 3"},{ctrlKey:1,shiftKey:0,altKey:1,keyCode:100,des:"Ctrl + Alt + 4"},{ctrlKey:1,shiftKey:0,altKey:1,keyCode:101,des:"Ctrl + Alt + 5"}]},layout_desktop_gosystem:{id:"layout_desktop_gosystem",name:"\u5feb\u901f\u6536\u8d77Q+ Web\u684c\u9762",
        limit:!0,disable:!0,des:"F2",keys:[{ctrlKey:1,shiftKey:0,altKey:1,keyCode:48,des:"Ctrl + Alt + 0"},{ctrlKey:1,shiftKey:0,altKey:1,keyCode:96,des:"Ctrl + Alt + 0"},{ctrlKey:0,shiftKey:0,altKey:0,keyCode:113,des:"F2"},{ctrlKey:1,shiftKey:0,altKey:1,keyCode:192,des:"Ctrl + Alt + `"}]},layout_desktop_manage:{id:"layout_desktop_manage",name:"\u5168\u5c40\u89c6\u56fe",limit:!0,keys:[{ctrlKey:1,shiftKey:0,altKey:1,keyCode:38,des:"Ctrl + Alt + \u2191"}]}};
...
Jx().$package("alloy.hotkey", function(a) {
    var d = this,b = a.dom,e = "\u622a\u5c4f",g = !1,j = new a.Class({hotkeyctrl:null,init:function() {
        ...
        } else if(a.browser.firefox)d = document.createElement("div"),b.addClass(d, "hidden_div"),d.innerHTML = '<embed id="hotkeyctrlid" type="application/tencent-WebQQ-hotkey" hidden="true"></embed>',document.body.appendChild(d),this.hotkeyctrl = document.getElementById("hotkeyctrlid"); else if(a.browser.chrome)d = document.createElement("div"),b.addClass(d, "hidden_div"),d.innerHTML = '<embed id="hotkeyctrlid" type="application/tencent-webqq-hotkey" hidden="true"></embed>',document.body.appendChild(d),this.hotkeyctrl = document.getElementById("hotkeyctrlid")
    },install:function() {
        if((a.browser.ie || a.browser.firefox || a.browser.chrome) && this.detectPlugin()) {
            ...
            }),alloy.layout.removeHotKeyAction("layout_screencaptrue"),!0; else setTimeout(function() {
            }, 1E3)
        }
        return!1
    },hotKeyBusy:function() {
        alloy.windowFactory.createWindow("Window", {title:"\u6e29\u99a8\u63d0\u793a",modeSwitch:!0,dragable:!0,resize:!0,width:380,
            height:120,hasCloseButton:!0,hasOkButton:!0,isSetCentered:!0}).setHtml('<div style="width:100%; height:100%; background-color:#FFFFFF; line-height:60px;text-align:center; vertical-align:middle;">\t\t\t\t\t\t\t\u622a\u5c4f\u5feb\u6377\u952e\u5df2\u88ab\u5176\u4ed6\u7a0b\u5e8f\u5360\u7528,\u82e5\u8981\u8fdb\u884c\u622a\u5c4f,\u8bf7\u624b\u52a8\u70b9\u51fb\u622a\u5c4f\u6309\u94ae!\t\t\t\t\t\t   </div>')
