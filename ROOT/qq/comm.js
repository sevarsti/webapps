...
var pt = {uin:0,ckNum:{},action:[0,0],submitN:{},err_m:null,isHttps:false,isIpad:false,mibao_css:"",needAt:"",t_appid:46000101,seller_id:703010802,needCodeTip:false,regmaster:0,qrlogin_step:0,qrlogin_clock:0,qrlogin_timeout:0,qrlogin_timeout_time:70000,isQrLogin:false,qr_uin:"",qr_nick:"",dftImg:"http://imgcache.qq.com/ptlogin/face/1.png",js_type:0,nlog:function(F, C) {
    ...
    sys.onload(function() {
        ...
        document.body.onkeydown = function(R) {
            R = R | window.event;
            pt.action[1]++
        };
        ...
        try {
            ...
            var L = sys.getQueryValue("hide_close_icon") == 1 || sys.getQueryValue("hide_title_bar") == 1;
            ...
            if(window.g_href && location.href.indexOf(g_href) == -1 && /^ui.ptlogin2./.test(location.hostname)) {
                if(location.protocol == "http:") {
                    if(window.g_jumpname == "aqjump" && F != 5 && N != 3 && N != 2) {
                        if(!L && !sys.$("close")) {
                        ...
                        P.src = "http://badjs.qq.com/cgi-bin/js_report?bid=110&msg=" + O + "&v=" + Math.random()
                    } else {
                        var P = new Image();
                        var O = encodeURIComponent(window.g_href + "|_|" + location.href + "|_|" + window.g_jumpname + "|_|mid=245580");
                        P.src = "http://badjs.qq.com/cgi-bin/js_report?bid=110&mid=245580&msg=" + O + "&v=" + Math.random()
                    }
                } else {
                ...
                switch(g_target) {case"self":document.forms[0].ptredirect.value = 0;break;case"top":document.forms[0].ptredirect.value = 1;break;case"parent":document.forms[0].ptredirect.value = 2;break;default:document.forms[0].ptredirect.value = 1}
                g_qtarget = sys.getQueryValue("qtarget");
                switch(g_qtarget) {case"self":g_qtarget = 0;break;case"top":g_qtarget = 1;break;case"parent":g_qtarget = 2;break;default:g_qtarget = 1}
                var M = 1;
                if(g_jumpname != "") {
                    if(g_qtarget != -1) {
                        M = g_qtarget
                    ...
                    switch(g_target) {case"self":M = 0;break;case"top":M = 1;break;case"parent":M = 2;break;default:M = 1}
                }
                if(sys.$("safe_login")) {
                    sys.$("safe_login").onclick = function() {
                        ...
                        var R = "https://ui.ptlogin2.qq.com/cgi-bin/login";
                        window.open(R + "?style=14&pt_safe=1&appid=" + C + "&s_url=" + J + "&regmaster=" + N + "&enable_qlogin=" + I, "_top");
                ...
                document.forms[0].u1.value = J;
                if(N == 3 || N == 2) {
                    pt.regmaster = N
                }
                var H = (g_jumpname == "jump" || g_jumpname == "") ? encodeURIComponent("u1=" + encodeURIComponent(document.forms[0].u1.value)) : "";
                sys.$("xui") && (sys.$("xui").src = sys.$("xui").src + "&jumpname=" + g_jumpname + "&param=" + H + "&qtarget=" + M + "&regmaster" + N)
            }
        } catch(K) {
        }
    });
    ...
    switch(A) {case 1:sys.$("qrlogin_step1").style.display = "block";sys.$("qrlogin_step2").style.display = "none";sys.$("qrlogin_step3").style.display = "none";break;case 2:sys.$("qrlogin_step1").style.display = "none";sys.$("qrlogin_step2").style.display = "block";sys.$("qrlogin_step3").style.display = "none";break;case 3:sys.$("qr_nick").innerHTML = pt.html.encode(pt.qr_nick);sys.$("qr_uin").innerHTML = pt.qr_uin;sys.$("qrlogin_step3").style.display = "block";sys.$("qrlogin_step2").style.display = "none";sys.$("qrlogin_step1").style.display = "none";var C = (sys.$("qrlogin_step3").offsetWidth - sys.$("qr_card").offsetWidth) / 2;var B = (sys.$("qrlogin_step3").offsetWidth - 270) / 2;pt.animate(sys.$("qr_card"), {left:C,top:20}, 20, 20, function() {
...
function ptuiCB(J, K, B, H, C, A) {
    ...
    function D() {
        ...
        pt.hide_err();
        switch(H) {case"0":window.location.href = B;break;case"1":top.location.href = B;break;case"2":parent.location.href = B;break;default:top.location.href = B}
    }
    $("p").blur();
