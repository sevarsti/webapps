...
function createMovableOptions(fromBox, toBox, totalWidth, totalHeight, labelLeft, labelRight)
{
    ...
    //subDiv.style.border='2px';
    //subDiv.style.backgroundColor='gray';
    ...
    buttonAllRight.className = 'common';
    ...
    buttonAllLeft.className = 'common';
    buttonAllLeft.value = '<<';
